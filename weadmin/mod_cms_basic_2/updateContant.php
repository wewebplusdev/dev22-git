...
// print_pre($_REQUEST);
// die;
// print_pre(changeQuot_code($_REQUEST['inputDescription']));
// die;
?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        if ($execute == "update") {
            ...
            $update[] = $mod_tb_root . "_title='" . changeQuot_code($_POST['inputDescription']) . "'";
            ...
            // print_pre($sql);
            // print_pre($_REQUEST['inputDescription']);die;
