...
$langMod["tit:subject:setting"] = "Subject";
$langMod["tit:title:setting"] = "Subtitle";
...
$langMod["txt:titleaddsg"] = "". $langMod["meu:subgroup"]." New";
$langMod["txt:titleeditsg"] = "". $langMod["meu:subgroup"]." Edit";
$langMod["txt:titleviewsg"] = "". $langMod["meu:subgroup"]." Display";
$langMod["txt:sortpermissg"] = "". $langMod["meu:subgroup"]." Sort";
...
$langMod["inp:noteicon"] = "Note: Please upload only .jpg, .png and .gif files, the size of the image should not exceed 2 Mb and the image provided in the upload should have a proportional ". $sizeWidthIcon." X ". $sizeHeightIcon." Pixels ";
...
$langMod["tit:subjectgg"] = "Name Group " .$langMod["meu:group"];
$langMod["tit:subjectsg"] = "Name " .$langMod["meu:subgroup"];
...
$langMod["tit:selectg"] = "Select Group ". $langMod["meu:group"];
$langMod["tit:selectgn"] = "Name Group ". $langMod["meu:group"];
...
$langMod["tit:selectsg"] = "Select Sub Group ". $langMod["meu:group"];
$langMod["tit:selectsgn"] = "Name Sub Group ". $langMod["meu:group"];
$langMod["meu:selectsgn"] = "Sub Group ". $langMod["meu:group"];
...
$langMod["txt:tags"] = "Tags";
$langMod["tit:credit"] ="Credit";

$langMod["txt:groupType"] = "Detail type information";
$langMod["txt:groupTypeDe"] = "Please fill in the section used to define the details of the news display. For use in displaying the website pages";
$langMod["txt:groupTypeDis"] = "Display";
$langMod["txt:groupTypeurls"] = "URL";
$langMod["txt:groupTypeori"] = "Open the original window";
$langMod["txt:groupTypenew"] = "Open a new window";
$langTxt["mg:pin"] = "Pin";
$langTxt["mg:statuspin"] = "Pin/Unpin";
$langMod["tit:typeshow"] = "ประเภทข้อมูล";
$langMod["tit:typetheme"] = "การแสดงผล";
