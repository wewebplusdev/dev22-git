...
$contant_orderby = $mod_tb_root_group . "_credate";
$group_orderby = $mod_tb_root_group . "_order";
...
if ($inputSearch != "") {
  $sqlSearch = $sqlSearch . "  AND   (
    " . $mod_tb_root_group . "_ipaddress LIKE '%$inputSearch%' OR
    " . $mod_tb_root_group . "_iprouter LIKE '%$inputSearch%'
  ) ";
}

// ".$mod_tb_root_group_group."_subject LIKE '%$inputSearch%' OR

// if($inputGh>=1) {
//   $sqlSearch = $sqlSearch."  AND    ".$mod_tb_root_group_group."_id='".$inputGh."'  ";
// }
...
if ($sdateInput != "") {
  ...
  $sqlSearch = $sqlSearch . "  AND  (" . $mod_tb_root_group . "_credate BETWEEN '" . $valSdate . " 00:00:00' AND '" . $valEdate . " 23:59:59')  ";
}
...
$sqlSelect = "
    ...
    " . $mod_tb_root_group . "_htmlfilename ,
    ...
    " . $mod_tb_root_group . "_groupProoject ,
    " . $mod_tb_root_group . "_year      ,
    " . $mod_tb_root_group . "_metatitle       ,
    " . $mod_tb_root_group . "_description       ,
    " . $mod_tb_root_group . "_keywords,
    " . $mod_tb_root_group . "_type ,
    " . $mod_tb_root_group . "_filevdo ,
    " . $mod_tb_root_group . "_url,
    " . $mod_tb_root_group . "_pic2,
    " . $mod_tb_root_group . "_view,
    " . $mod_tb_root_group . "_ipaddress as ipaddress,
    " . $mod_tb_root_group . "_keysite as keysite,
    " . $mod_tb_root_group . "_countsecretkey as countsecretkey,
    " . $mod_tb_root_group . "_iprouter as iprouter,
";
// $sqlSelect .= "
//     ".$mod_tb_root_group_group."_id as group_id,
//     ".$mod_tb_root_group_group."_subject as group_name,
//     ".$mod_tb_root_group_group."_url as group_url,
//     ";

$sqlSelect .= "
    " . $mod_tb_root_group . "_accesstoken as token,
    " . $mod_tb_root_group . "_secretkeysite as secretkey,
    " . $mod_tb_root_group . "_browser as sitename
    ";

$sql_export = "SELECT " . $sqlSelect . "  FROM " . $mod_tb_root_group;
// $sql_export = $sql_export."  INNER JOIN ".$mod_tb_root_group_group." ON ".$mod_tb_root_group.".".$mod_tb_root_group."_secretkeysite = ".$mod_tb_root_group_group.".".$mod_tb_root_group_group."_secretkey ";
...
<form action="?" method="post" name="myForm" id="myForm">
  ...
  <div class="divRightMain">
    ...
    <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
      ...
      $sql = "SELECT
      " . $mod_tb_root_group . "_id,
      " . $mod_tb_root_group . "_masterkey,
      " . $mod_tb_root_group . "_ip,
      " . $mod_tb_root_group . "_session,
      " . $mod_tb_root_group . "_credate 
      ...
      if ($inputSearch != "") {
        $sql = $sql . "  AND  (
      " . $mod_tb_root_group . "_ip LIKE '%$inputSearch%'
    ) ";
      }
      // print_pre($sql);
      ...
      ?>
          <tr class="<?php echo $valDivTr ?>">
            ...
            <td class="divRightContantOverTb" valign="top" align="left"><span class="fontContantTbupdate"><?php echo $valName ?></span></td>
