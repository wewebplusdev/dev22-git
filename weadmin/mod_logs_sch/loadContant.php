...
if ($module_orderby == "") {
  $module_orderby = $mod_tb_root . "_count";
}
if ($inputSearch != "") {
...
" . $mod_tb_root . "_keyword LIKE '%$inputSearch%'
) ";
}
...
$sql_export .= " ORDER BY  " . $mod_tb_root . "_count DESC ";
  ...
  <div class="divRightMain">
    ...
    <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
      <tr>
        ...
        <td class="divRightTitleTb" valign="middle" align="left"><span class="fontTitlTbRight"><?php echo $langMod["tit:keywords"] ?></span></td>
        <td width="10%" class="divRightTitleTb" valign="middle" align="center"><span class="fontTitlTbRight"><?php echo $langMod["tit:count"] ?></span></td>
        <td width="10%" class="divRightTitleTb" valign="middle" align="center"><span class="fontTitlTbRight"><?php echo $langTxt["us:credate"] ?></span></td>
        <td width="10%" class="divRightTitleTb" valign="middle" align="center"><span class="fontTitlTbRight"><?php echo $langTxt["mg:manage"] ?></span></td>
      </tr>
      <?php
      // SQL SELECT #########################
      $sql = "SELECT
      ...
      ?>
          <tr class="<?php echo $valDivTr ?>">
            ...
            <td class="divRightContantOverTb" valign="top" align="center"><span class="fontContantTbupdate"><?php echo $valCount ?></span></td>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top" align="center" width="30">
                      ...
                      <div class="divRightManage" title="<?php echo $langTxt["btn:list"] ?>" onclick="
   document.myFormHome.inputLt.value='Thai';
   document.myFormHome.valEditID.value=<?php echo $valID ?>;
   editContactNew('subContant.php');">
                        <img src="../img/btn/list_all.png" /><br />
                        <span class="fontContantTbManage"><?php echo $langTxt["btn:list"] ?></span>
                      </div>
                    </td>
                    <td valign="top" align="center" width="30">
