...
<body>
	...
	if ($execute == "update") {
		...
		if ($_REQUEST['inputLt'] == "Thai") {
			...
			$update[] = $mod_tb_root . "_head='" . changeQuot($_REQUEST['inputHead']) . "'";
			...
			$update[] = $mod_tb_root . "_headen='" . changeQuot($_REQUEST['inputHead']) . "'";
		} else {
			...
			$update[] = $mod_tb_root . "_headcn='" . changeQuot($_REQUEST['inputHead']) . "'";
		}
