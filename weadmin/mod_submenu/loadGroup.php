...
if(Paging_CountChecked('CheckBoxID',document.myForm.TotalCheckBoxID.value)>0) {
    ...
    <div class="divRightMain">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
        <tr>
          ...
          <td width="22%" align="left" valign="middle" class="divRightTitleTb"><span class="fontTitlTbRight"><?php echo  $langMod["tit:subjectg"] ?><?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] >= 2) { ?>(<?php echo  $langTxt["lg:thai"] ?>)<?php } ?></span></td>
          ...
          <?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>
            <td width="22%" align="left" valign="middle" class="divRightTitleTb"><span class="fontTitlTbRight"><?php echo  $langMod["tit:subjectg"] ?><?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] >= 2) { ?>(<?php echo  $langTxt["lg:chi"] ?>)<?php } ?></span></td>
          <?php } ?>
        ...
        " . $mod_tb_root_group . "_urlen,
        " . $mod_tb_root_group . "_subjectcn,
        " . $mod_tb_root_group . "_urlcn
         FROM " . $mod_tb_root_group;
        $sql = $sql . "  WHERE " . $mod_tb_root_group . "_masterkey ='" . $_REQUEST['masterkey'] . "'   ";

        /*if($inputgroupID>=1) {
	$sql = $sql."  AND    ".$mod_tb_root_group."_coreid='".$inputgroupID."'  ";
}*/

        if ($inputSearch <> "") {
          $sql = $sql . "  AND  (
		" . $mod_tb_root_group . "_subject LIKE '%$inputSearch%' ) ";
        }
        ...
        if ($count_record > 0) {
          while ($index < $count_record + 1) {
            ...
            $valUrlEn = rechangeQuot($row[7]);
            
            $valNameCn = rechangeQuot($row[8]);
            $valNameCn = chechNullVal($valNameCn);
            $valUrlCn = rechangeQuot($row[9]);
   ...
   document.myFormHome.valEditID.value=<?php echo  $valID ?>;
    viewContactNew('viewGroup.php');"><?php echo  $valName ?></a><br>
                      <span class="fontContantTbTime">
                        <?php echo $langTxt["txt:url"] ?><a href="<?php echo $valUrl  ?>" class="fontLinksub" target="_blank"><?php echo $valUrl  ?></a>
                      </span>
                    </td>
                  </tr>
                </table>
              ...
              <td  class="divRightContantOverTb"   valign="top" align="left" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  document.myFormHome.valEditID.value=<?php echo  $valID ?>;
                    viewContactNew('viewGroup.php');" ><?php echo  $valNameEn ?></a>
                    <br>
                      <span class="fontContantTbTime">
                        <?php echo $langTxt["txt:url"] ?><a href="<?php echo $valUrlEn  ?>" class="fontLinksub" target="_blank"><?php echo $valUrlEn  ?></a>
                      </span>  
                    </td>
                  </tr>
                </table>
              ...
              <td  class="divRightContantOverTb"   valign="top" align="left" >
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  document.myFormHome.valEditID.value=<?php echo  $valID ?>;
                    viewContactNew('viewGroup.php');" ><?php echo  $valNameCn ?></a>
                    <br>
                      <span class="fontContantTbTime">
                        <?php echo $langTxt["txt:url"] ?><a href="<?php echo $valUrlCn  ?>" class="fontLinksub" target="_blank"><?php echo $valUrlCn  ?></a>
                      </span>  
                    </td>
                  </tr>
                </table>
