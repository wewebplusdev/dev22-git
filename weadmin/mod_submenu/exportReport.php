...
header('Content-Disposition: attachment; filename="report_ebook_'.date('Y-m-d').'.xls"');#ชื่อไฟล์
...
<table border="1" cellspacing="1" cellpadding="2"  align="center">
  <tbody>
    <tr >
      ...
      <td width="175" align="center" bgcolor="#eeeeee" class="bold" valign="middle">ชื่อข่าวประกาศ</td>
      <td width="175" align="center" bgcolor="#eeeeee" class="bold" valign="middle">คำบรรยายข่าวประกาศ</td>
      <td width="175" align="center" bgcolor="#eeeeee" class="bold" valign="middle">รายละเอียดข่าวประกาศ</td>
      <td width="175" align="center" bgcolor="#eeeeee" class="bold" valign="middle">วันที่สร้าง</td>
      <td width="175" align="center" bgcolor="#eeeeee" class="bold" valign="middle">เปิดอ่าน(ครั้ง)</td>
      <td width="175" align="center" bgcolor="#eeeeee" class="bold" valign="middle">สถานะ</td>
    </tr>
...
$date_print=date("Y-m-d H:i:s");
   ...
   <tr bgcolor="#ffffff">
      ...
      <td align="left"  valign="middle"><?php echo $row_subject?></td>
      <td align="left"  valign="middle"><?php echo $row_title?></td>
      <td align="left"  valign="middle"><?php echo $valHtmlContant?></td>
      <td align="left"  valign="middle">'<?php echo $row_credate?></td>
      <td align="left"  valign="middle"><?php echo $txt_cms_view?></td>
      <td align="left" valign="middle"><?php echo $row_status?></td>
    </tr>
    <?php 
								$index++;
									}
