    ...
    <?php if ($_REQUEST['viewID'] <= 0) { ?>
      <div class="divRightNav">
        <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr>
            <td class="divRightNavTb" align="left" id="defTop"><span class="fontContantTbNav"><a href="<?php echo  $valLinkNav1 ?>" target="_self"><?php echo  $valNav1 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a href="javascript:void(0)" onclick="btnBackPage('index.php')" target="_self"><?php echo  $langMod["tit:inpName"] ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php echo  $langMod["txt:titleview"] ?><?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>(<?php echo  getSystemLangTxt($_REQUEST['inputLt'], $langTxt["lg:thai"], $langTxt["lg:eng"]) ?>)<?php } ?></span></td>
        ...
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <div class="formDivView">
              ...
              $sql_subgroup = "SELECT ";
              if ($_REQUEST['inputLt'] == "Thai") {
                $sql_subgroup .= "  " . $mod_tb_root_subgroup . "_id," . $mod_tb_root_subgroup . "_subject";
              } else if ($_REQUEST['inputLt'] == "Eng") {
                $sql_subgroup .= "  " . $mod_tb_root_subgroup . "_id," . $mod_tb_root_subgroup . "_subjecten";
              } else {
                $sql_subgroup .= " " . $mod_tb_root_subgroup . "_id," . $mod_tb_root_subgroup . "_subjectcn ";
              }

              $sql_subgroup .= "  FROM " . $mod_tb_root_subgroup . " WHERE  " . $mod_tb_root_subgroup . "_id='" . $valGid . "'  ORDER BY " . $mod_tb_root_subgroup . "_order DESC ";
              ...
              echo   $row_subgroupname = $row_subgroup[1];
              ?>
            </div>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <div class="formDivView">
              ...
              <a href="<?php echo  $valUrl ?>" target="_blank"><?php echo  txtLimit($valUrl, 100) ?></a>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <div class="formDivView">
              ...
              ?>
                  ...
                  <div style="float:left; width:100%; height:30px; margin-bottom:15px;"><img src="<?php echo  get_Icon($downloadFile) ?>" align="absmiddle" width="30" /><a href="../<?php echo  $mod_fd_root ?>/download.php?linkPath=<?php echo  $linkRelativePath ?>&amp;downloadFile=<?php echo  $downloadName ?>"><?php echo  $downloadName . "" . $imageType ?></a>
