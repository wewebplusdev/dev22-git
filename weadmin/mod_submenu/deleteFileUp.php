...
include("config.php");
	...
	$sql_fileNew="SELECT ".$mod_tb_root."_fileUp  FROM ".$mod_tb_root." WHERE ".$mod_tb_root."_id 	='".$_REQUEST['valDelFile']."' ";
	...
	// $sql="DELETE FROM ".$mod_tb_root." WHERE   ".$mod_tb_root."_id='".$_REQUEST['valDelFile']."' ";
	// $Query=wewebQueryDB($coreLanguageSQL,$sql);

// 	$sql="UPDATE ".$mod_tb_root."_fileUp =  FROM ".$mod_tb_root." WHERE   ".$mod_tb_root."_id='".$_REQUEST['valDelFile']."' ";
//  $Query=wewebQueryDB($coreLanguageSQL,$sql);


		// $sql="SELECT ".$mod_tb_root."_id,".$mod_tb_root."_fileUp,".$mod_tb_root."_name,".$mod_tb_root."_download FROM ".$mod_tb_file." WHERE ".$mod_tb_file."_contantid 	='".$_REQUEST['valEditID']."'   ORDER BY ".$mod_tb_file."_id ASC";
