...
// }else{
// 	$inputgroupID = $_SESSION[$valSiteManage."core_session_groupid"];
// }
?>
...
<script type="text/javascript">
	jQuery(function() {
		boxContantLoad('../<?php echo $mod_fd_root?>/loadGroup.php');
	});
</script>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
                ...
                <input name="module_orderby" type="hidden" id="module_orderby" value="<?php echo $_REQUEST['module_orderby']?>" />
								<input name="inputgroupID" type="hidden" id="inputgroupID" value="<?php echo $inputgroupID?>" />
