...
if(Paging_CountChecked('CheckBoxID',document.myForm.TotalCheckBoxID.value)>0) {
    ...
    <div class="divRightMain">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
        ...
        " . $mod_tb_root_subgroup . "_view,
        " . $mod_tb_root_subgroup . "_subjecten,
        " . $mod_tb_root_subgroup . "_urlen,
        " . $mod_tb_root_subgroup . "_subjectcn,
        " . $mod_tb_root_subgroup . "_urlcn 
   ...
   document.myFormHome.valEditID.value=<?php echo  $valID ?>;
    viewContactNew('viewSubGroup.php');"><?php echo  $valName ?></a><br>
   ...
   document.myFormHome.valEditID.value=<?php echo  $valID ?>;
    viewContactNew('viewSubGroup.php');"><?php echo  $valNameEn ?></a>
                  <br>
                    <span class="fontContantTbTime">
    ...
    document.myFormHome.inputLt.value='Eng';
   document.myFormHome.valEditID.value=<?php echo  $valID ?>;
    viewContactNew('viewSubGroup.php');"><?php echo  $valNameCn ?></a>
                  <br>
                    <span class="fontContantTbTime">
