...
<body>
	...
	if ($execute == "update") {
		...
		if ($_REQUEST['inputLt'] == "Thai") {
			...
			$update[] = $mod_tb_root_group . "_url ='" . $_POST["inputURL"] . "'";
			...
			$update[] = $mod_tb_root_group . "_urlen ='" . $_POST["inputURL"] . "'";
		} else {
			...
			$update[] = $mod_tb_root_group . "_urlcn ='" . $_POST["inputURL"] . "'";
		}
		$update[] = $mod_tb_root_group . "_target ='" . $_POST["inputTarget"] . "'";
