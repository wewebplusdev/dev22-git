...
$langMod["txt:titleaddg"] = "". $langMod["meu:subgroup"]." New";
$langMod["txt:titleeditg"] = "". $langMod["meu:subgroup"]." Edit";
$langMod["txt:titleviewg"] = "". $langMod["meu:subgroup"]." Display";
$langMod["txt:sortpermisg"] = "". $langMod["meu:subgroup"]." Sort";
...
$langMod["txt:subjectsg"] = "" .getNameMenu($_REQUEST["menukeyid"])." Info";
$langMod["txt:subjectsgDe"] = "Please enter a selection, group, title and subtitle. To use to display content on the page, include all of this menu information on your site. ";
$langMod["tit:selectsg"] ="Select ".$langMod["meu:subgroup"];
...
$langMod["edit:linknote"] ="หมายเหตุ : กรุณา URL นำหน้าด้วย \"http://\" เช่น http://www.wewebplus.com เป็นต้น"."<br/>"."กรณีไม่มี URL ให้ใส่ #";

}else{
	$langMod["edit:linknote"] ="หมายเหตุ : กรุณานำหน้า URL ด้วย \"http://\" เช่น http://www.wewebplus.com เป็นต้น"."<br/>"."กรณีไม่มี URL ให้ใส่ #";
