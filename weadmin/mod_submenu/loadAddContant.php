    ...
    <div class="divRightMain">
      ...
      <table style="display: none;" width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr id="boxInputlink">
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb"><br />
      ...
      <table style="display: none;" width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr>
          <td width="18%" align="right" valign="top" class="formLeftContantTb">จำนวนผู้เข้าชม <span class="fontContantAlert"></span></td>
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb"><input name="inputView" id="inputView" type="text" class="formInputContantTbShot" value="0" /></td>
        </tr>
        </tr>
      </table>
      <br style="display: none;" />
