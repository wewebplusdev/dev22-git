    ...
    <form action="?" method="post" name="myForm" id="myForm">
        ...
        <div class="divRightNav">
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    <td class="divRightNavTb" align="left"><span class="fontContantTbNav">
                            <?php if (!empty($_REQUEST['include'])) {
                            } else { ?> <a href="<?php echo $valLinkNav1 ?>" target="_self"><?php echo $valNav1 ?></a> <?php } ?>
...
if(Paging_CountChecked('CheckBoxID',document.myForm.TotalCheckBoxID.value)>0) {
        ...
        <div class="divRightMain">
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
                <tr>
                    ...
                    <td align="left" width="22%" valign="middle" class="divRightTitleTb"><span class="fontTitlTbRight"><?php echo $langMod["tit:selectsgn"] ?><?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>(<?php echo $langTxt["lg:thai"] ?>)<?php } ?></span></td>
                    <?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>
                        <td width="22%" align="left" valign="middle" class="divRightTitleTb"><span class="fontTitlTbRight"><?php echo $langMod["tit:selectsgn"] ?>(<?php echo $langTxt["lg:eng"] ?>)</span></td>
                    <?php } ?>
                ...
                <?php
                // SQL SELECT #########################
                $sql = "SELECT " . $mod_tb_root_subgroup . "_id," . $mod_tb_root_subgroup . "_subject," . $mod_tb_root_subgroup . "_lastdate," . $mod_tb_root_subgroup . "_status," . $mod_tb_root_subgroup . "_subjecten," . $mod_tb_root_subgroup . "_subjectcn  FROM " . $mod_tb_root_subgroup;
   ...
   document.myFormHome.valEditID.value=<?php echo $valID ?>;
    viewContactNew('viewSubroup.php');"><?php echo $valName ?></a></td>
                                    </tr>
                                </table>
                            </td>
        ...
        document.myFormHome.valEditID.value=<?php echo $valID ?>;
        viewContactNew('viewSubroup.php');"><?php echo $valNameEn ?></a></td>
                                        </tr>
                                    </table>
                                </td>
                            <?php } ?>
            ...
            document.myFormHome.valEditID.value=<?php echo $valID ?>;
            viewContactNew('viewSubroup.php');"><?php echo $valNameCn ?></a></td>
                                        </tr>
                                    </table>
                                </td>
                            <?php } ?>
