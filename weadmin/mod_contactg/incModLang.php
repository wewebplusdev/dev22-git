...
$langMod["txt:titlesDe"] = "Please enter details. For use in display on your website. ";
		...
		$langMod["txt:set"] = "ข้อมูลอีเมล";
		$langMod["txt:setDe"] = "ข้อมูลนี้คือส่วนที่ใช้ในการกำหนดอีเมลในการติดต่อหน้าเว็บไซต์ของคุณ";
		...
		$langMod["ats:email"] = "อีเมลซ้ำกับที่มีอยู่ในระบบแล้ว";
		...
		$langMod["meu:subgroup"] = "กลุ่มสิทธิ";
		$langMod["tit:subjectsg"] = 'คำขอใช้สิทธิ'; ///$langMod["meu:subgroup"];
		...
		$langMod["tit:country"] = "ประเทศ";
		$langMod["tit:city"] = "เมือง";
		$langMod["tit:file"]="เอกสารแนบ";
		...
		$langMod["tit:iden"] = "สำเนาบัตรประชาชนหรือหนังสือเดินทาง";
		$langMod["tit:reason"] = "รายละเอียดข้อมูลส่วนบุคคล";
