   ...
   document.myFormHome.valEditID.value=<?php echo $valID ?>;
    editContactNew('editContant.php');">
      ...
      <table width="96%" cellspacing="0" cellpadding="0" border="0" align="center" style="margin-top: 20px;">
          <tr>
              <td>Link : <a href="<?php echo $core_full_path . "" . $urlSegment[$_REQUEST['masterkey']] . "/" . 270 . "/diamond-weight-calculator"; ?>" target="_blank"><?php echo $core_full_path . "" . $urlSegment[$_REQUEST['masterkey']] . "/" . 270 . "/diamond-weight-calculator"; ?></a></td>
          </tr>
      </table>
