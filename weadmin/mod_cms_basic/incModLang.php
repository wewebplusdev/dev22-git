...
$langMod["txt:type_display"] = "Display";

$langMod["tit:link"] ="URL";
$langMod["edit:linknote"] = "Note: Please enter the URL name prefixed with \" http: // \". For example: http://www.wewebplus.com. Etc. "." <br> "." If there is no URL name, add # ";
$langMod ["txt:groupType"] = "Type description";
$langMod ["txt:groupTypeDe"] = "Please enter the part used to define the news display description. To display results on the website ";
$langMod ["tit:groupType"] = "Description type";

$langMod["tit:groupType"] = "Type attachment";
$langMod["tit:linkdownload"] = "URL File";
$langMod["tit:linkdownloadnote"] = "Note: Please enter the URL name, prefixed with \" http: // \". For example: http://www.google.com. Etc.";
}else{
...
$langMod["meu:selectgn"] = " ". $langMod["meu:group"];
$langMod["txt:type_display"] = "การแสดงผล";
$langMod["tit:link"] ="URL";
$langMod["meu:setPermis"] = "Setting";
$langMod["txt:titleadds"] = "". $langMod["meu:setPermis"]." New";
$langMod["txt:titleedits"] = "". $langMod["meu:setPermis"]." Edit";
