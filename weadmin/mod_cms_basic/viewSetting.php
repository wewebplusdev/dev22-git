...
$sql .= " , " . $mod_tb_setting . "_subjecten as subjecten, " . $mod_tb_setting . "_titleen as titleen, " . $mod_tb_setting . "_htmlfilenameen as htmlfilenameen, " . $mod_tb_setting . "_metatitleen as metatitleen, " . $mod_tb_setting . "_descriptionen as descriptionen, " . $mod_tb_setting . "_keywordsen as keywordsen ";
$sql .= " , " . $mod_tb_setting . "_subjectcn as subjectcn, " . $mod_tb_setting . "_titlecn as titlecn, " . $mod_tb_setting . "_htmlfilenamecn as htmlfilenamecn, " . $mod_tb_setting . "_metatitlecn as metatitlecn, " . $mod_tb_setting . "_descriptioncn as descriptioncn, " . $mod_tb_setting . "_keywordscn as keywordscn ";
...
// print_pre($Row);
    ...
    $valSubjectEN = rechangeQuot($Row['subjecten']);
    $valTitleEN = rechangeQuot($Row['titleen']);
    $valHtmlEN = $mod_path_html . "/" . $Row['htmlfilenameen'];
    $valSubjectCN = rechangeQuot($Row['subjectcn']);
    $valTitleCN = rechangeQuot($Row['titlecn']);
    $valHtmlCN = $mod_path_html . "/" . $Row['htmlfilenamecn'];
        ...
        <form action="?" method="get" name="myForm" id="myForm">
            ...
            <div class="divRightMain">
                ...
                <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                    <tr>
                        <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
                            <span class="formFontSubjectTxt"><?php echo $langMod["txt:subject"] ?><?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>(<?php echo $langTxt["lg:chi"] ?>)<?php } ?></span><br />
                            <span class="formFontTileTxt"><?php echo $langMod["txt:subjectDe"] ?></span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="18%" align="right" valign="top" class="formLeftContantTb"><?php echo $langMod["tit:title"] ?>:<span class="fontContantAlert"></span></td>
                        <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                            <div class="formDivView"><?php echo $valTitleCN ?></div>
                        </td>
                    </tr>
                </table>
                <br />
