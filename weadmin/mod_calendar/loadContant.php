...
<body>
        ...
        <div class="divRightHeadSearch">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:20px;" align="center">
                <tr>
                    ...
                    <td style="padding-right:10px;" width="5%">&nbsp;</td>
                </tr>
                <tr>
 ...
 " . $mod_tb_root . "_piccn";
                ...
                $sql = $sql . "  ON " . $mod_tb_root . "." . $mod_tb_root . "_id = " . $mod_tb_date . "." . $mod_tb_date . "_cid ";
                ...
                if ($_REQUEST['sdateInputSe'] <> "" && $_REQUEST['edateInputSe'] <> "") {
                    ...
                    $sql = $sql . "  AND  (" . $mod_tb_date . "_date BETWEEN '" . $valSdate . " 00:00:00' AND '" . $valEdate . " 23:59:59')  ";
                }
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                                <td width="21" align="center"> <img src="../img/controlpage/playset_backward.gif" width="21" height="21" style="cursor:pointer;" onmouseover="this.src = '../img/controlpage/playset_backward_active.gif';
                                                                                                                this.style.cursor = 'hand';" onmouseout="this.src = '../img/controlpage/playset_backward.gif';" onclick="document.myForm.module_pageshow.value = '<?php echo  $valPrePage ?>'; document.myForm.submit();" /></td>
                                            <?php } else { ?>
                                            ...
                                            ?>
                                                <td width="21" align="center"> <img src="../img/controlpage/playset_forward.gif" width="21" height="21" style="cursor:pointer;" onmouseover="this.src = '../img/controlpage/playset_forward_active.gif';
                                                                                                                this.style.cursor = 'hand';" onmouseout="this.src = '../img/controlpage/playset_forward.gif';" onclick="document.myForm.module_pageshow.value = '<?php echo  $valNextPage ?>'; document.myForm.submit();" /></td>
                                            <?php } else { ?>
