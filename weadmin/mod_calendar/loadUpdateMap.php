...
<?php
	...
	if(!empty($_FILES['fileToUploadMap']['error'])){
		...
		$update = array();
		$update[]=$mod_tb_root."_map  	='".$picname."'";
		...
		$msg .= "<div style=\"width:22px; height:22px;float:left;z-index:1; margin-left:-22px;cursor:pointer;\" onclick=\"delMapUpload(\'deleteMap.php\')\"  title=\"Delete file\" ><img src=\"../img/btn/delete.png\" width=\"22\" height=\"22\"  border=\"0\"/></div>";
