...
$valLinkNav1="../core/index.php";
            ...
            $sql .= "  ,".$mod_tb_root_group."_type, ".$mod_tb_root_group."_url, ".$mod_tb_root_group."_target   ";
...
<form action="?" method="get" name="myForm" id="myForm">
   ...
   <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr >
            ...
            <div class="formDivView"><?php echo $modGroupType['Thai'][$valType];?></div>
        ...
        <tr class="boxInputlink"  <?php if($valType == 1){ ?> style="display:none;" <?php } ?>>
          ...
          <tr class="boxInputlink"  <?php if($valType == 1){ ?> style="display:none;" <?php } ?>>
            ...
            <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo  $modTxtTarget[$valTarget] ?></div></td>
        </tr>
