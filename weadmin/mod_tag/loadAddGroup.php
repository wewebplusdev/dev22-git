                    ...
                    <form action="?" method="get" name="myForm" id="myForm">
                        ...
                        <div class="divRightNav">
                            <table width="96%" border="0" cellspacing="0" cellpadding="0"  align="center" >
                                <tr>
                                    <td  class="divRightNavTb" align="left"  id="defTop" ><span class="fontContantTbNav"><a href="<?php echo  $valLinkNav1 ?>" target="_self"><?php echo  $valNav1 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a  href="javascript:void(0)"  onclick="btnBackPage('group.php')" target="_self"><?php echo  $langMod["meu:group"] ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php echo  $langMod["txt:titleaddg"] ?> <?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2) { ?>(<?php echo  $langTxt["lg:thai"] ?>)<?php } ?></span></td>
                        ...
                        <div class="divRightMain" >
                            ...
                            <tr >
                                ...
                                <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                                    ...
                                    <label>
                                        <div class="formDivRadioL"><input name="inputType" id="inputType" value="1" class="formRadioContantTb" checked="checked"  type="radio" onclick="jQuery('.boxInputlink').hide();"/></div>
                                        <div class="formDivRadioR"><?php echo  $modGroupType['Thai'][1]; ?></div>
                                    </label>

                                    <label>
                                        <div class="formDivRadioL"><input name="inputType" id="inputType" value="2" class="formRadioContantTb" type="radio" onclick="jQuery('.boxInputlink').show();"/></div>
                                        <div class="formDivRadioR"><?php echo  $modGroupType['Thai'][2]; ?></div>
                                    </label>
                                </td>
                            </tr>

                            <tr class="boxInputlink"  style="display:none;">
