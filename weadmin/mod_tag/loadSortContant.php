                ...
                <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" style="	border-top:#c8c7cc solid 1px;"> 
                    <tr >
                        <td  colspan="7" align="left"  valign="middle" class="formTileTxt">
                            <?php
                            $sql = "SELECT   " . $mod_tb_root . "_id," . $mod_tb_root . "_subject," . $mod_tb_root . "_lastdate," . $mod_tb_root . "_status," . $mod_tb_root . "_subject  FROM " . $mod_tb_root . " WHERE " . $mod_tb_root . "_masterkey ='" . $_REQUEST['masterkey'] . "'    ";
