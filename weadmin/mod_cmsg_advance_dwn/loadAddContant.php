                ...
                <tr>
                    ...
                    <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
                        <select name="inputGroupID" id="inputGroupID" class="formSelectContantTb" onchange="onChangeSelect('openSelectSub.php','#subgroup');">
                            ...
                            ?>
                                <option value="<?php echo $row_groupid ?>" <?php if ($_REQUEST['inputGh'] == $row_groupid) { ?> selected="selected" <?php } ?> data-type="<?php echo $row_group[2] ?>"><?php echo $row_groupname ?></option>
                            <?php } ?>
                        </select>
                    </td>
                </tr>
