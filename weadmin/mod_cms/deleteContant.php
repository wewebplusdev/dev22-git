...
for($i=1;$i<=$_REQUEST['TotalCheckBoxID'];$i++) {
 $myVar=$_REQUEST['CheckBoxID'.$i];
	...
	$permissionID=$myVar;
			...
			$sql = "SELECT  ".$mod_tb_root."_htmlfilename,".$mod_tb_root."_pic,".$mod_tb_root."_filevdo,".$mod_tb_root."_htmlfilenameen,".$mod_tb_root."_picen FROM ".$mod_tb_root." WHERE  ".$mod_tb_root."_id='".$permissionID."' ";
