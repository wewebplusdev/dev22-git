                    ...
                    <form action="?" method="get" name="myForm" id="myForm">
                        ...
                        <div class="divRightNav">
                            <table width="96%" border="0" cellspacing="0" cellpadding="0"  align="center" >
                                <tr>
                                    <td  class="divRightNavTb" align="left"  id="defTop" ><span class="fontContantTbNav"><a href="<?php echo $valLinkNav1 ?>" target="_self"><?php echo $valNav1 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a  href="javascript:void(0)"  onclick="btnBackPage('groupPage.php')" target="_self"><?php echo $langMod["meu:group"] ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php echo $langMod["txt:sortpermisg"] ?></span></td>
                                            ...
                                            <tr>
                                                <td align="right">
                                                    <?php if ($valPermission == "RW") { ?>
                                                        <div  class="btnSave" title="<?php echo $langTxt["btn:save"] ?>" onclick="sortingContactNew('sortingGroupPage.php');"></div><?php } ?>
                                                    <div  class="btnBack" title="<?php echo $langTxt["btn:back"] ?>" onclick="btnBackPage('groupPage.php')"></div>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr >
                                    <td  colspan="7" align="left"  valign="middle" class="formTileTxt">
                                        ...
                                        if (!empty($_REQUEST['inputGh'])) {
                                            $sql .= "  AND " . $mod_tb_root_group . "_show_" . $_REQUEST['inputGh'] . " ='Enable'   ";
                                        }

                                        $sql .= " ORDER BY " . $mod_tb_root_group . "_order_".$_REQUEST['inputGh']." DESC";
