...
$valLinkNav1="../core/index.php";
      ...
      ".$mod_tb_root_group."_crebyid, ".$mod_tb_root_group."_status  ";
			...
			$sql .= " , ".$mod_tb_root_group."_pic, ".$mod_tb_root_group."_pic2	," . $mod_tb_root_group . "_type ,    " . $mod_tb_root_group . "_url,    " . $mod_tb_root_group . "_target FROM ".$mod_tb_root_group." WHERE ".$mod_tb_root_group."_masterkey='".$_POST["masterkey"]."' AND  ".$mod_tb_root_group."_id 	='".$_POST["valEditID"]."'";
