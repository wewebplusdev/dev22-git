...
function loadCheckUser() {
	with(document.myForm) {
		...
		if( inputValuename!=''){
			checkUsermemberMimisite(inputValuename);
		}
}

function loadCheckUrl() {
	with(document.myForm) {
		var inputValueUrlMinisite =document.myForm.inputUrlMinisite.value;
		}
		if( inputValueUrlMinisite!=''){
			checkUrlMimisite(inputValueUrlMinisite);
		}
}
...
<form action="?" method="get" name="myForm" id="myForm"   enctype="multipart/form-data">
    ...
    <input type="hidden" value="<?php echo  $valinID ?>" name="inputInfoid" id="inputInfoid"/>
   <input type="hidden" name="inputTheme" id="inputTheme" value=""/>					
   
   <div class="divRightNav">
                        <table width="96%" border="0" cellspacing="0" cellpadding="0"  align="center" >
                        <tr>
                        <td  class="divRightNavTb" align="left"  id="defTop" ><span class="fontContantTbNav"><a href="<?php echo $valLinkNav1?>" target="_self"><?php echo $valNav1?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a  href="javascript:void(0)"  onclick="btnBackPage('index.php')" target="_self"><?php echo $langMod["tit:inpName"]?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php echo $langMod["txt:titleadd"]?><?php if($_SESSION[$valSiteManage.'core_session_languageT']==2){ ?>(<?php echo $langTxt["lg:thai"]?>)<?php } ?></span></td>
...
<tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><input name="inputUrlMinisite" id="inputUrlMinisite" type="text"  class="formInputContantTbShot" onblur="loadCheckUrl()" /><br />
<span class="formFontNoteTxt"><?php echo $langMod["mit:noteurlminisite"]?></span></td>
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><input name="inputUsername" id="inputUsername" type="text"  class="formInputContantTbShot" onblur="loadCheckUser()"/></td>
  </tr>
   <tr >
  ...
  <tr>
    <td><input name="inputPassword" id="inputPassword" type="text"  class="formInputContantTbShot"/></td>
    <td width="10"></td>
...
<script type="text/javascript" language="javascript">
	...
	function ajaxFileUploadMap(){
		...
		jQuery.ajaxFileUpload({
				url:'loadInsertPicMap.php?myID=<?php echo $myRand?>&masterkey=<?php echo $_REQUEST['masterkey']?>&langt=<?php echo $_REQUEST['inputLt']?>&delpicname='+valuepicname+'&menuid=<?php echo $_REQUEST['menukeyid']?>',
				secureuri:false,
