...
// Check to set default value #########################
					...
					if($_REQUEST['sdateInputSe']<>"" && $_REQUEST['edateInputSe']<>"" ) {
						$valSdate =DateFormatInsertNoTimeLogs($_REQUEST['sdateInputSe']);
						$valEdate =DateFormatInsertNoTimeLogs($_REQUEST['edateInputSe']);
                    ...
                    <form action="?" method="post" name="myForm" id="myForm">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:20px;" align="center">
                                ...
                                <input name="sdateInput" type="text"  id="sdateInput"  placeholder="<?php echo $langMod["tit:sSedate"]?>" autocomplete="off" value="<?php echo trim($_REQUEST['sdateInputSe'])?>" class="formInputSearchStyle" style="margin-bottom: 10px;"/>
                                
												
								</td>
								<td class="selectSearch4" >
                                <input name="edateInput" type="text"  id="edateInput"  placeholder="<?php echo $langMod["tit:eSedate"]?>" autocomplete="off" value="<?php echo trim($_REQUEST['edateInputSe'])?>" class="formInputSearchStyle" style="margin-bottom: 10px;"/>
												
								</td>
                                <td class="bottonSearchStyle" align="right" >&nbsp;</td>
								</tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:20px;" align="center">
                                ...
                                <td class="selectSearch1">
                                        <input name="sdateInput" type="text"  id="sdateInput"  placeholder="<?php echo $langMod["tit:sSedate"]?>" value="<?php echo trim($_REQUEST['sdateInputSe'])?>" class="formInputSearchStyle" />
                                </td>
                                <td class="selectSearch1">
                                        <input name="edateInput" type="text"  id="edateInput"  placeholder="<?php echo $langMod["tit:eSedate"]?>" value="<?php echo trim($_REQUEST['edateInputSe'])?>" class="formInputSearchStyle" />
                                </td>
                                <td   id="boxSelectTest"  class="textSearch2">
                            <input name="inputSearch" type="text"  id="inputSearch" value="<?php echo trim($_REQUEST['inputSearch'])?>" class="formInputSearchStyle"  placeholder="<?php echo $langTxt["sch:search"]?>" /></td>
