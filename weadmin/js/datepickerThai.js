jQuery(function(){
    ...
    jQuery("#expDateInput,#reportDateInput,#finalDateInput").datepicker({
        dateFormat: 'dd-mm-yy',
        showOn: 'focus',
        buttonImage: '../img/calendar/calendar.gif',
        buttonImageOnly: true,
