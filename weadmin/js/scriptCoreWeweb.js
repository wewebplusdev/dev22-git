...
function delFileUploadShow(fileAc) {
    ...
    jQuery.ajax({
        ...
        success: function(html) {
            ...
            jQuery("#boxFileShow").show();
            jQuery("#boxFileShow").html(html);
            setTimeout(jQuery.unblockUI, 200);
...
function delFileUploadpro(fileAc) {
    ...
    jQuery.ajax({
        ...
        success: function(html) {
            ...
            jQuery("#boxFileNewprofile").html(html);
            setTimeout(jQuery.unblockUI, 200);
...
function delFileUploadpre(fileAc) {
    ...
    jQuery.ajax({
        ...
        success: function(html) {
            ...
            jQuery("#boxFileNewpresent").html(html);
            setTimeout(jQuery.unblockUI, 200);
...
function delFileUploadAch(fileAc) {
    ...
    jQuery.ajax({
        ...
        success: function(html) {
            ...
            jQuery("#boxFileNewachieve").html(html);
            setTimeout(jQuery.unblockUI, 200);
...
function delPicUpload_mul(fileAc, boxFile) {
...
function urlfriendly(target = '', target2 = '', fileAc) {
    var url = jQuery("#" + target).val();
