...
<?php
	...
	// 	$error = 'PNG ONLY';
		...
		if(!is_dir($mod_path_real)) { mkdir($mod_path_real,0777); }
			...
			$TIME=time();
			if(!$ERROR) {
			$filename="pic-icon2-".$_REQUEST['myID'];
		...
		$msg .= "<div style=\"width:22px; height:22px;float:left;z-index:1; margin-left:-22px;cursor:pointer;\" onclick=\"delPicUploadSite(\'deletePicInsertG2.php\',\'boxPic2\')\"  title=\"Delete file\" ><img src=\"../img/btn/delete.png\" width=\"22\" height=\"22\"  border=\"0\"/></div>";
