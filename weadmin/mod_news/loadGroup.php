            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    <td class="divRightNavTb" align="left"><span class="fontContantTbNav"><a
                                ...
                                src="../img/btn/navblack.png" align="absmiddle" vspace="5" />
                    ...
                    <td class="divRightNavTb" align="right">
                        ...
                        <div class="menuSubMod ">
                            <a
                                href="index.php?masterkey=<?php echo $_REQUEST['masterkey'] ?>&menukeyid=<?php echo $_REQUEST['menukeyid'] ?>">
        ...
        <div class="divRightHeadSearch">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:20px;" align="center">
                ...
                <tr>
                    ...
                    <td style="padding-right:10px;" align="right" width="6%"><input name="searchOk" id="searchOk"
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" align="right">
                            <tr>
                                <td align="right">
                                    ...
                                    <div class="btnAdd" title="<?php echo $langTxt["btn:add"]?>"
                                        onclick="document.myFormHome.inputLt.value='Thai';  addContactNew('addGroup.php');">
                                    </div>
		...
		alert('<?php echo $langTxt["mg:selpermis"] ?>');
				  ...
				  "></div>
                                    <div class="btnSort" title="<?php echo $langTxt["btn:sortting"]?>"
                                        onclick="sortContactNew('sortGroup.php');"></div>
                                    <?php } ?>
                                </td>
                            </tr>
                        </table>
        ...
        <div class="divRightMain">
            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
                <tr>
                    ...
                    <td width="12%" class="divRightTitleTb" valign="middle" align="center"><span
                            class="fontTitlTbRight"><?php echo $langTxt["mg:status"]?></span></td>
                    <td width="12%" class="divRightTitleTb" valign="middle" align="center"><span
                            class="fontTitlTbRight"><?php echo $langTxt["us:lastdate"]?></span></td>
                    <td width="12%" class="divRightTitleTbR" valign="middle" align="center"><span
...
if($inputSearch<>"") {
		...
		".$mod_tb_root_group."_subjecten LIKE '%$inputSearch%' OR
  ...
  ?>
   ...
   document.myFormHome.valEditID.value=<?php echo $valID?>;
    viewContactNew('viewGroup.php');"><?php echo $valName?></a>
      ...
      document.myFormHome.valEditID.value=<?php echo $valID?>;
        viewContactNew('viewGroup.php');"><?php echo $valNameEn?></a></td>
                            </tr>
                        </table>
                    </td>
                    <?php } ?>
            ...
            document.myFormHome.valEditID.value=<?php echo $valID?>;
            viewContactNew('viewGroup.php');"><?php echo $valNameCn?></a></td>
                            </tr>
                        </table>
                    </td>
                    <?php } ?>
                    <td class="divRightContantOverTb" valign="top" align="center">
                        ...
                        <div id="load_status<?php echo $valID?>">
                            ...
                            <a href="javascript:void(0)"
                                onclick="changeStatusHome('load_waiting<?php echo $valID?>','<?php echo $mod_tb_root_group?>','<?php echo $valStatus?>','<?php echo $valID?>','load_status<?php echo $valID?>','../<?php echo $mod_fd_root?>/statusMgH.php','<?php echo $_REQUEST['masterkey'] ?>')"><span
                                    class="<?php echo $valStatusClass?>"><?php echo $valStatus?></span></a>

                            <?php }elseif($valStatus=="Home"){ ?>
                            <a href="javascript:void(0)"
                                onclick="changeStatusHome('load_waiting<?php echo $valID?>','<?php echo $mod_tb_root_group?>','<?php echo $valStatus?>','<?php echo $valID?>','load_status<?php echo $valID?>','../<?php echo $mod_fd_root?>/statusMgH.php','<?php echo $_REQUEST['masterkey'] ?>')">
                        ...
                        <div id="load_status<?php echo $valID?>">
                            ...
                            <a href="javascript:void(0)"
                                onclick="changeStatus('load_waiting<?php echo $valID?>','<?php echo $mod_tb_root_group?>','<?php echo $valStatus?>','<?php echo $valID?>','load_status<?php echo $valID?>','../<?php echo $mod_fd_root?>/statusMgH.php')"><span
                                    class="<?php echo $valStatusClass?>"><?php echo $valStatus?></span></a>

                            <?php }else{ ?>

                            <a href="javascript:void(0)"
                                onclick="changeStatus('load_waiting<?php echo $valID?>','<?php echo $mod_tb_root_group?>','<?php echo $valStatus?>','<?php echo $valID?>','load_status<?php echo $valID?>','../<?php echo $mod_fd_root?>/statusMgH.php')">
                                <span class="<?php echo $valStatusClass?>"><?php echo $valStatus?></span> </a>
                                        ...
                                        <tr>
                                            <td align="right" style="padding-right:10px;"><span
                                                    ...
                                                    <select name="toolbarPageShow" class="formSelectContantPage"
                                                        onChange="document.myForm.module_pageshow.value=this.value; document.myForm.submit(); ">
                                                        <?php
...
?>
                                            ...
                                            <td width="21" align="center"> <img
                                                    ...
                                                    onclick="document.myForm.module_pageshow.value=1; document.myForm.submit();"
