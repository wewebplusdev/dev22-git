...
<?php
	if($execute=="update"){
		...
		// $update[]=$mod_tb_root."_credit='".changeQuot($_POST['inputCredit'])."'";
		...
		// $update[]=$mod_tb_root."_htmlfilename2en  	='".$filename2."'";
		// $update[]=$mod_tb_root."_crediten='".changeQuot($_POST['inputCredit'])."'";
		}else{
		...
		// $update[]=$mod_tb_root."_creditcn='".changeQuot($_POST['inputCredit'])."'";
		}
