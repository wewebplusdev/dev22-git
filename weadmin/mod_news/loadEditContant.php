...
$sql .= " , " . $mod_tb_root . "_picshow, " . $mod_tb_root . "_typec , " . $mod_tb_root . "_urlc, " . $mod_tb_root . "_target, " . $mod_tb_root . "_pic2, " . $mod_tb_root . "_title2 ";
	...
	<script language="JavaScript" type="text/javascript">
		function executeSubmit() {
			with(document.myForm) {
				...
				<?php if ($_REQUEST['masterkey'] == 'sl' || $_REQUEST['masterkey'] == 'nr' || $_REQUEST['masterkey'] == 'ac' || $_REQUEST['masterkey'] == 'news') { ?>
		...
		jQuery(document).ready(function() {
			...
			jQuery('#myForm').keypress(function(e) {
				...
				// var focusManager2 = new CKEDITOR.focusManager( editDetail2 );
				// var checkFocus2 =CKEDITOR.instances.editDetail.focusManager.hasFocus;
...
<body>
    ...
    <input name="inputHtmlDel2" type="hidden" id="inputHtmlDel2" value="<?php echo $valhtmlname2 ?>" /> -->
		...
		<td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
			...
			<br />
			<?php if (!in_array($_REQUEST['masterkey'], $array_uploadPic)) { ?>
				<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
					<tr>
						<td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
    ...
    <tr >
    <td colspan="7" align="left"  valign="middle" class="formTileTxt tbBoxViewBorderBottom">
    <span class="formFontSubjectTxt">Icon</span><br/>
    <span class="formFontTileTxt"><?php echo $langMod["txt:picDe"] ?></span>    </td>
    </tr>
                            <tr ><td colspan="7" align="right"  valign="top"   height="15" ></td></tr>

  <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo $langMod["inp:album"] ?> Icon</td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
    <div class="file-input-wrapper">
  <button class="btn-file-input"><?php echo $langTxt["us:inputpicselect"] ?></button>
...
<span class="formFontNoteTxt"><?php echo $langMod["inp:noteicon"] ?></span>
<div class="clearAll"></div>
