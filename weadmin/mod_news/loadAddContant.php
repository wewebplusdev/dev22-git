    ...
    <script language="JavaScript" type="text/javascript">
        ...
        jQuery(document).ready(function() {
            ...
            jQuery('#myForm').keypress(function(e) {
                ...
                var masterkeya = $('input[name="masterkey"]').val();
                ...
                // var checkFocus2 = CKEDITOR.instances.editDetail2.focusManager.hasFocus;
        ...
        <div class="divRightMain">
            ...
            <?php if (!in_array($_REQUEST['masterkey'],$array_uploadPic)) { ?>
                <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                    ...
                    <!-- <tr >
                                    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo $langMod["tit:credit"] ?><span class="fontContantAlert"></span></td>
                                    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><input name="inputCredit" id="inputCredit" type="text"  class="formInputContantTb"/></td>
                                </tr> -->
