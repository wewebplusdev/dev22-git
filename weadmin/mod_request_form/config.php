...
## Mod Table ###################################
$mod_tb_root = "md_cus";
$mod_tb_root_group = "md_cug";
$mod_tb_root_email = "md_cue";
// $mod_tb_setting = "md_cuss";
$mod_tb_setting = "md_cmss2";
## Mod Folder ###################################
$mod_fd_root = "mod_request_form";


$mod_path_html        = $core_pathname_upload."/".$masterkey."/html";
$mod_path_html_fornt  = $core_pathname_upload_fornt."/".$masterkey."/html";

$mod_path_index        = $core_pathname_upload."/".$masterkey."/index";  
$mod_path_index_fornt  = $core_pathname_upload_fornt."/".$masterkey."/index";

$mod_path_office        = $core_pathname_upload."/".$masterkey."/office";  
$mod_path_office_fornt  = $core_pathname_upload_fornt."/".$masterkey."/office";

$mod_path_240        = $core_pathname_upload."/".$masterkey."/240";  
$mod_path_240_fornt  = $core_pathname_upload_fornt."/".$masterkey."/240";
$mod_path_240_fornt_m  = $core_pathname_upload_m."/".$masterkey."/240";
...
$mod_path_file_fornt_m  = $core_pathname_upload_m."/".$masterkey."/file";  

$mod_path_vdo        = $core_pathname_upload."/".$masterkey."/vdo";  
$mod_path_vdo_fornt  = $core_pathname_upload_fornt."/".$masterkey."/vdo";   
$mod_path_vdo_fornt_m  = $core_pathname_upload_m."/".$masterkey."/vdo";   
