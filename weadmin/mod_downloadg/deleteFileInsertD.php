...
include("config.php");
	...
	$valLimitMysql =" LIMIT 0,1";
		 ...
		 $sql="SELECT ".$valLimitTop." ".$sqlSelect." FROM ".$mod_tb_fileTemp." WHERE ".$mod_tb_fileTemp."_contantid 	='".$_REQUEST['valEditID']."'   AND   ".$mod_tb_fileTemp."_language ='".$_REQUEST['inputLt']."'  ORDER BY ".$mod_tb_fileTemp."_id ASC     ".$valLimitMysql."";
