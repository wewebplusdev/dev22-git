...
include("config.php");
	...
	$sql_fileNew="SELECT ".$mod_tb_fileD."_filename  FROM ".$mod_tb_fileD." WHERE ".$mod_tb_fileD."_id 	='".$_REQUEST['valDelFile']."' ";
	...
	$sql="DELETE FROM ".$mod_tb_fileD." WHERE   ".$mod_tb_fileD."_id='".$_REQUEST['valDelFile']."' ";
	$Query=wewebQueryDB($coreLanguageSQL,$sql);
	
			
		$sql="SELECT ".$mod_tb_fileD."_id,".$mod_tb_fileD."_filename,".$mod_tb_fileD."_name,".$mod_tb_fileD."_download FROM ".$mod_tb_fileD." WHERE ".$mod_tb_fileD."_contantid 	='".$_REQUEST['valEditID']."'  AND   ".$mod_tb_fileD."_language ='".$_REQUEST['inputLt']."'  ORDER BY ".$mod_tb_fileD."_id ASC LIMIT 0,1";
