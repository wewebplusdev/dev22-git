...
$langMod["txt:titleadds"] = "" .$langMod["meu:sub"]." New";
$langMod["txt:titleedits"] = "" .$langMod["meu:sub"]." Edit";
$langMod["txt:titleviews"] = "" .$langMod["meu:sub"]." Display";
$langMod["txt:sortpermiss"] = "" .$langMod["meu:sub"]." Sort";
...
$langMod["txt:subjects"] = "" .$langMod["meu:sub"]." Info";
$langMod["txt:subjectsDe"] = "Please enter a selection, group, title and subtitle. To use to display content on the page, include all of this menu information on your site. ";
...
$langMod["tit:subjectsg"] = "Name ". $langMod["meu:sub"];
...
$langMod["tit:linkurl"] = "Url link";
$langMod["tit:note"] = "Note: Please enter the URL name, prefixed with \" http: // \". For example: http://www.google.com. Etc. "." <br> "
...
$langMod["tit:selectsg"] = "Select ". $langMod["meu:sub"];
...
$langMod["tit:selectyear"] ="Select Year";
$langMod["tit:year"] ="Annual";
}else{
