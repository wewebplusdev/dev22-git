  ...
  <form action="?" method="post" name="myForm" id="myForm">
    ...
    <div class="divRightHeadSearch">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:20px;" align="center">
        ...
        <tr>
          <td style="padding-right:10px;" <?php if(!in_array($_REQUEST['masterkey'], $arr_masterkey)){ echo 'width="25%"'; }else{ echo 'width="42%"'; } ?>>
          ...
          <?php if(!in_array($_REQUEST['masterkey'], $arr_masterkey)){ ?>
            ...
            <select name="inputGh2" id="inputGh2" onchange="document.myForm.submit(); " class="formSelectSearchStyle">
              ...
              <?php
              $sql_group = "SELECT " . $mod_tb_root_sub . "_id," . $mod_tb_root_sub . "_subject," . $mod_tb_root_sub . "_subjecten  FROM " . $mod_tb_root_sub . " WHERE  " . $mod_tb_root_sub . "_masterkey ='" . $_REQUEST['masterkey'] . "'  ORDER BY " . $mod_tb_root_sub . "_order DESC ";
              $query_group = wewebQueryDB($coreLanguageSQL, $sql_group);
              ...
              ?>
                <option value="<?php echo $row_groupid ?>" <?php if ($_REQUEST['inputGh2'] == $row_groupid) { ?> selected="selected" <?php  } ?>><?php echo $valNameShow ?></option>
              <?php } ?>
            </select>
          </td>
          <?php }?>
    ...
    <div class="divRightMain">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
        <tr>
          ...
          <td align="left" width="22%" valign="middle" class="divRightTitleTb"><span class="fontTitlTbRight"><?php echo $langMod["tit:subject"] ?><?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2) { ?>(<?php echo $langTxt["lg:thai"] ?>)<?php } ?></span></td>
          ...
          <?php } ?>
          <td width="12%" class="divRightTitleTb" valign="middle" align="center"><span class="fontTitlTbRight"><?php echo $langMod["file:download"] ?></span></td>
          <?php if(!in_array($_REQUEST['masterkey'], $arr_masterkey)){ ?>
          <td width="12%" class="divRightTitleTb" valign="middle" align="center"><span class="fontTitlTbRight">Pin/Unpin</span></td>
          <?php } ?>
        ...
        if ($_REQUEST['inputGh2'] >= 1) {
          $sql = $sql . "  AND " . $mod_tb_root . "_year ='" . $_REQUEST['inputGh2'] . "'   ";
        }
        ...
        if ($count_record > 0) {
          while ($index < $count_record + 1) {
            ...
            $valNameCn = rechangeQuot($row[10]);
            $valNameCn = chechNullVal($valNameCn);
            $valPicen = $mod_path_office . "/" . $row[11];
            if (is_file($valPicen)) {
              $valPicen = $valPicen;
            } else {
    ...
    viewContactNew('viewContant.php');"><?php echo $valName ?></a>
        ...
        viewContactNew('viewContant.php');"><?php echo $valNameEn ?></a>
            ...
            viewContactNew('viewContant.php');"><?php echo $valNameCn ?></a>
              ...
              <?php } ?>
              <td class="divRightContantOverTb" valign="top" align="center"><span class="fontContantTbupdate"><?php echo $valDownload ?></span></td>
              <?php if(!in_array($_REQUEST['masterkey'], $arr_masterkey)){ ?>
              ...
              <td class="divRightContantOverTb" valign="top" align="center">
                <?php if ($valPermissionContent == "RW") { ?>
                  <div id="load_status<?php echo $valID ?>">
                    ...
                    <?php } else if ($valStatus == "Home" && !in_array($_REQUEST['masterkey'], $arr_masterkey_home)) { ?>
   ...
   document.myFormHome.valEditID.value=<?php echo $valID ?>;
    editContactNew('topUpdateContant.php');">
                          ...
                          <span class="fontContantTbManage"><?php echo $langTxt["btn:top"] ?><?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?><br />
                            (<?php echo $langTxt["lg:all"] ?>)<?php } ?></span></div>
                      </td>
                      <td valign="top" align="center" width="30">
   ...
   document.myFormHome.valEditID.value=<?php echo $valID ?>;
    editContactNew('editContant.php');">
                          ...
                          <span class="fontContantTbManage"><?php echo $langTxt["btn:edit"] ?><?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?><br />
                            (<?php echo $langTxt["lg:thai"] ?>)<?php } ?></span> </div>
                      </td>
                      <?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>
                        <td valign="top" align="center" width="30">
                          <div class="divRightManage" title="<?php echo $langTxt["btn:edit"] ?>" onclick="
