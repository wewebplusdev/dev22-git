...
$valLinkNav1="../core/index.php";
      ...
      ".$mod_tb_root_group."_crebyid, ".$mod_tb_root_group."_status  ";
			...
			$sql .= " , ".$mod_tb_root_group."_pic, ".$mod_tb_root_group."_pic2	," . $mod_tb_root_group . "_type ,    " . $mod_tb_root_group . "_url,    " . $mod_tb_root_group . "_target,    " . $mod_tb_root_group . "_layout
			...
			$valPicName2=$Row[7];
			$valPic2=$mod_path_pictures."/".$Row[7];
			$valType = $Row[8];
			$valUrl = $Row[9];
			$valTarget = $Row[10];
			$valLayout = $Row[11];
...
<form action="?" method="get" name="myForm" id="myForm">
    ...
    <input name="inputLt" type="hidden" id="inputLt" value="<?php echo $_REQUEST['inputLt']?>" />
					<div class="divRightNav">
                        ...
                        <tr>
                        <td  class="divRightNavTb" align="left"  id="defTop" ><span class="fontContantTbNav"><a href="<?php echo $valLinkNav1?>" target="_self"><?php echo $valNav1?></a> <img src="../img/btn/navblack.png" align="absmiddle" vspace="5" /> <a  href="javascript:void(0)"  onclick="btnBackPage('group.php')" target="_self"><?php echo $langMod["meu:group"]?></a> <img src="../img/btn/navblack.png" align="absmiddle" vspace="5" /> <?php echo $langMod["txt:titleeditg"]?><?php if($_SESSION[$valSiteManage.'core_session_languageT']==2 || $_SESSION[$valSiteManage.'core_session_languageT']==3){ ?>(<?php echo getSystemLangTxt($_REQUEST['inputLt'],$langTxt["lg:thai"],$langTxt["lg:eng"],$langTxt["lg:chi"])?>)<?php } ?></span></td>
  ...
  <!-- <tr >
		<td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo  $modTxtLayout[0]; ?><span class="fontContantAlert">*</span></td>
		<td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >


			<label>
				<div class="formDivRadioL"><input name="inputLayout" id="inputLayout" value="1" class="formRadioContantTb" type="radio"  <?php if($valLayout == 1){ ?> checked="checked" <?php } ?>  /></div>
				<div class="formDivRadioR"><?php echo  $modTxtLayout[1]; ?></div>
			</label>

			<label>
				<div class="formDivRadioL"><input name="inputLayout" id="inputLayout" value="2" class="formRadioContantTb"  type="radio" <?php if($valLayout == 2){ ?> checked="checked" <?php } ?> /></div>
				<div class="formDivRadioR"><?php echo  $modTxtLayout[2]; ?></div>
			</label>
		</td>
	</tr> -->
