...
include("config.php");
	...
	$sql_fileNew="SELECT ".$mod_tb_file."_filename  FROM ".$mod_tb_file." WHERE ".$mod_tb_file."_id 	='".$_REQUEST['valDelFile']."' AND " . $mod_tb_file . "_language ='".$_REQUEST['inputLt']."' ";
	...
	$sql="DELETE FROM ".$mod_tb_file." WHERE   ".$mod_tb_file."_id='".$_REQUEST['valDelFile']."' AND " . $mod_tb_file . "_language ='".$_REQUEST['inputLt']."' ";
	$Query=wewebQueryDB($coreLanguageSQL,$sql);
	
			
		$sql="SELECT ".$mod_tb_file."_id,".$mod_tb_file."_filename,".$mod_tb_file."_name,".$mod_tb_file."_download FROM ".$mod_tb_file." WHERE ".$mod_tb_file."_contantid 	='".$_REQUEST['valEditID']."' AND " . $mod_tb_file . "_language ='".$_REQUEST['inputLt']."'  ORDER BY ".$mod_tb_file."_id ASC";
