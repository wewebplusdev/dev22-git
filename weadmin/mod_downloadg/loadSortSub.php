...
<form action="?" method="get" name="myForm" id="myForm">
    ...
    <input name="inputSort" type="hidden" id="inputSort" value="" />
					...
					<div class="divRightNav">
                        ...
                        <tr>
                        <td  class="divRightNavTb" align="left"  id="defTop" ><span class="fontContantTbNav"><a href="<?php echo  $valLinkNav1?>" target="_self"><?php echo  $valNav1?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a  href="javascript:void(0)"  onclick="btnBackPage('sub.php')" target="_self"><?php echo  $langMod["meu:sub"]?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php echo  $langMod["txt:sortpermiss"]?></span></td>
                        <td  class="divRightNavTb" align="right">
                            ...
                            <div class="divRightHead">
                                <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center" >
                                  <tr>
                                    <td height="77" align="left"><span class="fontHeadRight"><?php echo  $langMod["txt:sortpermiss"]?></span></td>
                                    <td align="left">
                                            <table  border="0" cellspacing="0" cellpadding="0" align="right">
                                                <tr>
                                                    <td align="right">
                                                    <?php if($valPermission=="RW"){ ?>
                                                        <div  class="btnSave" title="<?php echo  $langTxt["btn:save"]?>" onclick="sortingContactNew('sortingSub.php');"></div><?php } ?>
...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" style="	border-top:#c8c7cc solid 1px;"> 
  <tr >
    ...
    <?php
		$sql = "SELECT   ".$mod_tb_root_sub."_id,".$mod_tb_root_sub."_subject,".$mod_tb_root_sub."_lastdate,".$mod_tb_root_sub."_status,".$mod_tb_root_sub."_subjecten  FROM ".$mod_tb_root_sub." WHERE ".$mod_tb_root_sub."_masterkey ='".$_REQUEST['masterkey']."'    ";
		$sql .= " AND ".$mod_tb_root_sub."_gid='".$_REQUEST['inputGh']."' ";
		$sql .= " ORDER BY ".$mod_tb_root_sub."_order DESC";
