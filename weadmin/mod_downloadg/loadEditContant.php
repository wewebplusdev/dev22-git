				...
				<tr>
					...
					<td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
						<select name="inputYear" id="inputYear" class="formSelectContantTb">
							...
							?>
								<option value="<?php echo $row_subgroupid ?>" <?php if ($valYear == $row_subgroupid) { ?> selected="selected" <?php  } ?>><?php echo $row_subgroupname ?></option>
							<?php } ?>
						</select>
					</td>
				</tr>
					...
					<td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
						<select name="inputYear" id="inputYear" class="formSelectContantTb">
							...
							while ($year_end >= $year_start) { ?>
								<option value="<?php echo $year_end ?>" <?php if ($valYear == $year_end) { ?> selected="selected" <?php } ?>><?php echo $year_end ?></option>
							<?php
								$year_end--;
							}
							?>
