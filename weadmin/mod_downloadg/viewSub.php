...
if ($_REQUEST['inputLt'] == "Thai") {
    $sql .= "   " . $mod_tb_root_sub . "_id, " . $mod_tb_root_sub . "_credate , " . $mod_tb_root_sub . "_crebyid, " . $mod_tb_root_sub . "_status	, " . $mod_tb_root_sub . "_lastdate , " . $mod_tb_root_sub . "_lastbyid ,    " . $mod_tb_root_sub . "_subject  ,    " . $mod_tb_root_sub . "_title  , " . $mod_tb_root_sub . "_pic  ";
} else {
    $sql .= "  " . $mod_tb_root_sub . "_id, " . $mod_tb_root_sub . "_credate , " . $mod_tb_root_sub . "_crebyid, " . $mod_tb_root_sub . "_status	, " . $mod_tb_root_sub . "_lastdate , " . $mod_tb_root_sub . "_lastbyid ,    " . $mod_tb_root_sub . "_subjecten  ,    " . $mod_tb_root_sub . "_titleen 	 , " . $mod_tb_root_sub . "_pic  ";
}
$sql .= " , " . $mod_tb_root_sub . "_gid";

$sql .= " FROM " . $mod_tb_root_sub . " WHERE " . $mod_tb_root_sub . "_masterkey='" . $_REQUEST["masterkey"] . "'  AND  " . $mod_tb_root_sub . "_id='" . $_REQUEST['valEditID'] . "' ";
    ...
    <form action="?" method="get" name="myForm" id="myForm">
        ...
        <?php if ($_REQUEST['viewID'] <= 0) { ?>
            <div class="divRightNav">
                <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                        <td class="divRightNavTb" align="left" id="defTop"><span class="fontContantTbNav"><a href="<?php echo   $valLinkNav1 ?>" target="_self"><?php echo   $valNav1 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a href="javascript:void(0)" onclick="btnBackPage('sub.php')" target="_self"><?php echo   $langMod["meu:sub"] ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php echo   $langMod["txt:titleviews"] ?> <?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2) { ?>(<?php echo   getSystemLangTxt($_REQUEST['inputLt'], $langTxt["lg:thai"], $langTxt["lg:eng"]) ?>)<?php } ?></span></td>
        ...
        <div class="divRightHead">
            <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center">
                <tr>
                    <td height="77" align="left"><span class="fontHeadRight"><?php echo   $langMod["txt:titleviews"] ?> <?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2) { ?>(<?php echo   getSystemLangTxt($_REQUEST['inputLt'], $langTxt["lg:thai"], $langTxt["lg:eng"]) ?>)<?php } ?></span></td>
                    <td align="left">
                                    ...
                                    <?php if ($_REQUEST['viewID'] <= 0) { ?>
                                        <?php if ($valPermission == "RW") { ?>
                                            <div class="btnEditView" title="<?php echo   $langTxt["btn:edit"] ?>" onclick="
                                                                    ...
                                                                    editContactNew('../<?php echo   $mod_fd_root ?>/editSub.php')"></div>
                                        <?php } ?>
