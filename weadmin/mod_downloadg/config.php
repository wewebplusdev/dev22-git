...
$mod_tb_root_sub = "md_cmsg";

$mod_tb_file = "md_cmf";
$mod_tb_fileTemp = "md_cmtp";

## Mod Masterkey ###################################
$arr_masterkey = array('ir_fi_2', 'ir_pub', 'ir_cod');
$arr_masterkey_year = array('ir_fi_2');
$arr_masterkey_home_status = array('ir_pub');
$arr_masterkey_home = array('ir_public', 'ir_ar');

## Mod Folder ###################################
$mod_fd_root = "mod_downloadg";
...
$modTxtLayout=array("0"=>"Layout","1" => "Layout 1","2" => "Layout 2");
