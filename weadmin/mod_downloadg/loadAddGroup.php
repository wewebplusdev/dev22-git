...
<form action="?" method="get" name="myForm" id="myForm">
    ...
    <input name="inputLt" type="hidden" id="inputLt" value="<?php echo $_REQUEST['inputLt']?>" />
					<div class="divRightNav">
                        ...
                        <tr>
                        <td  class="divRightNavTb" align="left"  id="defTop" ><span class="fontContantTbNav"><a href="<?php echo $valLinkNav1?>" target="_self"><?php echo $valNav1?></a> <img src="../img/btn/navblack.png" align="absmiddle" vspace="5" /> <a  href="javascript:void(0)"  onclick="btnBackPage('group.php')" target="_self"><?php echo $langMod["meu:group"]?></a> <img src="../img/btn/navblack.png" align="absmiddle" vspace="5" /> <?php echo $langMod["txt:titleaddg"]?><?php if($_SESSION[$valSiteManage.'core_session_languageT']==2 || $_SESSION[$valSiteManage.'core_session_languageT']==3){ ?>(<?php echo $langTxt["lg:thai"]?>)<?php } ?></span></td>
                        <td  class="divRightNavTb" align="right">
                            ...
                            <div class="divRightHead">
                                <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center" >
                                  <tr>
                                    <td height="77" align="left"><span class="fontHeadRight"><?php echo $langMod["txt:titleaddg"]?><?php if($_SESSION[$valSiteManage.'core_session_languageT']==2 || $_SESSION[$valSiteManage.'core_session_languageT']==3){ ?>(<?php echo $langTxt["lg:thai"]?>)<?php } ?></span></td>
                                    <td align="left">
	...
	<!-- <tr >
		...
		<td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
			...
			<label>
				<div class="formDivRadioL"><input name="inputLayout" id="inputLayout" value="1" class="formRadioContantTb" type="radio"  checked="checked" /></div>
				<div class="formDivRadioR"><?php echo  $modTxtLayout[1]; ?></div>
			</label>

			<label>
				<div class="formDivRadioL"><input name="inputLayout" id="inputLayout" value="2" class="formRadioContantTb"  type="radio" /></div>
