                            ...
                            <tr>
                                <td align="right">
                                    <?php if ($valPermission == "RW") { ?>
                                        <div class="btnAdd" title="<?php echo $langTxt["btn:add"] ?>" onclick="document.myFormHome.inputLt.value='Thai';  addContactNew('addGroup.php');">
                                        </div>
	...
	if(confirm('<?php echo $langTxt['mg:delpermis'] ?>')) {
        ...
        <div class="divRightMain">
            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
                ...
                " . $mod_tb_root_group . "_picen,
                " . $mod_tb_root_group . "_piccn
                            ...
                            <?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2 || $_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>
                                <td class="divRightContantOverTb" valign="top" align="left">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <!-- <td class="displayTdImg" width="39" align="left" valign="top">
                                                <div class="displayClickImg" style="background:url(<?php echo $valPicen ?>) center no-repeat; background-size: cover;background-repeat: no-repeat; border-radius: 50%;  ">
                                                </div>
                                            </td> -->
                                            <td align="left"><a href="javascript:void(0)" onclick="
                            ...
                            <?php if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 3) { ?>
                                <td class="divRightContantOverTb" valign="top" align="left">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <!-- <td class="displayTdImg" width="39" align="left" valign="top">
                                                <div class="displayClickImg" style="background:url(<?php echo $valPiccn ?>) center no-repeat; background-size: cover;background-repeat: no-repeat; border-radius: 50%;  ">
                                                </div>
                                            </td> -->
                                            <td align="left"><a href="javascript:void(0)" onclick="
                                    ...
                                    <?php if ($valPermissionContent == "RW") { ?>
                                        <div id="load_status<?php echo $valID ?>">
                                            <?php if ($valStatus == "Enable") { ?>
                                                ...
                                                <a href="javascript:void(0)" onclick="changeStatus('load_waiting<?php echo $valID ?>','<?php echo $mod_tb_root_group ?>','<?php echo $valStatus ?>','<?php echo $valID ?>','load_status<?php echo $valID ?>','../<?php echo $mod_fd_root ?>/statusMgH.php')"><span class="<?php echo $valStatusClass ?>"><?php echo $valStatus ?></span></a>

                                            <?php } else { ?>

                                                <a href="javascript:void(0)" onclick="changeStatus('load_waiting<?php echo $valID ?>','<?php echo $mod_tb_root_group ?>','<?php echo $valStatus ?>','<?php echo $valID ?>','load_status<?php echo $valID ?>','../<?php echo $mod_fd_root ?>/statusMgH.php')">
                                                    <span class="<?php echo $valStatusClass ?>"><?php echo $valStatus ?></span> </a>
