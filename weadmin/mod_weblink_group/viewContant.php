...
$sql .= " , " . $mod_tb_root . "_urlfriendly , " . $mod_tb_root . "_langth, " . $mod_tb_root . "_langen , " . $mod_tb_root . "_langcn , " . $mod_tb_root . "_pin as pin, " . $mod_tb_root . "_target as target";
...
$valUrleregis = rechangeQuot($Row[20]);
$valUrlFoemD = rechangeQuot($Row[21]);
$valUrlfriendly = rechangeQuot($Row[22]);
$valLang[0] = $Row[23];
$valLang[1] = $Row[24];
$valLang[2] = $Row[25];
