...
if ($_REQUEST['inputLt'] == "Thai") {
  $sql .= "   , " . $mod_tb_root_group . "_subject  ,    " . $mod_tb_root_group . "_title,    " . $mod_tb_root_group . "_htmlfilename," . $mod_tb_root_group . "_pic   ";
} else if ($_REQUEST['inputLt'] == "Eng") {
  $sql .= "  ," . $mod_tb_root_group . "_subjecten  ,    " . $mod_tb_root_group . "_titleen,    " . $mod_tb_root_group . "_htmlfilenameen," . $mod_tb_root_group . "_picen 	  ";
} else {
  $sql .= "  ," . $mod_tb_root_group . "_subjectcn  ,    " . $mod_tb_root_group . "_titlecn ,    " . $mod_tb_root_group . "_htmlfilenamecn," . $mod_tb_root_group . "_piccn	  ";
}
