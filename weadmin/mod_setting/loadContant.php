        ...
        <div class="divRightMain">
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
                <tr>
                    ...
                    <td align="left" valign="middle" class="divRightTitleTb divRightTitleTbLeft"><span class="fontTitlTbRight"><?php echo  $langMod["tit:subject"] ?></span></td>
                                ...
                                <?php if ($valPermission == "RW") { ?>
                                    <div id="load_status<?php echo $valID ?>">
                                        <?php if ($valStatus == "Enable") { ?>
                                            <a href="javascript:void(0)" onclick="changeStatusMainpage('load_waiting<?php echo $valID ?>','<?php echo $mod_tb_root ?>','<?php echo $valStatus ?>','<?php echo $valID ?>','load_status<?php echo $valID ?>','../<?php echo $mod_fd_root ?>/statusMg.php')"><span class="<?php echo $valStatusClass ?>"><?php echo $valStatus ?></span></a>
                                        <?php } else { ?>
                                            <a href="javascript:void(0)" onclick="changeStatusMainpage('load_waiting<?php echo $valID ?>','<?php echo $mod_tb_root ?>','<?php echo $valStatus ?>','<?php echo $valID ?>','load_status<?php echo $valID ?>','../<?php echo $mod_fd_root ?>/statusMg.php')"> <span class="<?php echo $valStatusClass ?>"><?php echo $valStatus ?></span> </a>
                                        <?php } ?>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td valign="top" align="center" width="30">
                                                <div class="divRightManage" title="<?php echo  $langTxt["btn:preview"] ?>">
                                                    <a href="<?php echo $core_full_path; ?>/preview/<?php echo encodeStr($valID); ?>" target="_blank">
                                                        <img src="../img/btn/search.png" /><br />
                                                        <span class="fontContantTbManage"><?php echo  $langTxt["btn:preview"] ?></span>
                                                    </a>
                                                </div>
                                            </td>
                                            <td valign="top" align="center" width="30">
