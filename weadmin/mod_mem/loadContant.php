        ...
        <tr>
          ...
          <td class="divRightNavTb" align="right">
            ...
            <!-- <div class="menuSubMod">
              <a href="../mod_setting_board/index.php?masterkey=<?php echo $_REQUEST['masterkey'] ?>&menukeyid=<?php echo $_REQUEST['menukeyid'] ?>">
                Setting Group
              </a>
            </div> -->
            <div class="menuSubMod">
...
if(Paging_CountChecked('CheckBoxID',document.myForm.TotalCheckBoxID.value)>0) {
    ...
    <div class="divRightMain">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
        ...
        " . $mod_tb_root . "_status,
        " . $mod_tb_root . "_fnameen,
        " . $mod_tb_root . "_pic,
        " . $mod_tb_root . "_view,
        " . $mod_tb_root . "_pin   ,
        " . $mod_tb_root . "_gid ,
        " . $mod_tb_root . "_fnamecn, 
        " . $mod_tb_root . "_lname,
        " . $mod_tb_root . "_lnameen,
        " . $mod_tb_root . "_lnamecn,
        " . $md_mem_position . "." . $md_mem_position . "_gid as groupid,
        " . $md_mem_position . "." . $md_mem_position . "_pid as positionid
        ...
        ON
        " . $mod_tb_root . "." . $mod_tb_root . "_id = " . $md_mem_position . "." . $md_mem_position . "_mid 
        ...
        if ($_REQUEST['inputGh'] >= 1) {
          $sql = $sql . "  AND " . $md_mem_position . "." . $md_mem_position . "_gid ='" . $_REQUEST['inputGh'] . "'   ";
        }

        if ($_REQUEST['inputPh'] >= 1) {
          $sql = $sql . "  AND " . $md_mem_position . "." . $md_mem_position . "_pid ='" . $_REQUEST['inputPh'] . "'   ";
        }
        ...
        if ($inputSearch <> "") {
          $sql = $sql . "  AND  (
		" . $mod_tb_root . "_fname LIKE '%$inputSearch%'  OR
		" . $mod_tb_root . "_fnameen LIKE '%$inputSearch%'   OR
		" . $mod_tb_root . "_fnamecn LIKE '%$inputSearch%'   ) ";
        }

        $sql .= " GROUP BY " . $mod_tb_root . "_id ORDER BY $module_orderby $module_adesc";
        ...
        if ($count_record > 0) {
          while ($index < $count_record + 1) {
            ...
            $vallastName = rechangeQuot($row[10]);
            $vallastName = chechNullVal($vallastName);
            $vallastNameEn = rechangeQuot($row[11]);
            $vallastNameEn = chechNullVal($vallastNameEn);
            $vallastNameCn = rechangeQuot($row[12]);
            $vallastNameCn = chechNullVal($vallastNameCn);
