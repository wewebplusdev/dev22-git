...
$sql .= " , " . $mod_tb_root_group . "_pic, " . $mod_tb_root_group . "_pic2	," . $mod_tb_root_group . "_type ,    " . $mod_tb_root_group . "_url, " . $mod_tb_root_group . "_target, " . $mod_tb_root_group . "_gid FROM " . $mod_tb_root_group . " WHERE " . $mod_tb_root_group . "_masterkey='" . $_POST["masterkey"] . "' AND  " . $mod_tb_root_group . "_id 	='" . $_POST["valEditID"] . "'";
