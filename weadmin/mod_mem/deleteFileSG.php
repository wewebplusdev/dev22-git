...
include("config.php");
	...
	$Query=wewebQueryDB($coreLanguageSQL,$sql);
		...
		$sql="SELECT ".$mod_tb_file."_id,".$mod_tb_file."_filename,".$mod_tb_file."_name,".$mod_tb_file."_download 
        FROM ".$mod_tb_file." 
        WHERE ".$mod_tb_file."_contantid 	='".$_REQUEST['valEditID']."' 
        AND ".$mod_tb_file."_masterkey = '".$_REQUEST['masterkey']."'
        AND ".$mod_tb_file."_language ='".$_REQUEST['inputLt']."'  
