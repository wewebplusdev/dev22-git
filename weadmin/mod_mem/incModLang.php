...
if ($_SESSION[$valSiteManage . "core_session_language"] == "Eng") {
	...
	$langMod["txt:titleaddgsub"] = "" . $langMod["meu:sub"] . " New";
	$langMod["txt:titleeditgsub"] = "" . $langMod["meu:sub"] . " Edit";
	$langMod["txt:titleviewgsub"] = "" . $langMod["meu:sub"] . " Display";
	$langMod["txt:sortpermisgsub"] = "" . $langMod["meu:sub"] . " Sort";
	...
	$langMod["txt:titleg"] = "Detailed information " . $langMod["meu:sub"];
	$langMod["txt:titlegDe"] = "Please enter details. For use in display on your website. ";
	...
	$langMod["tit:fname"] = "Name";
	$langMod["tit:lname"] = "Lastname";
	...
	$langMod["tit:subjectggsub"] = "Name " . $langMod["meu:sub"];
	...
	$langMod["tit:selectgsub"] = "Select " . $langMod["meu:sub"];
	$langMod["tit:selectgnsub"] = "Name " . $langMod["meu:sub"];
	$langMod["meu:selectgnsub"] = "" . $langMod["meu:sub"];
	$langMod["txt:subjectgsub"] = "" . $langMod["meu:sub"] . " Info";
	$langMod["txt:subjectgDesub"] = "Please enter a name " . $langMod["meu:sub"] . " to be used for display on your site.";
	...
	$langMod["tit:selectgsub"] = "เลือก" . $langMod["meu:sub"];
	$langMod["tit:selectgnsub"] = $langMod["meu:sub"];
	$langMod["txt:subjectgsub"] = "ข้อมูล" . $langMod["meu:sub"];
	$langMod["txt:subjectgDesub"] = "โปรดป้อนชื่อ" . $langMod["meu:sub"] . " เพื่อใช้ในการแสดงผลในหน้าเว็บไซต์ของคุณ";
	...
	$langMod["meu:setPermis"] = "Setting";
	$langMod["txt:titleadds"] = "สร้างข้อมูล" . $langMod["meu:setPermis"];
	$langMod["txt:titleedits"] = "แก้ไขข้อมูล" . $langMod["meu:setPermis"];
	$langMod["txt:titleviews"] = "แสดงผลข้อมูล" . $langMod["meu:setPermis"];
