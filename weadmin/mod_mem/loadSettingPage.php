    ...
    <form action="?" method="post" name="myForm" id="myForm">
        ...
        <div class="divRightMain">
            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
                ...
                <?php
                // SQL SELECT #########################
                $sql = "SELECT " . $mod_tb_root_group . "_id," . $mod_tb_root_group . "_subject," . $mod_tb_root_group . "_lastdate," . $mod_tb_root_group . "_status," . $mod_tb_root_group . "_subjecten," . $mod_tb_root_group . "_color  FROM " . $mod_tb_root_group;
		...
		" . $mod_tb_root_group . "_subjecten LIKE '%$inputSearch%'   ) ";
                ...
                $sqlPermis = "Select
  " . $mod_tb_permis . "." . $mod_tb_permis . "_id,
  " . $mod_tb_permis . "." . $mod_tb_permis . "_name,
...
From
  " . $mod_tb_permis . "
Where
  " . $mod_tb_permis . "." . $mod_tb_permis . "_lv = 'staff' AND  " . $mod_tb_permis . "." . $mod_tb_permis . "_typemini != '1'  ORDER BY " . $mod_tb_permis . "." . $mod_tb_permis . "_order DESC  ";
...
From
  " . $mod_tb_permisGroup . "";
                ...
                foreach ($listPermis as $genlistCheck) {
                    $listAllowPer[$genlistCheck['md_cmgp_cmgid']][$genlistCheck['md_cmgp_misid']] = true;
                }
                            ...
                            <td colspan="3" rowspan="1">
                                <ul class="listper">
                                    ...
                                    foreach ($listadmin as $showGpermis) {
                                        ...
                                        echo '<label style="background-color:#fff;color:#333;"><input type="checkbox" name="permis[' . $valID . '][' . $showGpermis['sy_grp_id'] . ']"';
                                        if ($listAllowPer[$valID][$showGpermis['sy_grp_id']] == 1) {
                                            echo "checked";
                                        }
                                        echo  '>' . $showGpermis['sy_grp_name'] . '</label>';
                                        echo "</li>";
                                    }
                                    ?>
                                </ul>
