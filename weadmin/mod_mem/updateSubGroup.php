...
<?php
	if($execute=="update"){
		...
		$update[]=$mod_tb_root_subgroup."_url  	='".changeQuot($_POST['inputurl'])."'";
		...
		$update[]=$mod_tb_root_subgroup."_urlen  	='".changeQuot($_POST['inputurl'])."'";
		}else{
		...
		$update[]=$mod_tb_root_subgroup."_urlcn  	='".changeQuot($_POST['inputurl'])."'";
		}
		...
		$update[]=$mod_tb_root_subgroup."_type  	='".changeQuot($_POST['inputType'])."'";
		$update[]=$mod_tb_root_subgroup."_target  	='".changeQuot($_POST['inputTarget'])."'";

		// $update[]=$mod_tb_root_subgroup."_pic='".$_POST["picname"]."'";

		$sql="UPDATE ".$mod_tb_root_subgroup." SET ".implode(",",$update)." WHERE ".$mod_tb_root_subgroup."_id='".$_POST["valEditID"]."' ";
		$Query=wewebQueryDB($coreLanguageSQL,$sql);

		logs_access('3','Update SubGroup');
		?>
        <?php } ?>
