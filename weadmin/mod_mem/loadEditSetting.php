...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder" >
    <tr >
    <td colspan="7" align="left"  valign="middle" class="formTileTxt tbBoxViewBorderBottom">
    <span class="formFontSubjectTxt"><?php echo "Setting ข้อมูลกรรมการ และผู้บริหาร"; ?></span><br/>
    <span class="formFontTileTxt"><?php echo "Please enter details. For use in display on your website."; ?></span>    </td>
    </tr>
        <tr >
