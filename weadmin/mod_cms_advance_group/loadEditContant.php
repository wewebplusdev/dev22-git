...
if ($_REQUEST['inputLt'] == "Thai") {
	$sql .= " , " . $mod_tb_root . "_url, " . $mod_tb_root . "_pic, " . $mod_tb_root . "_subject, " . $mod_tb_root . "_title, " . $mod_tb_root . "_htmlfilename, " . $mod_tb_root . "_metatitle, " . $mod_tb_root . "_description, " . $mod_tb_root . "_keywords, " . $mod_tb_root . "_urleregis, " . $mod_tb_root . "_urlformd";
} elseif ($_REQUEST['inputLt'] == "Eng") {
	$sql .= " , " . $mod_tb_root . "_urlen, " . $mod_tb_root . "_picen, " . $mod_tb_root . "_subjecten, " . $mod_tb_root . "_titleen, " . $mod_tb_root . "_htmlfilenameen, " . $mod_tb_root . "_metatitleen, " . $mod_tb_root . "_descriptionen, " . $mod_tb_root . "_keywordsen, " . $mod_tb_root . "_urleregisen, " . $mod_tb_root . "_urlformden";
} else {
	$sql .= " , " . $mod_tb_root . "_urlcn, " . $mod_tb_root . "_picen, " . $mod_tb_root . "_subjectcn, " . $mod_tb_root . "_titlecn, " . $mod_tb_root . "_htmlfilenamecn, " . $mod_tb_root . "_metatitlecn, " . $mod_tb_root . "_descriptioncn, " . $mod_tb_root . "_keywordscn, " . $mod_tb_root . "_urleregiscn, " . $mod_tb_root . "_urlformdcn";
}
...
$valUrleregis = rechangeQuot($Row[17]);
$valUrlformD = rechangeQuot($Row[18]);
$valUrlfriendly = rechangeQuot($Row[19]);
$valLang[0] = $Row[20];
$valLang[1] = $Row[21];
$valLang[2] = $Row[22];
		...
		<div class="divRightMain">
			...
			<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
				...
				<!-- <tr>
					...
					<td colspan="6" align="left" valign="top" class="formRightContantTb">
						<textarea name="inputEregis" id="inputEregis" cols="45" rows="5" class="formTextareaContantTb"><?php echo $valUrleregis; ?></textarea>
						<span class="formFontNoteTxt"><?php echo $langMod["edit:linknote"] ?></span>
					</td>
				</tr>
				<tr>
					<td align="right" valign="top" class="formLeftContantTb"><?php echo $langMod["tit:formdownload"] ?><span class="fontContantAlert">*</span></td>
					<td colspan="6" align="left" valign="top" class="formRightContantTb">
						<textarea name="inputFormD" id="inputFormD" cols="45" rows="5" class="formTextareaContantTb"><?php echo $valUrlformD; ?></textarea>
						<span class="formFontNoteTxt"><?php echo $langMod["edit:linknote"] ?></span>
					</td>
				</tr> -->
			</table>
