...
if ($_REQUEST['execute'] == "insert") {
    ...
    $insert[$mod_tb_root . "_urleregis"] = "'" . changeQuot($_REQUEST['inputEregis']) . "'";
    $insert[$mod_tb_root . "_urlformd"] = "'" . changeQuot($_REQUEST['inputFormD']) . "'";
    ...
    // $insert[$mod_tb_root . "_urlfriendly"] = "'" . changeQuot($_REQUEST['inputUrlFriendly']) . "'";
