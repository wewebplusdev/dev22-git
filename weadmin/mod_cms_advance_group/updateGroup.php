...
<?php
	if($execute=="update"){
		...
		if ($_POST['inputHtml'] != "") {
			$filename = "html-G-" . $_POST["valEditID"] . "-" . $randomNumber . ".html";
		...
		$update[] = $mod_tb_root_group . "_htmlfilename  	='" . $filename . "'";
		...
		$update[] = $mod_tb_root_group . "_htmlfilenameen  	='" . $filename . "'";
		}else{
		...
		$update[] = $mod_tb_root_group . "_htmlfilenamecn  	='" . $filename . "'";
		}
