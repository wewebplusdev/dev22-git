...
include("config.php");
	...
	$sql_fileTemp="SELECT ".$mod_tb_root_albumTemp."_filename  FROM ".$mod_tb_root_albumTemp." 
	WHERE ".$mod_tb_root_albumTemp."_id 	='".$_REQUEST['valDelAlbum']."' ";
	...
	$Query=wewebQueryDB($coreLanguageSQL,$sql);
		...
		$sql="SELECT ".$mod_tb_root_albumTemp."_id,".$mod_tb_root_albumTemp."_filename ,".$mod_tb_root_albumTemp."_download 
