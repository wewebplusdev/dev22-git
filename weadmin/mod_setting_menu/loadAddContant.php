...
function executeSubmit() {
    ...
    if(inputTypeID.value==0) {
      inputTypeID.focus();
      jQuery("#inputTypeID").addClass("formInputContantTbAlertY");
      return false;
    }else{
      jQuery("#inputTypeID").removeClass("formInputContantTbAlertY");
    }
...
<form action="?" method="get" name="myForm" id="myForm"   enctype="multipart/form-data">
   ...
   <br />
    ...
    <span class="formFontTileTxt"><?php echo $langMod["txt:subjectDe"]?></span>    </td>
      ...
      <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo "ชื่อโครงการ"?><span class="fontContantAlert">*</span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
    <select name="inputTypeID"  id="inputTypeID" class="formSelectContantTb">
       <option value="0"><?php echo "กรุณาเลือกโครงการ"?> </option>
        <?php 
	$sql_group = "SELECT ".$mod_tb_root_type."_id,".$mod_tb_root_type."_subject FROM ".$mod_tb_root_type." WHERE  
  ".$mod_tb_root_type."_language='".$_SESSION[$valSiteManage.'core_session_language']."'    AND   ".$mod_tb_root_type."_masterkey='ml' ";
  $sql_group .= "   AND   ".$mod_tb_root_type."_gid='0' ";
  $sql_group .= "  ORDER BY ".$mod_tb_root_type."_order DESC ";
