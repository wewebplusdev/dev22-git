...
$type = "";
	...
	if(!empty($_FILES['inputFileUpload']['error'])){
		...
		$error = 'No file was uploaded..';
			...
			$sql="DELETE FROM ".$mod_tb_file." WHERE ".$mod_tb_file."_contantid='".$_REQUEST['myID']."' AND ".$mod_tb_file."_type='0'";
		...
		$Query=wewebQueryDB($coreLanguageSQL, $sql);
		 ...
		 ORDER BY ".$mod_tb_file."_id ASC";
			...
			$msg .= " <a href=\"javascript:void(0)\"  onclick=\" document.myForm.valDelFile.value=".$downloadID.";delFileUpload(\'deleteFile.php\')\" ><img src=\"../img/btn/delete.png\" align=\"absmiddle\" title=\"Delete file\"  hspace=\"10\"  vspace=\"10\"   border=\"0\" /></a>".$downloadName."".$imageType." | ".$langMod["file:type"].":".$imageType."  | ".$langMod["file:size"].": ".get_IconSize($linkRelativePath).
			 " <br/>";
