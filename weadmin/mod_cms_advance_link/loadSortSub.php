...
$sql = "SELECT   ".$mod_tb_root."_id,".$mod_tb_root."_subject,".$mod_tb_root."_lastdate,".$mod_tb_root."_status,".$mod_tb_root."_type,".$mod_tb_root."_subtype  FROM ".$mod_tb_root." WHERE ".$mod_tb_root."_masterkey ='".$_REQUEST['masterkey']."'    ";
    $sql .= "  AND ".$mod_tb_root."_id ='".$_REQUEST['valEditID']."' ";     		
                                    ...
                                    <td align="left">
                                            <table  border="0" cellspacing="0" cellpadding="0" align="right">
                                                <tr>
                                                    <td align="right">
                                                    <? if($valPermission=="RW"){?>
                                                        <div  class="btnSave" title="<?=$langTxt["btn:save"]?>" onclick="sortingContactNew('sortingSub.php');"></div><? }?>
...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" style="	border-top:#c8c7cc solid 1px;"> 
  <tr >
    ...
    <?
		$sql = "SELECT   ".$mod_tb_file."_id,".$mod_tb_file."_title FROM ".$mod_tb_file." WHERE ".$mod_tb_file."_contantid ='".$_REQUEST['valEditID']."'    ";
    $sql .= "  AND ".$mod_tb_file."_file !='' "; 
    // $sql .= "  AND ".$mod_tb_file."_type ='".$valSubType."' ";		
