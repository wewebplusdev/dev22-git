...
$datetime = date('Y-m-d H:i:s');
	...
	if(!empty($_FILES['inputFileUpload']['error'])){
		...
		$sql="DELETE FROM ".$mod_tb_fileTemp." WHERE ".$mod_tb_fileTemp."_contantid='".$_REQUEST['myID']."' AND ".$mod_tb_fileTemp."_type='0'";
		...
		$Query=wewebQueryDB($coreLanguageSQL, $sql);
		 ...
		 AND ".$mod_tb_fileTemp."_language ='".$_REQUEST['langt']."'  
		 AND ".$mod_tb_fileTemp."_type ='0'  AND
