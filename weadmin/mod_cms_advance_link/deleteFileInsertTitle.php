...
include("config.php");
	...
	$Query=wewebQueryDB($coreLanguageSQL, $sql);
		...
		$sql="SELECT ".$mod_tb_fileTemp."_id,".$mod_tb_fileTemp."_filename,".$mod_tb_fileTemp."_name,".$mod_tb_fileTemp."_download,".$mod_tb_fileTemp."_Title,".$mod_tb_fileTemp."_url 
		FROM ".$mod_tb_fileTemp." WHERE ".$mod_tb_fileTemp."_contantid 	='".$_REQUEST['valEditID']."' AND ".$mod_tb_fileTemp."_type ='".$_REQUEST['inputSubtype']."'AND ".$mod_tb_fileTemp."_file ='".$_REQUEST['inputType_sub']."' ORDER BY ".$mod_tb_fileTemp."_id ASC";
		...
		$query_file=wewebQueryDB($coreLanguageSQL, $sql);
			...
			if ($_REQUEST['valueTypeSub'] != 'url') {			
				$txtFile .= "• <span>$valTitle</span> <a href=\"javascript:void(0)\"  onclick=\"document.myForm.valDelFile.value=".$downloadID.";delFileUploadTitle('deleteFileInsertTitle.php');\" ><img src=\"../img/btn/delete.png\" align=\"absmiddle\" title=\"Delete file\"  hspace=\"10\"  vspace=\"10\"   border=\"0\" /></a>".$downloadName."".$imageType." | ".$langMod["file:type"].": ".$imageType."  | ".$langMod["file:size"].": ".get_IconSize($linkRelativePath)."<br/>";
			}else{			
				$txtFile .= "• <span>$valTitle</span> <a href=\"javascript:void(0)\"  onclick=\"document.myForm.valDelFile.value=".$downloadID.";delFileUploadTitle('deleteFileInsertTitle.php');\" ><img src=\"../img/btn/delete.png\" align=\"absmiddle\" title=\"Delete file\"  hspace=\"10\"  vspace=\"10\"   border=\"0\" /></a>".$downloadName.""."<br/>";
			}	
									 }}
			echo $txtFile;
