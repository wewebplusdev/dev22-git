...
if ($_REQUEST['inputLt'] == "Thai") {
    $sql .= "  " . $mod_tb_root_sub_group . "_id ,  
    " . $mod_tb_root_sub_group . "_lastdate, 
    " . $mod_tb_root_sub_group . "_creby, 
    " . $mod_tb_root_sub_group . "_status ,    
    " . $mod_tb_root_sub_group . "_subject  ,    
    " . $mod_tb_root_sub_group . "_title ,    
    " . $mod_tb_root_sub_group . "_type ,    
    " . $mod_tb_root_sub_group . "_gid ";
    ...
    " . $mod_tb_root_sub_group . "_titleen ,    
    " . $mod_tb_root_sub_group . "_type ,    
    " . $mod_tb_root_sub_group . "_gid ";
} else {
    $sql .= "  
    " . $mod_tb_root_sub_group . "_id , 
    " . $mod_tb_root_sub_group . "_lastdate, 
    " . $mod_tb_root_sub_group . "_creby, 
    " . $mod_tb_root_sub_group . "_status  ,   
    " . $mod_tb_root_sub_group . "_subjectcn  ,    
    " . $mod_tb_root_sub_group . "_titlecn  ,    
    " . $mod_tb_root_sub_group . "_type ,    
    " . $mod_tb_root_sub_group . "_gid";
}

$sql .= " 	FROM " . $mod_tb_root_sub_group . " WHERE " . $mod_tb_root_sub_group . "_masterkey='" . $_POST["masterkey"] . "' AND  " . $mod_tb_root_sub_group . "_id 	='" . $_POST["valEditID"] . "'";
//print_pre($sql);
                    ...
                    <form action="?" method="get" name="myForm" id="myForm">
                        ...
                        <div class="divRightNav">
                            <table width="96%" border="0" cellspacing="0" cellpadding="0"  align="center" >
                                <tr>
                                    <td  class="divRightNavTb" align="left"  id="defTop" ><span class="fontContantTbNav"><a href="<?= $valLinkNav1 ?>" target="_self"><?= $valNav1 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a  href="javascript:void(0)"  onclick="btnBackPage('subgroup.php')" target="_self"><?= $langMod["meu:subgroup"] ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?= $langMod["txt:titleeditsg"] ?> <? if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2) { ?>(<?= getSystemLangTxt($_REQUEST['inputLt'], $langTxt["lg:thai"], $langTxt["lg:eng"]) ?>)<? } ?></span></td>
                        ...
                        <div class="divRightHead">
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center" >
                                <tr>
                                    <td height="77" align="left"><span class="fontHeadRight"><?= $langMod["txt:titleeditsg"] ?> <? if ($_SESSION[$valSiteManage . 'core_session_languageT'] == 2) { ?>(<?= getSystemLangTxt($_REQUEST['inputLt'], $langTxt["lg:thai"], $langTxt["lg:eng"]) ?>)<? } ?></span></td>
                                    <td align="left">
                            ...
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                                ...
                                <tr >
                                    ...
                                    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
										...
										<input name="inputType" id="inputType" type="hidden"  class="formInputContantTb" value="<?= $valType ?>"/>
                                    </td>
                                </tr>
                                ...
                                <!--<tr >
                                    ...
                                    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
										...
										<input name="inputType" id="inputType" type="hidden"  class="formInputContantTb" value="<?= $valType ?>"/>
                                        <label>
                                            <div class="formDivRadioL"><input name="inputType" id="inputType" value="link" class="formRadioContantTb" <? if ($valType == "link") {
                                                        echo 'checked="checked"';
                                                    } ?>  type="radio"/></div>
                                            <div class="formDivRadioR"><?= $langMod["tit:typelink"]; ?></div>
                                        </label>

                                        <label>
                                            <div class="formDivRadioL"><input name="inputType" id="inputType" value="map" class="formRadioContantTb" <? if ($valType == "map") {
                                                        echo 'checked="checked"';
                                                    } ?>  type="radio"/></div>
                                            <div class="formDivRadioR"><?= $langMod["tit:typemap"]; ?></div>
                                        </label>
