...
$langMod["tit:inpName"] = "Name " .getNameMenu($_REQUEST["menukeyid"]);
		...
		$langMod["tit:subject"] ="ชื่อ".$langMod["meu:group"];
		...
		$langMod["inp:link"]="ลิงค์";
		$txt_mod["edit:linknote"]="หมายเหตุ : กรุณา URL นำหน้าด้วย http://  เช่น http://www.wewebplus.com เป็นต้น";
		$langMod["inp:uploadfile"]="ไฟล์อัพโหลด";
		$txt_mod["edit:vdonote"]="หมายเหตุ : ระบบไม่อนูญาตให้อัพโหลดไฟล์นามสกุลดังนี้ .exe, .bat และ .ini";
		...
		//$langMod["tit:inpName"] = "ชื่อ".$langMod["meu:contant"];

		$langTxt["mg:pin"] = "Pin";
		$langMod["tit:inpName"] ="หัวข้อ";
