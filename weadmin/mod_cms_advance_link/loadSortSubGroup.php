                        ...
                        <td  class="divRightNavTb" align="right">
                            ...
                            <div class="divRightHead">
                                <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center" >
                                  <tr>
                                    <td height="77" align="left"><span class="fontHeadRight"><?=$langMod["txt:sortpermissg"]?></span></td>
                                    <td align="left">
                                            <table  border="0" cellspacing="0" cellpadding="0" align="right">
                                                <tr>
                                                    <td align="right">
                                                    <? if($valPermission=="RW"){?>
                                                        <div  class="btnSave" title="<?=$langTxt["btn:save"]?>" onclick="sortingContactNew('sortingSubGroup.php');"></div><? }?>
...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" style="	border-top:#c8c7cc solid 1px;">
  <tr >
    ...
    <?
    $sql = "SELECT   ".$mod_tb_root_sub_group."_id,".$mod_tb_root_sub_group."_subject,".$mod_tb_root_sub_group."_lastdate,".$mod_tb_root_sub_group."_status,".$mod_tb_root_sub_group."_subjecten  FROM ".$mod_tb_root_sub_group." WHERE ".$mod_tb_root_sub_group."_masterkey ='".$_REQUEST['masterkey']."'    ";
   
      if($_REQUEST['inputGh']>=1) {
        $sql .= " AND ".$mod_tb_root_sub_group."_gid ='".$_REQUEST['inputGh']."'   ";
        }

    $sql .= " ORDER BY ".$mod_tb_root_sub_group."_order DESC";
   // print_pre($sql);
