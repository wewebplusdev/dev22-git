...
if(Paging_CountChecked('CheckBoxID',document.myForm.TotalCheckBoxID.value)>0) {
   ...
   document.myFormHome.valEditID.value=<?= $valID ?>;
    viewContactNew('viewSubGroup.php');"><?= $valName ?></a></div>
                    </td>
                  </tr>
                </table>
              </td>
    ...
    document.myFormHome.inputLt.value='Eng';
   document.myFormHome.valEditID.value=<?= $valID ?>;
    viewContactNew('viewSubGroup.php');"><?= $valNameEn ?></a></div>
                      </td>
                    </tr>
                  </table>
                </td>
          ...
          delContactNew('deleteSubGroup.php');
            ...
            ?>
                  <tr class="divSubOverTb">
                    <td class="divRightContantOverTbL" style="padding-left:20px;" valign="top" align="center"><input id="CheckBoxID<?= $index ?>" name="CheckBoxID<?= $index ?>" type="checkbox" class="formCheckboxList" onClick="Paging_CheckAllHandle(document.myForm.CheckBoxAll,'CheckBoxID',document.myForm.TotalCheckBoxID.value)" value="<?= $valIDSub ?>" /> </td>
                    <td class="divRightContantOverTb" valign="top" align="left">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td align="left">
