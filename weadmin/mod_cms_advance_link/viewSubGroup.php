...
$valLinkNav1="../core/index.php";
			...
			if($_REQUEST['inputLt']=="Thai"){
				$sql .= "   ".$mod_tb_root_sub_group."_id, ".$mod_tb_root_sub_group."_credate , ".$mod_tb_root_sub_group."_crebyid, ".$mod_tb_root_sub_group."_status	, ".$mod_tb_root_sub_group."_lastdate , ".$mod_tb_root_sub_group."_lastbyid ,    ".$mod_tb_root_sub_group."_subject  ,    ".$mod_tb_root_sub_group."_title ,    ".$mod_tb_root_sub_group."_gid   ";
			}else{
				$sql .= "  ".$mod_tb_root_sub_group."_id, ".$mod_tb_root_sub_group."_credate , ".$mod_tb_root_sub_group."_crebyid, ".$mod_tb_root_sub_group."_status	, ".$mod_tb_root_sub_group."_lastdate , ".$mod_tb_root_sub_group."_lastbyid ,    ".$mod_tb_root_sub_group."_subjecten  ,    ".$mod_tb_root_sub_group."_titleen 	,    ".$mod_tb_root_sub_group."_gid  ";
			}

		 	 $sql .= " FROM ".$mod_tb_root_sub_group." WHERE ".$mod_tb_root_sub_group."_masterkey='".$_REQUEST["masterkey"]."'  AND  ".$mod_tb_root_sub_group."_id='".$_REQUEST['valEditID']."' ";
...
<form action="?" method="get" name="myForm" id="myForm">
   ...
   <br />
    ...
    <span class="formFontTileTxt"><?=$langMod["viw:subjectgDe"]?></span>    </td>
    </tr>
		<tr >
