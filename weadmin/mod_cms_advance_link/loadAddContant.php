    ...
    <form action="?" method="get" name="myForm" id="myForm" enctype="multipart/form-data">
        ...
        <div class="divRightNav">
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                    <td class="divRightNavTb" align="left" id="defTop"><span class="fontContantTbNav"><a href="<?= $valLinkNav1 ?>" target="_self"><?= $valNav1 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a href="javascript:void(0)" onclick="btnBackPage('index.php')" target="_self"><?= $langMod["meu:contant"] //$langMod["tit:inpName"] 
                                                                                                                                                                                                                                                                                                                    ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?= $langMod["txt:titleadd"] ?>
            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder " style="display: none">
                <tr>
                    <td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
                        ...
                        <span class="formFontTileTxt"><?= $langMod["lang:desciption"] ?></span>
                    </td>
                </tr>
                <tr>
            ...
            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                ...
                <tr>
                    ...
                    <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb" id="boxSubSelect">
                        <select name="inputSubgroupID" id="inputSubgroupID" class="formSelectContantTb" onchange="openSelectSub2('openSelectSub2.php')">
                            >
                            ...
                            while ($row_group = wewebFetchArrayDB($coreLanguageSQL, $query_group)) {
                                ...
                                $row_groupname = $row_group[1];
                            ?>
                                <option value="<?= $row_groupid ?>" <? if ($_REQUEST['inputSGh'] == $row_groupid) { ?> selected="selected" <? } ?>><?= $row_groupname ?></option>
                            <? } ?>
                        </select>
                    </td>
                </tr>
                ...
                <tr id="row_file_sub">
                    ...
                    <td width="82%">
                        <div class="file-input-wrapper">
                            ...
                            <input type="file" name="inputFileUploadTitle" id="inputFileUploadTitle" onchange="ajaxFileUploadDocTitle();" />
                        </div>
                    <td>
                </tr>
