    ...
    <div class="divRightHeadSearch">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:20px;" align="center">
        ...
        <tr>
          ...
          <td id="boxSelectTest" width="95%" align="right">
    ...
    <div class="divRightMain">
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
        <tr>
          ...
          <?php } ?>
          <td width="12%" class="divRightTitleTb" valign="middle" align="center"><span class="fontTitlTbRight">ปักหมุด</span></td>
...
" . $mod_tb_root_group . "_subjecten, 
" . $mod_tb_root_group . "_statuspin,
" . $mod_tb_root_group . "_subjectcn
                ...
                <? if ($valPermission == "RW") { ?>
                  <div id="load_pin<?= $valID ?>">
                    <? if ($valPin == "Yes") { ?>
                      ...
                      <a href="javascript:void(0)" onclick="changeStatus('load_waitingPin<?= $valID ?>','<?= $mod_tb_root_group ?>','<?= $valPin ?>','<?= $valID ?>','load_pin<?= $valID ?>','../<?= $mod_fd_root ?>/statusMgP.php')"><span class="fontContantTbEnable"><?= $valPin ?></span></a>
                    <? } else { ?>

                      <a href="javascript:void(0)" onclick="changeStatus('load_waitingPin<?= $valID ?>','<?= $mod_tb_root_group ?>','<?= $valPin ?>','<?= $valID ?>','load_pin<?= $valID ?>','../<?= $mod_fd_root ?>/statusMgP.php')"> <span class="fontContantTbDisable"><?= $valPin ?></span> </a>

                    <? } ?>

                    <img src="../img/loader/ajax-loaderstatus.gif" alt="waiting" style="display:none;" id="load_waitingPin<?= $valID ?>" />
                  </div>
                <? } else { ?>
                  <? if ($valPin == "Yes") { ?>
                ...
                <? if ($valPermission == "RW") { ?>
                  <div id="load_status<?= $valID ?>">
                    <? if ($valStatus == "Enable") { ?>
                      ...
                      <a href="javascript:void(0)" onclick="changeStatus('load_waiting<?= $valID ?>','<?= $mod_tb_root_group ?>','<?= $valStatus ?>','<?= $valID ?>','load_status<?= $valID ?>','../<?= $mod_fd_root ?>/statusMg.php')"><span class="<?= $valStatusClass ?>"><?= $valStatus ?></span></a>
        ...
        <tr>
          <td colspan="7" align="center" valign="middle" class="divRightContantTbRL">
            <table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                <td class="divRightNavTb" align="left"><span class="fontContantTbNav"><?= $langTxt["pr:All"] ?> <b><?= number_format($count_totalrecord) ?></b> <?= $langTxt["pr:record"] ?></span></td>
                <td class="divRightNavTb" align="right">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="right" style="padding-right:10px;"><span class="fontContantTbNav"><?= $langTxt["pr:page"] ?>
                          <? if ($numberofpage > 1) { ?>
