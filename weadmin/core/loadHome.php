                ...
                <body>
                    <div class="divRightNav">
                        <table width="96%" border="0" cellspacing="0" cellpadding="0"  align="center" >
                            <tr>
                                <th  class="divRightNavTb" align="left"   id="defTop"><span class="fontContantTbNav"><?php echo  $langTxt["nav:home1"] ?></span></th>
                                <th  class="divRightNavTb" align="right"><?php echo  DateFormat(date('Y-m-d H:i:s')) ?></th>
                            </tr>
                        </table>
                    </div>
                    <div class="divRightHead">
                        <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center" >
                            <tr>
                                <th height="77" align="left"><span class="fontHeadRight"><?php echo  $langTxt["nav:home2"] ?></span></th>
                                <th align="left">
                            ...
                            <?php if ($_SESSION[$valSiteManage . "core_session_level"] == "SuperAdmin" || $_SESSION[$valSiteManage . "core_session_level"] == "admin") {
                                ...
                                <div  class="divRightInnerTopBoxHome">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <th width="16%" align="left"><div style="width:52px; height:52px;  background:url(<?php echo  $valPicProfileTop ?>) center no-repeat; border:#ffffff solid 1px;  background-size: cover;background-repeat: no-repeat;   "><img src="../img/home/cycle.png" /></div></th>
                                            <th width="84%" style="padding-left:10px;" align="left">
                                                <?php
                                                ...
                                                ?>
                                                <a href="<?php echo  $valLinkViewUser ?>"><span class="fontTitlTbHome"><?php echo  $_SESSION[$valSiteManage . "core_session_name"] ?></span></a></th>
                                        </tr>
                                        <tr>
                              ...
                              <?php if ($_SESSION[$valSiteManage . "core_session_level"] == "SuperAdmin" || $_SESSION[$valSiteManage . "core_session_level"] == "admin") {
                                ...
                                <div  class="divRightInnerTopBoxHome">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <th width="16%" align="left"><div class="cycle1Login"></div></th>
                                            <th width="84%" style="padding-left:10px;" align="left"><a href="../core/userManage.php" title="<?php echo  $langTxt["nav:userManage2"] ?>"><span class="fontTitlTbHome"><?php echo  $langTxt["nav:userManage2"] ?></span></a></th>
                                        </tr>
                                        <tr>
                                            <td colspan="2" height="15"></td>
                                        </tr>
                                ...
                                <div  class="divRightInnerTopBoxHome">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <th width="16%" align="left"><div class="cycle4Login"></div></th>
                                            <th width="84%" style="padding-left:10px;" align="left"><a href="../core/permisManage.php" title="<?php echo  $langTxt["nav:perManage2"] ?>"><span class="fontTitlTbHome"><?php echo  $langTxt["nav:perManage2"] ?></span></a></th>
                                        </tr>
                                        <tr>
                                            <td colspan="2" height="15"></td>
                                        </tr>
                                                ...
                                                <li class="boxHomeSortli"  id="listItem_<?php echo  $txtMenuID ?>" >
                                                    <div  class="divRightInnerBoxHome">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"  class="divRightTitleHomeBoxAll"  >
                                                            <tr >
                                                                <th width="3%"  class="divRightTitleHome"  valign="middle" align="left">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                                        <tr>
                                                                            <th align="center" width="31" style="cursor:move;"><?php if ($txtNameIcon) { ?><img src="<?php echo  $txtNameIcon ?>" border="0" align="absmiddle" /><?php } else {
                                        echo " - ";
                                    } ?></th>
                                                                            <th align="left" style="cursor:move;"><?php echo  $txtNameMenu ?></th>
                                                                            <th align="center" width="31"><a href="javascript:void(0)" onclick="delContactHome('../core/deleteHome.php', '<?php echo  $txtMenuID ?>', 'listItem_<?php echo  $txtMenuID ?>');"   title="<?php echo  $langTxt["btn:close"] ?>"><img src="../img/btn/close.png" /></a></th>
                                                                        </tr>
                                                                    </table>
                                                                </th>
                                                            </tr>
        ...
        <?php }
                            ...
                            <?php } else { ?>  <div class="clearAll"></div>
                                ...
                                <div>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                        <tr>
                                            <th height="140" align="center"  ><?php echo  $langTxt["home:app"] ?> <img src="../img/btn/add.png" align="absmiddle" hspace="10" width="30" onclick="window.open('box.php', '_self');" style="cursor:pointer;"/> <?php echo  $langTxt["home:appLast"] ?></th>
                                        </tr>
                                    </table>
                                </div>
                            <?php } ?>
                                ...
                                <div  class="divRightInnerBigBoxHome">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"   class="divRightTitleHomeBoxAll"  >
                                        <tr ><th width="3%"  class="divRightTitleHome"  valign="middle" align="left" >
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                    <tr>
                                                        <th align="left"><span class="fontTitlTbHome">&nbsp;&nbsp;<?php echo  $langTxt["home:used"] ?></span></th>
                                                        <th align="right"><a href="../core/exportLog.php" title="<?php echo  $langTxt["btn:export"] ?>"><img src="../img/iconfile/3.png" style="padding-right:3px;" width="25" border="0" /></a></th>
                                                    </tr>
                                                </table>
