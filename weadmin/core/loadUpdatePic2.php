...
<?php
	...
	if(!empty($_FILES['fileToUpload2']['error'])){
		...
		if(!is_dir($core_pathname_crupload)) { mkdir($core_pathname_crupload,0777); }
			...
			$filename="pic-header-".$myRandNew."-".$_REQUEST['myID'];
		...
		$msg .= "<div style=\"width:22px; height:22px;float:left;z-index:1; margin-left:-22px;cursor:pointer;\" onclick=\"delPicUploadSite(\'deletePic3.php\',\'boxPicNew2\')\"  title=\"Delete file\" ><img src=\"../img/btn/delete.png\" width=\"22\" height=\"22\"  border=\"0\"/></div>";
