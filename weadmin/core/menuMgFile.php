...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <th valign="top" class="bg_centerhome" align="center"><table width="450" height="250" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <th valign="top">
...
?>
            <table width="100%" border="0" cellpadding="1" cellspacing="0" id="htmltool_table">
              <tr> 
                <th height="22" align="center" valign="middle">&nbsp;</th>
                <th height="22" colspan="2" align="left"><span class="font_style10">
