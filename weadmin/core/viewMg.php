  ...
  <form action="?" method="get" name="myForm" id="myForm">
    ...
    <div class="divRightHead">
      <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center">
        <tr>
          <th height="77" align="left"><span class="fontHeadRight"><?php echo $langTxt["mg:viewpermis"] ?><?php if ($_REQUEST["myParentID"] >= 1) { ?> (<?php echo $valName ?>)<?php } ?></span></th>
          <th align="left">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr id="rowURL" <?php if ($valModuletype == "Module" || $valModuletype == "Group") { ?> style="display:none" <?php } ?>>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            ...
            ?>
            <div class="formDivView"><?php echo $valLinkShow ?></div>
          </td>
        </tr>
        <tr id="rowModuleKey" <?php if ($valModuletype == "Group" || $valModuletype == "Link") { ?> style="display:none" <?php } ?>>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <div class="formDivView"><?php echo $valMasterkey ?></div>
          </td>
        </tr>
