                                ...
                                <tr>
                                    <th>
                                        <table border="0" cellpadding="0" cellspacing="1" class="table_border">
                                            ...
                                            foreach (jt_get_font_icons() as $nameIcon => $value) {
                                                if ($i % 12 === 0) {
                                                    echo '</tr><tr>';
                                                }
                                            ?>
                                                <th width="30" height="30" align="center"><i class="fa <?php echo  $nameIcon ?>" onClick="setIconSelected('fa <?php echo  $nameIcon ?>')"> </i></th>
                                            <?php
                                                $i++;
                                            }
                                            ?>
