...
if ($_SESSION[$valSiteManage . "core_session_language"] == "Eng") {
    ...
    $langTxt["pr:content"] = "Management without status";
    ...
    $langTxt["us:sex"] = "Sex";
    $langTxt["us:firstname"] = "First name";
    $langTxt["us:lastname"] = "Last name";
    ...
    $langTxt["inp:notepic"] ="Note: Please upload only .jpg, .png and .gif files, the size of the image is not more than 2 Mb and the image provided in the upload should be proportional to 150x150 pixels.";

    $langTxt["txt:pic2"] = "Header";
    $langTxt["txt:pic2De"] = "The image header, for use in the picture display of content";
    $langTxt["inp:notepic2"] ="Note: Please upload only .jpg, .png and .gif files, the size of the image is not more than 2 Mb and the image provided in the upload should be proportional to 500x180 pixels.";


    $langTxt["txt:pic3"] = "Background";
    $langTxt["txt:pic3De"] = "The image background, for use in the picture display of content";
    $langTxt["inp:notepic3"] ="Note: Please upload only .jpg, .png and .gif files, the size of the image is not more than 2 Mb and the image provided in the upload should be proportional to 1920x840 pixels.";


    $langMod["sys:department_main"] = "Main office ";
    $langMod["opti:department_main"] = "Select Main office ";
    $langMod["sys:department_sub"] = "Subdivision ";
    $langMod["opti:department_sub"] = "Select Subdivision ";
...
พร้อมทั้งยังสามารถเปิดแสดงผลเนื้อหาได้ทันทีโดยตัวคุณเอง";
    ...
    $langTxt["pr:content"] = "บริหารจัดการไม่รวมสถานะ";
    ...
    $langTxt["us:sex"] = "เพศ";
    $langTxt["us:firstname"] = "ชื่อ";
    $langTxt["us:lastname"] = "นามสกุล";
...
$langMod["sys:department_main"] = "หน่วยงานหลัก ";
$langMod["opti:department_main"] = "เลือกหน่วยงานหลัก ";
$langMod["sys:department_sub"] = "หน่วยงานย่อย ";
$langMod["opti:department_sub"] = "เลือกหน่วยงานย่อย ";
...
$langMod["tit:selectghasg"] = "เลือก".$langMod["inp:hashtag"]."ธีม";
}
