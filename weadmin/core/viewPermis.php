...
<form action="?" method="get" name="myForm" id="myForm">
                        ...
                        <th  class="divRightNavTb" align="right">
                            ...
                            <div class="divRightHead">
                                <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center" >
                                  <tr>
                                    <th height="77" align="left"><span class="fontHeadRight"><?php echo $langTxt["pr:viewpermis"]?></span></th>
                                    <th align="left">
  ...
  <tr >
    ...
    <span class="formFontTileTxt"><?php echo $langTxt["pr:titleDe"]?></span>    </th>
    </tr>
  <tr >
  ...
  <tr >
    ...
    <span class="formFontTileTxt"><?php echo $langTxt["pr:titlePerDe"]?></span>    </th>
    </tr>
   ...
   <tr ><th align="left"  valign="middle"  class="tbRightTitleTbL" >
       <span class="fontTitlTbRight"><?php echo $langTxt["mg:subject"]?>
        </span></th>

    <th width="18%"  class="tbRightTitleTb"  valign="middle"  align="center"><span style="color:#FFCC00;"  class="fontTitlTbRight" ><?php echo $langTxt["pr:all"]?></span></th>
    <th width="18%"  class="tbRightTitleTb"  valign="middle"  align="center"><span style="color:#00CC00;" class="fontTitlTbRight"><?php echo $langTxt["pr:all"]?></span></th>
    <!-- <td width="18%"  class="tbRightTitleTb"  valign="middle"  align="center"><span style="color:#022cff;" class="fontTitlTbRight"><?php echo $langTxt["pr:all"]?></span></td> -->
    <th width="18%"  class="tbRightTitleTbR"  valign="middle"  align="center"><span style="color:#FF0000;"  class="fontTitlTbRight"><?php echo $langTxt["pr:all"]?></span></th>
  </tr>
   <?php
	// Admin
	$Field=$core_tb_menu;
  ...
  <tr class="divOverTb" >
   ...
   <img src="../img/btn/blank.gif" width="11" height="11" id="R<?php echo $topic1[$Field."_id"]?>" name="R<?php echo $topic1[$Field."_id"]?>"   border="0"/>&nbsp;<span><?php echo $langTxt["pr:read"]?> </span>
    ...
    <!-- <td  class="divRightContantOverTb"  valign="top"  align="center">
    <div  style="width:118px; margin:0 auto; text-align:center;">
    <div class="formDivRadioR"  style="color:#022cff;">
    <img src="../img/btn/blank.gif" width="11" height="11" id="CT<?php echo $topic1[$Field."_id"]?>"   name="CT<?php echo $topic1[$Field."_id"]?>"  border="0"/>&nbsp;<span><?php echo $langTxt["pr:content"]?></span>
    </div>
     </div>
    </td> -->
  ...
  <?php
    ...
    <div  style="width:118px; margin:0 auto; text-align:center;">
    <div class="formDivRadioR" style="color:#022cff;">
    <img src="../img/btn/blank.gif" width="11" height="11" id="CT<?php echo $subtopic1[$Field."_id"]?>"  name="CT<?php echo $subtopic1[$Field."_id"]?>" border="0"/>&nbsp;<span><?php echo $langTxt["pr:content"]?></span>
    </div>
    </div>
    </td> -->
