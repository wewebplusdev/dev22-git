  ...
  <form action="?" method="get" name="myForm" id="myForm">
    ...
    <div class="divRightNav">
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
        <tr>
          <td class="divRightNavTb" align="left" id="defTop"><span class="fontContantTbNav"><a href="<?php echo $valLinkNav1 ?>" target="_self"><?php echo $valNav1 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a href="javascript:void(0)" onclick="btnBackPage('../core/userManage.php')" target="_self"><?php echo $valNav2 ?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php echo $langTxt["us:editpermis"] ?></span></td>
...
document.myForm.inputGender[1].checked=true    " /></div>
        ...
        <tr>
          <td width="18%" align="right" valign="top" class="formLeftContantTb"><?php echo $langTxt["us:firstname"] ?><span class="fontContantAlert">*</span></td>
        ...
        <tr>
          <td width="18%" align="right" valign="top" class="formLeftContantTb"><?php echo $langTxt["us:lastname"] ?><span class="fontContantAlert">*</span></td>
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><input name="inputPosition" id="inputPosition" type="text"  class="formInputContantTb" value="<?php echo $valPositionUser ?>"/></td>
  </tr> -->
        <tr>
