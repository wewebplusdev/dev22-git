  ...
  <form action="?" method="get" name="myForm" id="myForm">
    ...
    <div class="divRightHead">
      <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center">
        <tr>
          <th height="77" align="left"><span class="fontHeadRight"><?php echo $langTxt["us:sortpermis"] ?></span></th>
          <th align="left">
                ...
                ?>
                  <li id="listItem_<?php echo $valID ?>" class="divSortDrop">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <th width="58%" align="left" valign="top">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <th align="left"><?php echo $valName ?></th>
                            </tr>
                          </table>
                        </th>
