        ...
        <table  border="0" cellspacing="0" cellpadding="0" align="right">
            <tr>
                <th style="padding-right:10px;" >
                    ...
                    ?>
                    <div style="width:29px; height:29px;  background:url(<?php echo  $valPicProfileTop ?>) center no-repeat; border:#ffffff solid 1px;  background-size: cover;background-repeat: no-repeat;   "><a href="<?php echo  $valLinkViewUser ?>"><img src="../img/btn/boxprofile.png" /></a></div></th>
                <th style="padding-right:10px;" ><a href="<?php echo  $valLinkViewUser ?>"><?php echo  $_SESSION[$valSiteManage . "core_session_name"] ?></a></th>
                <th><a href="javascript:void(0)"onclick="clickInSubMenuTop()" id="showSubMenuTop" title="<?php echo  $langTxt["menu:topmenu"] ?>"><img src="../img/btn/submenu.png" /></a></th>
            </tr>
        </table>
