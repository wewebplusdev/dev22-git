				...
				<tr>
					...
					<th class="divRightNavTb" align="right">
						<table border="0" cellspacing="0" cellpadding="0" align="right">
							<tr>
								<th style="display:none;"><select name="inputGh" id="inputGh" class="formSelectSearch" onchange="document.myForm.submit(); ">
				...
				<tr>
					...
					<th align="left">
						<table border="0" cellspacing="0" cellpadding="0" align="right">
							<tr>
								<th align="right">
									<div class="btnAdd" title="<?php echo $langTxt["btn:add"] ?>" onclick="addContactNew('../core/addMiniUs.php');"></div>
...
if(Paging_CountChecked('CheckBoxID',document.myForm.TotalCheckBoxID.value)>0) {
						...
						<tr class="<?php echo $valDivTr ?>">
							...
							<td class="divRightContantOverTb" valign="top" align="left">
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<th align="left"><a href="javascript:void(0)" onclick="
   document.myFormHome.valEditID.value=<?php echo $valID ?>;  
    viewContactNew('../core/viewUsMini.php');"><?php echo $valName ?></a></th>
									</tr>
								</table>
							...
							<td class="divRightContantOverTbR" valign="top" align="center">
								<table border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<th valign="top" align="center" width="30">
   ...
   document.myFormHome.valEditID.value=<?php echo $valID ?>;  
    editContactNew('../core/editUsMini.php');">
										...
										<?php if ($valID != $_SESSION[$valSiteManage . "core_session_id"]) { ?>
