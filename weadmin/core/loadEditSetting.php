                    ...
                    <form action="?" method="get" name="myForm" id="myForm"  enctype="multipart/form-data">
                        ...
                        <div class="divRightHead">
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center" >
                                <tr>
                                    <th height="77" align="left"><span class="fontHeadRight"><?php echo  $langTxt["st:edit"] ?></span></th>
                                    <th align="left">
                            ...
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                                <tr >
                                    <th colspan="7" align="left"  valign="middle" class="formTileTxt tbBoxViewBorderBottom">
                                        ...
                                        <span class="formFontTileTxt"><?php echo  $langTxt["st:titleDe"] ?></span>    </th>
                                </tr>
                                <tr >
                                ...
                                <tr >
                                    ...
                                    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
                                        ...
                                        <label>
                                            <div class="formDivRadioL"><input name="inputType" id="inputType" type="radio" class="formRadioContantTb"  <?php if ($valType == "3") { ?>checked="checked"<?php } ?> value="3" /></div>
                                            <div class="formDivRadioR"><?php echo  $langTxt["st:3"] ?></div>
                                        </label>
                                    </td>
                                </tr>
                            ...
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
                                <tr >
                                    <th colspan="7" align="left"  valign="middle" class="formTileTxt tbBoxViewBorderBottom">
                                        ...
                                        <span class="formFontTileTxt"><?php echo  $langTxt["txt:aboutDe"] ?></span>                             </th>
                                </tr>
                                <tr >
                            ...
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder "> 
                                <tr >
                                    <th colspan="7" align="left"  valign="middle" class="formTileTxt tbBoxViewBorderBottom">
                                        ...
                                        <span class="formFontTileTxt"><?php echo  $langTxt["txt:picDe"] ?></span>    </th>
                                </tr>
                            ...
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder "> 
                                <tr >
                                    <th colspan="7" align="left"  valign="middle" class="formTileTxt tbBoxViewBorderBottom">
                                        ...
                                        <span class="formFontTileTxt"><?php echo  $langTxt["txt:pic2De"] ?></span>    </th>
                                </tr>
                                <tr ><td colspan="7" align="right"  valign="top"   height="15" ></td></tr>
                            ...
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder "> 
                                <tr >
                                    <th colspan="7" align="left"  valign="middle" class="formTileTxt tbBoxViewBorderBottom">
                                        ...
                                        <span class="formFontTileTxt"><?php echo  $langTxt["txt:pic3De"] ?></span>    </th>
                                </tr>
                                <tr ><td colspan="7" align="right"  valign="top"   height="15" ></td></tr>
