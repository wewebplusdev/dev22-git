                    ...
                    <form action="?" method="post" name="myForm" id="myForm">
                        ...
                        <div class="divRightMain" >
                            ...
                            <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
                                <tr ><th width="3%"  class="divRightTitleTbL"  valign="middle" align="center" >
                                        <input name="CheckBoxAll" type="checkbox"  id="CheckBoxAll"  value="Yes" onClick="Paging_CheckAll(this, 'CheckBoxID', document.myForm.TotalCheckBoxID.value)"   class="formCheckboxHead" />    </th>

                                    <th  class="divRightTitleTb"   valign="middle" align="left" ><span class="fontTitlTbRight"><?php echo  $langTxt["mg:subject"] ?></span></th>
                                    <th width="12%"  class="divRightTitleTb"  valign="middle"  align="center"><span class="fontTitlTbRight"><?php echo  $langTxt["mg:type"] ?></span></th>
                                    <th width="12%"  class="divRightTitleTb"  valign="middle"  align="center"><span class="fontTitlTbRight"><?php echo  $langTxt["mg:show"] ?></span></th>
                                                        ...
                                                        <?php if ($valType == "Group") { ?>
                                                            <th valign="top" align="center" width="30">
                                                                <div class="divRightManage" title="<?php echo  $langTxt["btn:add"] ?>" onclick="
                                                                    ...
                                                                    <span class="fontContantTbManage"><?php echo  $langTxt["btn:add"] ?></span>    </div>    </th>
                                                        <?php } ?>
                                                        <th valign="top" align="center" width="30">
                                                            <div class="divRightManage" title="<?php echo  $langTxt["btn:edit"] ?>" onclick="
                                                                ...
                                                                <span class="fontContantTbManage"><?php echo  $langTxt["btn:edit"] ?></span>    </div>    </th>
                                                        <th valign="top" align="center" width="30">
                                                            <div class="divRightManage" title="<?php echo  $langTxt["btn:del"] ?>"  onClick="
                                                                ...
                                                                <span class="fontContantTbManage"><?php echo  $langTxt["btn:del"] ?></span>    </div>    </th>
                                                    </tr>
                                                </table>    </td>
                                        </tr>
                                        <?php
                                                ...
                                                while ($rowSub = wewebFetchArrayDB($coreLanguageSQL, $querySub)) {
                                                    ...
                                                    <tr class="divSubOverTb" >
                                                        ...
                                                        <td  class="divRightContantTb"  valign="top"  align="center">
                                                            ...
                                                            <span class="fontContantTbTime"><?php echo  $valTimeCredateSub ?></span>    </td>
                                                                ...
                                                                <tr>
                                                                    <th valign="top" align="center" width="30">
                                                                        <div class="divRightManage" title="<?php echo  $langTxt["btn:sort"] ?>" onclick="
                                                                            ...
                                                                            <span class="fontContantTbManage"><?php echo  $langTxt["btn:sort"] ?></span>    </div>    </th>
                                                                    <th valign="top" align="center" width="30">
                                                                        <div class="divRightManage" title="<?php echo  $langTxt["btn:edit"] ?>" onclick="
                                                                                document.myFormHome.myParentID.value =<?php echo  $valID ?>;
                                                                                document.myFormHome.valEditID.value =<?php echo  $valIDSub ?>;
                                ...
                                <tr >
                                    <td colspan="7" align="center"  valign="middle"  class="divRightContantTbRL" >
                                        <table width="98%" border="0" cellspacing="0" cellpadding="0"  align="center" >
                                            <tr>
                                                <th  class="divRightNavTb" align="left"><span class="fontContantTbNavPage"><?php echo  $langTxt["pr:All"] ?> <b><?php echo  number_format($recordCount) ?></b> <?php echo  $langTxt["pr:record"] ?></span></th>
                                                <th  class="divRightNavTb" align="right">                        </th>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
