  ...
  <form action="?" method="get" name="myForm" id="myForm">
    ...
    <div class="divRightHead">
      <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center">
        <tr>
          <th height="77" align="left"><span class="fontHeadRight"><?php echo $langTxt["pr:editpermis"] ?></span></th>
          <th align="left">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        <tr>
          <th colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
            ...
            <span class="formFontTileTxt"><?php echo $langTxt["pr:titleDe"] ?></span>
          </th>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <select name="inputaccess" id="inputaccess" class="formSelectContantTb">
              ...
              <option value="admin" <?php if ($valLv == "admin") { ?> selected="selected" <?php } ?>><?php echo $langTxt["pr:select1"] ?></option>
              <option value="staff" <?php if ($valLv == "staff") { ?> selected="selected" <?php } ?>><?php echo $langTxt["pr:select2"] ?></option>
            </select>
          </td>
        </tr>
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb"><input name="inputnamegroup" id="inputnamegroup" type="text" class="formInputContantTb" value="<?php echo $valName ?>" /></td>
        </tr>
      </table>
      <br />
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder ">
        ...
        <tr>
          <th colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
            ...
            <span class="formFontTileTxt"><?php echo $langTxt["pr:titlePerDe"] ?></span>
          </th>
        </tr>
        ...
        <tr>
          <td colspan="7" align="left" valign="top" class="formTileTxt">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                <th align="left" valign="middle" class="tbRightTitleTbL">
                ...
                <!-- <td width="18%"  class="tbRightTitleTb"  valign="middle"  align="center"><span onclick="checkAllAdmin('AdminCT');"  style="cursor:pointer;color:#022cff;"  class="fontTitlTbRight"><?php echo $langTxt["pr:all"] ?></span></td> -->
                  ...
                  <tr class="divOverTb">
                      ...
                      <div style="width:125px; margin:0 auto; text-align:center;">
                        <label>
                          <div class="formDivRadioL">
                            <input name="Admin<?php echo $topic1[$Field . "_id"] ?>" id="AdminR<?php echo $topic1[$Field . "_id"] ?>" type="radio" class="formRadioContantTb" value="R" onclick="checkInSubAdmin('AdminR',<?php echo $topic1[$Field . "_id"] ?>)" />
                          </div>
                    ...
                    <td class="divRightContantOverTb" valign="top" align="center">
                      <div style="width:118px; margin:0 auto; text-align:center;">
                        <label>
                          <div class="formDivRadioL">
                            <input name="Admin<?php echo $topic1[$Field . "_id"] ?>" id="AdminRW<?php echo $topic1[$Field . "_id"] ?>" type="radio" class="formRadioContantTb" value="RW" onclick="checkInSubAdmin('AdminRW',<?php echo $topic1[$Field . "_id"] ?>)" />
                          </div>
    ...
    <label>
    <div class="formDivRadioL">
    <input name="Admin<?php echo $topic1[$Field . "_id"] ?>"  id="AdminCT<?php echo $topic1[$Field . "_id"] ?>" type="radio" class="formRadioContantTb"  value="CT" onclick="checkInSubAdmin('AdminCT',<?php echo $topic1[$Field . "_id"] ?>)" /></div>
    <div class="formDivRadioR"  style="color:#022cff;"><?php echo $langTxt["pr:content"] ?></div>
    </label>
    </div>
    </td> -->
                    ...
                    <td class="divRightContantOverTbR" valign="top" align="center">
                      <div style="width:145px; margin:0 auto; text-align:center;">
                        <label>
                          <div class="formDivRadioL">
                            <input name="Admin<?php echo $topic1[$Field . "_id"] ?>" id="AdminNA<?php echo $topic1[$Field . "_id"] ?>" type="radio" class="formRadioContantTb" value="NA" onclick="checkInSubAdmin('AdminNA',<?php echo $topic1[$Field . "_id"] ?>)" />
                          </div>
                      ...
                      <tr class="divSubOverTb">
                        ...
                        <td class="divRightContantTb" valign="top" align="center">
                          <div style="width:125px; margin:0 auto; text-align:center;">
                            <label>
                              <div class="formDivRadioL">
                                <input name="Admin<?php echo $subtopic1[$Field . "_id"] ?>" id="AdminR<?php echo $subtopic1[$Field . "_id"] ?>" type="radio" class="formRadioContantTb" value="R" onclick="checkInSub('R',<?php echo $subtopic1[$Field . "_id"] ?>)" />
                              </div>
                        ...
                        <td class="divRightContantTb" valign="top" align="center">
                          <div style="width:118px; margin:0 auto; text-align:center;">
                            <label>
                              <div class="formDivRadioL">
                                <input name="Admin<?php echo $subtopic1[$Field . "_id"] ?>" id="AdminRW<?php echo $subtopic1[$Field . "_id"] ?>" type="radio" class="formRadioContantTb" value="RW" onclick="checkInSub('RW',<?php echo $subtopic1[$Field . "_id"] ?>)" />
                              </div>
    ...
    <label>
    <div class="formDivRadioL">
    <input name="Admin<?php echo $subtopic1[$Field . "_id"] ?>"  id="AdminCT<?php echo $subtopic1[$Field . "_id"] ?>" type="radio" class="formRadioContantTb"  value="CT" onclick="checkInSub('CT',<?php echo $subtopic1[$Field . "_id"] ?>)" /></div>
    <div class="formDivRadioR"  style="color:#022cff;"><span for="CT<?php echo $subtopic[$Field . "_id"] ?>"><?php echo $langTxt["pr:content"] ?></span></div>
    </label>
    </div>
    </td> -->
                        ...
                        <td class="divRightContantTbR" valign="top" align="center">
                          <div style="width:145px; margin:0 auto; text-align:center;">
                            <label>
                              <div class="formDivRadioL">
                                <input name="Admin<?php echo $subtopic1[$Field . "_id"] ?>" id="AdminNA<?php echo $subtopic1[$Field . "_id"] ?>" type="radio" class="formRadioContantTb" value="NA" onclick="checkInSub('NA',<?php echo $subtopic1[$Field . "_id"] ?>)" />
                              </div>
