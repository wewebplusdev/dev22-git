...
?>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			<th class="divRightTrHomeLog" style="padding-left:20px;" valign="top"><b><?php echo $langTxt["mg:subject"] ?></b></th>
			<th width="15%" height="30" align="center" class="divRightTrHomeLog" valign="top"><b><?php echo $langTxt["home:access"] ?></b></th>
			<th width="15%" align="center" class="divRightTrHomeLog" valign="top"><b><?php echo $langTxt["us:creby"] ?></b></th>
			<th width="23%" align="center" class="divRightTrHomeLog" valign="top"><b><?php echo $langTxt["home:date"] ?></b></th>
		</tr>
