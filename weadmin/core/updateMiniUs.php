...
include("../lib/checkMember.php");
	...
	if($_REQUEST['execute']=="update"){
		...
		$update[]=$core_tb_staff."_typeuser  	='".changeQuot($_REQUEST['inputTypeUser'])."'";
		$update[]=$core_tb_staff."_typeapprove  	='".changeQuot($_REQUEST['inputTypeApprove'])."'";
		
		$update[]=$core_tb_staff."_part  	='".changeQuot($_REQUEST['inputPart'])."'";
		$update[]=$core_tb_staff."_position  	='".changeQuot($_REQUEST['inputPosition'])."'";
		...
		$update[]=$core_tb_staff."_usercar  	='".changeQuot($_REQUEST['inputUsercar'])."'";
		
		if($_REQUEST["valEditID"]!=$_REQUEST['valUserMain']){
		$update[]=$core_tb_staff."_typeusermini  	='".changeQuot($_REQUEST['valUserMain'])."'";
		}
...
<form action="../core/userMiniManage.php" method="post" name="myFormAction" id="myFormAction">
