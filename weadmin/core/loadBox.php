  ...
  <form action="?" method="post" name="myForm" id="myForm">
    ...
    <div class="divRightHead">
      <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center">
        <tr>
          <th width="93%" height="77" align="left"><span class="fontHeadRight"><?php echo $valNav2 ?></span></th>
          <th width="7%" align="right">
            <div class="btnBack" title="<?php echo $langTxt["btn:back"] ?>" onclick="window.open('<?php echo $valLinkNav1 ?>','_self');"></div>
          </th>
        </tr>
      </table>
    </div>
    <div class="divRightMain">
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxListwBorder">
        <tr>
          <th width="2%" class="divRightTitleTbL" valign="middle" align="center">&nbsp;</th>

          <th width="86%" align="left" valign="middle" class="divRightTitleTb"><span class="fontTitlTbRight"><?php echo $langTxt["mg:subject"] ?></span></th>
