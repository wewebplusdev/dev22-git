...
include("../lib/checkMember.php");
	...
	if($_REQUEST['execute']=="insert"){
		...
		$insert[$core_tb_staff."_typeuser"] = "'".changeQuot($_REQUEST['inputTypeUser'])."'";
		$insert[$core_tb_staff."_typeapprove"] = "'".changeQuot($_REQUEST['inputTypeApprove'])."'";
		
		$insert[$core_tb_staff."_part"] = "'".changeQuot($_REQUEST['inputPart'])."'";
		...
		$insert[$core_tb_staff."_typeusermini"] = "'".changeQuot($_REQUEST['valUserMain'])."'";
