...
$valLinkNav1="../core/index.php";
			...
			if($_REQUEST['inputLt']=="Thai"){
				...
				$sql .= "  ".$mod_tb_root_group."_id , ".$mod_tb_root_group."_lastdate, ".$mod_tb_root_group."_creby, ".$mod_tb_root_group."_status  ,    ".$mod_tb_root_group."_subjectcn  ,    ".$mod_tb_root_group."_titlecn   ";
			}
			// $sql .= "  ,".$mod_tb_root_group."_showhome ";
			...
			$valSubject=$Row[4];
			$valTitle=$Row[5];
			// $valShowHome=rechangeQuot($Row[6]);
...
<form action="?" method="get" name="myForm" id="myForm">
    ...
    <input name="valDelFile" type="hidden" id="valDelFile" value="" />
					<div class="divRightNav">
                        ...
                        <tr>
                        <td  class="divRightNavTb" align="left"  id="defTop" ><span class="fontContantTbNav"><a href="<?php echo $valLinkNav1?>" target="_self"><?php echo $valNav1?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <a  href="javascript:void(0)"  onclick="btnBackPage('group.php')" target="_self"><?php echo $langMod["meu:group"]?></a> <img src="../img/btn/nav.png" align="absmiddle" vspace="5" /> <?php echo $langMod["txt:titleeditg"]?><?php if ($_SESSION[$valSiteManage.'core_session_languageT']==2 || $_SESSION[$valSiteManage.'core_session_languageT']==3) { ?>(<?php echo  getSystemLangTxt($_REQUEST['inputLt'], $langTxt["lg:thai"], $langTxt["lg:eng"], $langTxt["lg:chi"]) ?>)<?php } ?></span></td>
                        <td  class="divRightNavTb" align="right">
                            ...
                            <div class="divRightHead">
                                <table width="96%" border="0" cellspacing="0" cellpadding="0" class="borderBottom" align="center" >
                                  <tr>
                                    <td height="77" align="left"><span class="fontHeadRight"><?php echo $langMod["txt:titleeditg"]?><?php if ($_SESSION[$valSiteManage.'core_session_languageT']==2 || $_SESSION[$valSiteManage.'core_session_languageT']==3) { ?>(<?php echo  getSystemLangTxt($_REQUEST['inputLt'], $langTxt["lg:thai"], $langTxt["lg:eng"], $langTxt["lg:chi"]) ?>)<?php } ?></span></td>
                                    <td align="left">
  ...
  <!-- <tr  >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo $coreShowHomeSite[0]?> <span class="fontContantAlert">*</span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
    <label>
    <div class="formDivRadioL"><input name="inputTypeHome" id="inputTypeHome" value="1" type="radio"  class="formRadioContantTb"   <?php if($valShowHome<=1){ ?>  checked="checked" <?php } ?>></div>
    <div class="formDivRadioR"><?php echo $coreShowHomeSite[1]?></div>
    </label>
  
    <label>
    <div class="formDivRadioL"><input name="inputTypeHome" id="inputTypeHome"  value="2"  type="radio"  class="formRadioContantTb"    <?php if($valShowHome==2){ ?>  checked="checked" <?php } ?> /></div>
    <div class="formDivRadioR"><?php echo $coreShowHomeSite[2]?></div>
    </label>
    </label>    </td>
      </tr> -->
  <tr >
