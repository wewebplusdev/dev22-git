...
<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
   <tr ><td width="3%"  class="divRightTitleTbL"  valign="middle" align="center" >
     ...
     <td width="27%" align="left"   valign="middle"  class="divRightTitleTb" ><span class="fontTitlTbRight"><?php echo $langMod["tit:subject"]?><?php if($_SESSION[$valSiteManage.'core_session_languageT']==2){ ?>(<?php echo $langTxt["lg:eng"]?>)<?php } ?></span></td>
     <?php } ?>
  ...
  <?php 
// SQL SELECT #########################
$sql = "SELECT ".$mod_tb_root."_id,".$mod_tb_root."_subject,".$mod_tb_root."_lastdate,".$mod_tb_root."_status,".$mod_tb_root."_subjecten,".$mod_tb_root."_pic  FROM ".$mod_tb_root;
...
if($count_record>0) {
	while($index<$count_record+1) {
		...
		$sqlJ = "SELECT  ".$mod_tb_apply."_id FROM ".$mod_tb_apply." WHERE  ".$mod_tb_apply."_jID='".$valID."' ";
		$queryJ=wewebQueryDB($coreLanguageSQL,$sqlJ);
		$count_recordJ=wewebNumRowsDB($coreLanguageSQL,$queryJ);		
  ...
  <tr>
   ...
   document.myFormHome.valEditID.value=<?php echo $valID?>;  
    viewContactNew('viewContant.php');" ><?php echo $valName?></a></td>
  </tr>
</table></td>
<?php if($_SESSION[$valSiteManage.'core_session_languageT']==2){ ?>
...
<?php } ?>
    ...
    <a href="mem.php?masterkey=<?php echo $_REQUEST['masterkey']?>&amp;menukeyid=<?php echo ($_REQUEST['menukeyid']+1)?>&amp;inputGh=<?php echo $valID?>"><span class="fontContantTbupdate"><?php echo number_format($count_recordJ)?></span></a>   </td>
...
<a href="javascript:void(0)"  onclick="changeStatus('load_waiting<?php echo $valID?>','<?php echo $mod_tb_root?>','<?php echo $valStatus?>','<?php echo $valID?>','load_status<?php echo $valID?>','../<?php echo $mod_fd_root?>/statusMg.php')" ><span class="<?php echo $valStatusClass?>"><?php echo $valStatus?></span></a>
  ...
  <tr>
   ...
   document.myFormHome.valEditID.value=<?php echo $valID?>;  
    ...
    <span class="fontContantTbManage"><?php echo $langTxt["btn:top"]?></span></div>
  </td>
<td valign="top" align="center" width="30">
