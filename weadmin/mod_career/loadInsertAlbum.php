...
<?phpphp
	...
	if(!empty($_FILES['inputAlbumUpload']['error'])){
		...
		$Query=wewebQueryDB($coreLanguageSQL,$sql);	
			...
			$sql_filetemp="SELECT  ".$mod_tb_root_albumTemp."_id,".$mod_tb_root_albumTemp."_filename,".$mod_tb_root_albumTemp."_name,".$mod_tb_root_albumTemp."_download  FROM ".$mod_tb_root_albumTemp." WHERE ".$mod_tb_root_albumTemp."_contantid 	='".$_REQUEST['myID']."'    ORDER BY ".$mod_tb_root_albumTemp."_id ASC";
			...
			$imageType = strstr($downloadFile,'.');														
				...
				$msg .= "<div style=\"width:15px; height:15px;float:left;z-index:1; margin-left:-15px;cursor:pointer;margin-right:15px;margin-top:15px;\" onclick=\"document.myForm.valDelAlbum.value=".$downloadID.";delAlbumUpload(\'deleteAlbumInsert.php\')\"  title=\"Delete file\" ><img src=\"../img/btn/delete.png\" width=\"15\" height=\"15\"  border=\"0\"/></div>";
			}}
	}		
	echo "{";
