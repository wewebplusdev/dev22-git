  ...
  <tr>
   ...
   <select name="inputProvince"  id="inputProvince" class="formSelectSearchStyle" onchange="document.myForm.submit(); ">
    ...
    <td style="padding-right:3px;"  width="33%"><select name="inputSex"  id="inputSex" class="formSelectSearchStyle" onchange="document.myForm.submit(); ">
       ...
       <option value="1" <?php if($_REQUEST['inputSex']==1){ ?> selected="selected" <?php } ?>><?php echo $modTxtSexThai[1]?> </option>
       <option value="2" <?php if($_REQUEST['inputSex']==2){ ?> selected="selected" <?php } ?>><?php echo $modTxtSexThai[2]?> </option>
    </select></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
if($count_record>0) {
    ...
    $valMobile=rechangeQuot($row[11]);
		...
		// $test=json_decode($row['test'],true);
		// print_pre($test);
  ...
  <tr>
    ...
    <div style="width:29px; height:29px;  background:url(<?php echo $valPic?>) center no-repeat; background-size: cover;background-repeat: no-repeat;   "><img src="../img/btn/<?php echo $valImgCycle?>" /></div>    </td>
  ...
  <tr>
	...
	<?php echo $langMod["ep:sex"]?>: <?php echo $modTxtSexThai[$valSex]?><br />
  ...
  <tr>
    ...
    <span class="fontContantTbManage"><?php echo $langMod["btn:export3"]?></span>    </div>    </td>
