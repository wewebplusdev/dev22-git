...
$sql = $sql."  WHERE ".$mod_tb_root."_masterkey ='".$_REQUEST['masterkey']."'  ORDER BY ".$mod_tb_root."_order DESC   LIMIT 0,5";
  ...
  <tr>
    ...
    <td  align="left"  valign="top"><a href="../<?php echo $mod_fd_root?>/viewContant.php?masterkey=<?php echo $_REQUEST['masterkey']?>&menukeyid=<?php echo $_REQUEST['menukeyid']?>&viewID=1&inputLt=<?php echo $_SESSION[$valSiteManage.'core_session_language']?>&valEditID=<?php echo $valID?>" class="moreDetailAb fancybox.iframe"><?php echo txtLimit($valNameShow,45)?></a></td>
  </tr>
  <?php  } ?>
  </table>
...
<script type="text/javascript">
	jQuery(function() {
		jQuery(".moreDetailAb").colorbox({width:"950px", height:"600px"});
	});
</script>
