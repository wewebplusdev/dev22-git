...
$valTypeSal = rechangeQuot($Row[19]);
//  echo $valTypeSal;
$valSalaryFr = rechangeQuot($Row[20]);
$valSalaryTo = rechangeQuot($Row[21]);
$valSalaryOne = rechangeQuot($Row[22]);
$valQuantity = rechangeQuot($Row[23]);
...
<body>
  <form action="?" method="get" name="myForm" id="myForm">
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
      ...
      ?>
        ...
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <div class="formDivView"><?php echo $modTxtSalary[$valTypeSal] ?></div>
          </td>
        </tr>
        <?php if ($valTypeSal == 2) { ?>
          <tr>
            ...
            <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
              <div class="formDivView"><?php echo number_format($valSalaryOne) ?></div>
            </td>
          </tr>
        <?php } ?>
        <?php if ($valTypeSal == 3) { ?>
          <tr>
            <td width="18%" align="right" valign="top" class="formLeftContantTb"><?php echo $langMod["inp:salaryinfo"] ?>:<span class="fontContantAlert"></span></td>
            <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
              <div class="formDivView"><?php echo number_format($valSalaryFr) ?>-<?php echo number_format($valSalaryTo) ?></div>
            </td>
          </tr>
        <?php } ?>
        <tr>
          ...
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <div class="formDivView"><?php echo number_format($valQuantity) ?></div>
          </td>
        </tr>
        <tr>
    ...
    <td width=" 18%" align="right" valign="top" class="formLeftContantTb"><span class="fontContantAlert"></span></td>
          <td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
            <div class="formDivView">
              <img src="<?php echo $valPic ?>" width="500" height="480" style="float:left;border:#c8c7cc solid 1px;" onerror="this.src='<?php echo "../img/btn/nopic.jpg" ?>'" />
            </div>
          </td>
        </tr>
      </table>
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr>
          <td width="18%" align="left" valign="top" class="formLeftContantTb">
          <td colspan="6" align="left" valign="top" class="formLeftContantTb">
            <div style=" line-height:normal; width:100%; margin-top:-10px;">
              <?php
              $fd = @fopen($valHtml, "r");
