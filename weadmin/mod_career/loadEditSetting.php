...
$sql .= " , " . $mod_tb_setting . "_picshow, " . $mod_tb_setting . "_typec , " . $mod_tb_setting . "_urlc, " . $mod_tb_setting . "_target, " . $mod_tb_setting . "_pic2, " . $mod_tb_setting . "_title2, " . $mod_tb_setting . "_urlfriendly  FROM " . $mod_tb_setting . " WHERE " . $mod_tb_setting . "_masterkey='" . $_POST["masterkey"] . "' AND  " . $mod_tb_setting . "_id 	='" . $_POST["valEditID"] . "'";
...
<body>
	<form action="?" method="get" name="myForm" id="myForm" enctype="multipart/form-data">
		...
		<td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" >
			<input name="inputUrlFriendly" id="inputUrlFriendly" type="text" onchange="urlfriendly('inputUrlFriendly','inputUrlFriendly','checkurl.php');" value="<?php echo $valUrlfriendly ?>" class="formInputContantTb"/>
			<span class="formFontNoteTxt">URL : <span id="urlstatus" style="color:green;">สามารถใช้งานได้</span></span>
		</td>
	</tr> -->
					...
					<td width="82%" colspan="6" align="left" valign="top" class="formRightContantTb">
						...
						<div id="boxPicNew" class="formFontTileTxt">
							<?php if (is_file($valPic)) { ?>
								...
								<div style="width:22px; height:22px;float:left;z-index:1; margin-left:-22px;cursor:pointer;" onclick="delPicUpload('deletePicS.php')" title="Delete file"><img src="../img/btn/delete.png" width="22" height="22" border="0" /></div>
         ...
         <br  class="ckabout" <?php if ($valTypeC == 2) { ?> style="display:none;" <?php } ?>/> -->
			<table width="96%" border="0" cellspacing="0" cellpadding="0" align="center" class="tbBoxViewBorder">
				<tr>
					<td colspan="7" align="left" valign="middle" class="formTileTxt tbBoxViewBorderBottom">
						<span class="formFontSubjectTxt"><?php echo $langMod["txt:titles"] ?></span><br />
						<span class="formFontTileTxt"><?php echo $langMod["txt:titlesDe"] ?></span>
					</td>
				</tr>
				<tr>
	...
	<script type="text/javascript" language="javascript">
		...
		function ajaxFileUpload() {
			...
			jQuery.ajaxFileUpload({
				url: 'loadUpdatePicS.php?myID=<?php echo $_POST["valEditID"] ?>&masterkey=<?php echo $_REQUEST['masterkey'] ?>&langt=<?php echo $_REQUEST['inputLt'] ?>&delpicname=' + valuepicname + '&menuid=<?php echo $_REQUEST['menukeyid'] ?>',
				secureuri: false,
