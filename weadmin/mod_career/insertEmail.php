...
include("config.php");
		...
		$sql = "SELECT ".$mod_tb_root_email."_email FROM ".$mod_tb_root_email."  WHERE  ".$mod_tb_root_email."_masterkey='".$_REQUEST["masterkey"]."'  AND   ".$mod_tb_root_email."_email='".$_REQUEST['inputEmail']."'";
