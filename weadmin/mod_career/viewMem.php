...
$valLinkNav1="../core/index.php";
        ...
        ".$mod_tb_apply."_email           as email, 
				".$mod_tb_apply."_mobile          as mobile, 
				".$mod_tb_apply."_jID             as jID, 
				".$mod_tb_apply."_amphur          as amphur, 
				".$mod_tb_apply."_district        as district, 
				".$mod_tb_apply."_postcode        as postcode, 
				".$mod_tb_apply."_bdate           as bdate, 
				".$mod_tb_apply."_bmonth          as bmonth, 
				".$mod_tb_apply."_byear           as byear, 
				".$mod_tb_apply."_religion        as religion, 
				".$mod_tb_apply."_marry           as marry, 
				".$mod_tb_apply."_weight          as weight, 
				".$mod_tb_apply."_height          as height, 
				".$mod_tb_apply."_soider          as soider, 
				".$mod_tb_apply."_school          as school, 
				".$mod_tb_apply."_branch          as branch, 
				".$mod_tb_apply."_graduation      as graduation, 
				".$mod_tb_apply."_gpa             as gpa, 
				".$mod_tb_apply."_talent          as talent, 
				".$mod_tb_apply."_address         as address, 
				".$mod_tb_apply."_file            as file,
        ".$mod_tb_apply."_nationality     as nationality,
        ".$mod_tb_apply."_sdate           as startDate,
      ...
      $valStartDate=dateFormatReal($Row['startDate']);
      // print_pre();
      $valAge=$Row['age'];
      $valRace=$Row['race'];
      $valBlood=$Row['blood'];
...
?>
  ...
  <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valSalary?></div></td>
  </tr>  
  ...
  <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valStartDate?></div></td>
  </tr>  
 <tr >
 ...
 <tr colspan="7" height="20"><td></td></tr>
    ...
    <span class="formFontTileTxt"><?php echo $langMod["txt:regisDe"]?></span>    </td>
    </tr>
     <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo loadNameProvince($valProvince)?></div></td>
  </tr>
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valZipcode?></div></td>
  </tr>
  ...
  <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valBdate?></div></td>
  </tr>
  <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo $langMod["ep:blood"]?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valBlood?></div></td>
  </tr>
  <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo "อายุ" ?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valAge?> <?php echo $langMod["age"];?></div></td>
  </tr>
  <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo $langMod["ep:sex"]?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $modTxtSexThai[$valSex]?></div></td>
  </tr>
 <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valNationality?></div></td>
  </tr> 
  <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo "เชื้อชาติ" ?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valRace?></div></td>
  </tr> 
  <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php//=$modTxtBuddhaThai[$valReligion]?><?php echo $valReligion?></div></td>
  </tr>
  <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valNationcardID ?></div></td>
  </tr>
  <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valPositionID ?></div></td>
  </tr>
  <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo "ออกให้โดย" ?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valNationcardBY ?></div></td>
  </tr>
  <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo "จังหวัด" ?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valNationcardProvince ?></div></td>
  </tr>
     <!-- <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo $langMod["ep:h"]?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valH?></div></td>
  </tr> -->
     <!-- <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo $langMod["ep:w"]?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valW?></div></td>
  </tr> -->
     <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo $langMod["ep:army"]?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php//=$modTxtArmyThai[$valArmy]?>
      <?php echo $valArmy?>
    </div></td>
  </tr>
  <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valLove ?></div></td>
  </tr>
  ...
  <tr >
    ...
    <span class="formFontTileTxt"><?php echo $langMod["txt:regis6De"]?></span>    </td>
  </tr>
  <tr >
...
<?php } ?>
  ...
  <tr colspan="7" height="20"><td></td></tr>
    ...
    <span class="formFontTileTxt"><?php echo $langMod["txt:regis3De"]?></span>    </td>
    </tr>
     <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo $langMod["ep:edu"]?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valEdu ?></div></td>
  </tr>   <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valAcademy?></div></td>
  </tr>  
   <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valQualification?></div></td>
  </tr>  
   <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valEduyear?></div></td>
  </tr>   <tr >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo $langMod["ep:gpa"]?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valGpa?></div></td>
  </tr> 
  ...
  <tr colspan="7" height="20"><td></td></tr>
    ...
    <span class="formFontTileTxt"><?php echo $langMod["txt:regis8De"]?></span>    </td>
    </tr>
    <?php } ?> 
  <?php 
...
<tr colspan="7" height="20"><td></td></tr>
    ...
    <span class="formFontTileTxt"><?php echo $langMod["txt:regis9De"]?></span>    </td>
    </tr>
    <?php } ?>
  <?php 
...
<?php } ?>
  ...
  <tr colspan="7" height="20"><td></td></tr>
    ...
    <span class="formFontTileTxt"><?php echo $langMod["txt:regis5De"]?></span>    </td>
    </tr>
...
<?php } ?> 
  ...
  <tr   >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valPrintt?></div></td>
  </tr>   <tr   >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valPrinte?></div></td>
  </tr>
  <tr   >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" >ทักษะคอมพิวเตอร์:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valprogram?></div></td>
  </tr>

  <tr   >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" >ขับรถยนต์:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valDriv?></div></td>
  </tr>
  <tr   >
    <td width="18%" align="right"  valign="top"  class="formLeftContantTb" ><?php echo $langMod["ep:car"]?>:<span class="fontContantAlert"></span></td>
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valCar?></div></td>
  </tr>
  <tr  >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView"><?php echo $valDriving->drivCard ?> <?php echo $valDriving->id ?></div></td>
  </tr>
  <tr >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView">
      <?php if ($valSpecial!=""){echo $valSpecial;}else { echo "-";} ?></div></td>
  </tr>
  <?php $i=1; ?>
  ...
  <tr  >
    ...
    <td width="82%" colspan="6" align="left"  valign="top"  class="formRightContantTb" ><div class="formDivView">
    <?php if($valgeneral->job1){  echo $valgeneral->job1.","; } ?>
    <?php if($valgeneral->job2){  echo $valgeneral->job2."," ; } ?>
    <?php if($valgeneral->job3){  echo $valgeneral->job3."," ; } ?>
    <?php if($valgeneral->job4){  echo $valgeneral->job4."," ; } ?>
    <?php if($valgeneral->job5){  echo $valgeneral->job5.":"; } ?>
    <?php if($valgeneral->jobref){  echo $valgeneral->jobref;  } ?>
  </div></td>
  </tr>
