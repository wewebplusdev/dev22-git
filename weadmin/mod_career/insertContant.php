...
if ($_REQUEST['execute'] == "insert") {
	...
	$insert[$mod_tb_root . "_salaryFr"] = "'" . changeQuot($_REQUEST['inputSalaryFrom']) . "'";
	$insert[$mod_tb_root . "_salaryTo"] = "'" . changeQuot($_REQUEST['inputSalaryTo']) . "'";
	$insert[$mod_tb_root . "_salaryOne"] = "'" . changeQuot($_REQUEST['inputSalaryOne']) . "'";
	...
	$valUrlSearchTH = $mod_url_search_th . "/detail/" . $contantID . "/";
	$valUrlSearchEN = $mod_url_search_en . "/detail/" . $contantID . "/";
	$valUrlSearchCN = $mod_url_search_cn . "/detail/" . $contantID . "/";
