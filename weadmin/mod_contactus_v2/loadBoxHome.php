...
$sql = "SELECT ".$mod_tb_root."_id,".$mod_tb_root."_subject,".$mod_tb_root."_credate,".$mod_tb_root."_status FROM ".$mod_tb_root;
$sql = $sql."  WHERE ".$mod_tb_root."_masterkey ='".$_REQUEST['masterkey']."'  ORDER BY ".$mod_tb_root."_id DESC LIMIT 0,5 ";
