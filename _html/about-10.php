                ...
                <div class="container">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="profile-block">
                                <div class="profile">
                                    <div class="h-title">อดีตคณะกรรมการ</div>
                                    <ul class="item-list">
                                        <?php for ($i = 1; $i <= 4; $i++) { ?>
                                            <li>
                    ...
                    <div class="row mt-5">
                        <div class="col">
                            ...
                            <div class="profile-block">
                                <div class="profile">
                                    <div class="h-title">กรรมการโดยตำแหน่ง ผู้แทนกระทรวงพาณิชย์</div>
                                    <ul class="item-list">
                                        <?php for ($i = 1; $i <= 7; $i++) { ?>
                                            <li>
                                                <div class="row no-gutters">
                    ...
                    <div class="row mt-5">
                        <div class="col">
                            ...
                            <div class="profile-block">
                                <div class="profile">
                                    <div class="h-title">ผู้แทนกระทรวงทรัพยากรธรรมชาติลและสิ่งแวดล้อม</div>
                                    <ul class="item-list">
                                        <?php for ($i = 1; $i <= 9; $i++) { ?>
                                            <li>
                                                <div class="row no-gutters">
