                                    ...
                                    <div id="accordionInner">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">
                                                    <button class="btn btn-lg fluid collapsed" data-toggle="collapse" data-target="#information-service-5" aria-expanded="false" aria-controls="collapse">
                                                        <span>
                                            ...
                                            <div id="information-service-5" class="collapse show" aria-labelledby="headingCollapse" data-parent="#accordion">
                                                <?php for ($i = 1; $i <= 6; $i++) { ?>
                                ...
                                <div class="collapse-block">
                                    <div id="accordionInner">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">
                                                    <button class="btn btn-lg fluid collapsed" data-toggle="collapse" data-target="#information-service-6" aria-expanded="false" aria-controls="collapse">
                                                        <span>
                                                            บันทึกจากห้องปฏิบัติการ
                                                        </span>
                                                        <span class="feather icon-plus-circle"></span>
                                            ...
                                            <div id="information-service-6" class="collapse" aria-labelledby="headingCollapse" data-parent="#accordion">
                                                <?php for ($i = 1; $i <= 6; $i++) { ?>
                                                    <div class="download-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-md">
                                ...
                                <div class="collapse-block">
                                    <div id="accordionInner">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">
                                                    <button class="btn btn-lg fluid collapsed" data-toggle="collapse" data-target="#information-service-7" aria-expanded="false" aria-controls="collapse">
                                                        <span>
                                                            LMHC Information
                                                        </span>
                                                        <span class="feather icon-plus-circle"></span>
                                            ...
                                            <div id="information-service-7" class="collapse" aria-labelledby="headingCollapse" data-parent="#accordion">
                                                <div class="download-block">
                                                    <div class="row align-items-center">
                                                        <div class="col-md">
                                                            <div class="row no-gutters">
                                ...
                                <div class="collapse-block">
                                    <div id="accordionInner">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">
                                                    <button class="btn btn-lg fluid collapsed" data-toggle="collapse" data-target="#information-service-8" aria-expanded="false" aria-controls="collapse">
                                                        <span>
                                                            LMHC Information
                                                        </span>
                                                        <span class="feather icon-plus-circle"></span>
                                            ...
                                            <div id="information-service-8" class="collapse" aria-labelledby="headingCollapse" data-parent="#accordion">
                                                <?php for ($i = 1; $i <= 6; $i++) { ?>
                                                    <div class="download-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-md">
