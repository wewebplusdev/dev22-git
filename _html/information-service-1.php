            ...
            <div class="default-page information-service">
                ...
                <div class="container">
                    <div class="editor-content">
                        <div class="h-title">บทความด้านเทคนิค</div>
                        <div class="row py-3">
                            <div class="col">
                                    ...
                                    <div id="accordionInner">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">
                                                    <button class="btn btn-lg fluid collapsed" data-toggle="collapse" data-target="#information-service-1" aria-expanded="false" aria-controls="collapse">
                                                        <span>
                                            ...
                                            <div id="information-service-1" class="collapse show" aria-labelledby="headingCollapse" data-parent="#accordion">
                                                <?php for ($i = 1; $i <= 6; $i++) { ?>
                                ...
                                <div class="collapse-block">
                                    <div id="accordionInner">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">
                                                    <button class="btn btn-lg fluid collapsed" data-toggle="collapse" data-target="#information-service-2" aria-expanded="false" aria-controls="collapse">
                                                        <span>
                                                            บันทึกจากห้องปฏิบัติการ
                                                        </span>
                                                        <span class="feather icon-plus-circle"></span>
                                            ...
                                            <div id="information-service-2" class="collapse" aria-labelledby="headingCollapse" data-parent="#accordion">
                                                <?php for ($i = 1; $i <= 6; $i++) { ?>
                                                    <div class="download-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-md">
                                ...
                                <div class="collapse-block">
                                    <div id="accordionInner">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">
                                                    <button class="btn btn-lg fluid collapsed" data-toggle="collapse" data-target="#information-service-3" aria-expanded="false" aria-controls="collapse">
                                                        <span>
                                                            LMHC Information
                                                        </span>
                                                        <span class="feather icon-plus-circle"></span>
                                            ...
                                            <div id="information-service-3" class="collapse" aria-labelledby="headingCollapse" data-parent="#accordion">
                                                <div class="download-block">
                                                    <div class="row align-items-center">
                                                        <div class="col-md">
                                                            <div class="row no-gutters">
                                ...
                                <div class="collapse-block">
                                    <div id="accordionInner">
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="mb-0">
                                                    <button class="btn btn-lg fluid collapsed" data-toggle="collapse" data-target="#information-service-4" aria-expanded="false" aria-controls="collapse">
                                                        <span>
                                                            LMHC Information
                                                        </span>
                                                        <span class="feather icon-plus-circle"></span>
                                            ...
                                            <div id="information-service-4" class="collapse" aria-labelledby="headingCollapse" data-parent="#accordion">
                                                <?php for ($i = 1; $i <= 6; $i++) { ?>
                                                    <div class="download-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-md">
