        ...
        <section class="site-container">
            ...
            <div class="default-page about-page">
                ...
                <div class="container mt-5">
                    <h2 class="text-primary mb-4">คณะกรรมการสถาบันวิจัยและพัฒนาอัญมณีและเครื่องประดับแห่งชาติ</h2>
                    ...
                    <div class="row mt-5">
                        <div class="col">
                            ...
                            <div class="profile-block">
                                <div class="profile">
                                    <div class="h-title">กรรมการโดยตำแหน่ง</div>
                                    <ul class="item-list">
                                        <?php for ($i = 1; $i <= 3; $i++) { ?>
                                            <li>
                                                <div class="row no-gutters">
                    ...
                    <div class="row mt-5">
                        <div class="col">
                            ...
                            <div class="profile-block">
                                <div class="profile">
                                    <div class="h-title">กรรมการผูทรงคุณวุฒิ</div>
                                    <ul class="item-list">
                                        <?php for ($i = 1; $i <= 6; $i++) { ?>
                                            <li>
                                                <div class="row no-gutters">
                    ...
                    <div class="row mt-5">
                        <div class="col">
                            ...
                            <div class="profile-block">
                                <div class="profile">
                                    <div class="h-title">กรรมเลขานุการ</div>
                                    <ul class="item-list">
                                        <li>
                                            <div class="row no-gutters">
                                                <div class="col">
                    ...
                    <div class="row mt-5">
                        <div class="col">
                            ...
                            <div class="profile-block">
                                <div class="profile">
                                    <div class="h-title">ที่ปรึกษาของคณะกรรมการสถาบันวิจัยและพัฒนาอัญมณีและเครื่องประดับแห่งชาติ</div>
                                    <ul class="item-list">
                                        <li>
                                            <div class="row no-gutters">
                                                <div class="col">
