                ...
                <div class="col-12">
                    <div class="brand">
                        <a href="link" title="Gem and Jewelry Institute of Thailand">
                            <img src="<?php echo $core_template; ?>/assets/img/static/git-brand.svg" alt="Gem and Jewelry Institute of Thailand Logo">
                        </a>
                    </div>
                </div>
                <div class="col">
                        ...
                        <ul class="item-list">
                            <li>
                                <a href="" class="btn btn-xl btn-primary" title="Instagram">
                                    <div class="inner">
                                        <!-- <div class="icon">
                                            <img src="<?php echo $core_template; ?>/assets/img/icon/Icon-instagram.svg" alt="instagram icon">
                                        </div> -->
                            ...
                            <li>
                                <a href="" class="btn btn-xl btn-primary" title="Facebook">
                                    <div class="inner">
                                        <!-- <div class="icon">
                                            <img src="<?php echo $core_template; ?>/assets/img/icon/Icon-facebook-square.svg" alt="facebook icon">
                                        </div> -->
                            ...
                            <li>
                                <a href="" class="btn btn-xl btn-primary" title="YouTube">
                                    <div class="inner">
                                        <!-- <div class="icon">
                                            <img src="<?php echo $core_template; ?>/assets/img/icon/Icon-youtube.svg" alt="youtube icon">
                                        </div> -->
                            ...
                            <li>
                                <a href="" class="btn btn-xl btn-primary" title="Twitter">
                                    <div class="inner">
                                        <!-- <div class="icon">
                                            <img src="<?php echo $core_template; ?>/assets/img/icon/Icon-twitter.svg" alt="twitter icon">
                                        </div> -->
