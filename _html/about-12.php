                                ...
                                <div id="accordionInner">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="mb-0">
                                                <button class="btn btn-lg fluid collapsed" data-toggle="collapse" data-target="#about-1" aria-expanded="false" aria-controls="collapse">
                                                    <span>
                                                        ปรเภทการแผยแพร่แผนการจัดซื้อ/จัดจ้าง
                                                    </span>
                                                    <span class="feather icon-plus-circle"></span>
                                                </button>
                                            </h3>
                                        </div>
                                        <div id="about-1" class="collapse" aria-labelledby="headingCollapse" data-parent="#accordion">
                                            <?php for ($i = 1; $i <= 6; $i++) { ?>
                            ...
                            <div class="collapse-block">
                                <div id="accordionInner">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="mb-0">
                                                <button class="btn btn-lg fluid collapsed" data-toggle="collapse" data-target="#about-2" aria-expanded="false" aria-controls="collapse">
                                                    <span>
                                        ...
                                        <div id="about-2" class="collapse" aria-labelledby="headingCollapse" data-parent="#accordion">
                                            <?php for ($i = 1; $i <= 6; $i++) { ?>
                                                <div class="download-block">
                                                    <div class="row align-items-center">
                                                        <div class="col-md">
                            ...
                            <div class="collapse-block">
                                <div id="accordionInner">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="mb-0">
                                                <button class="btn btn-lg fluid collapsed" data-toggle="collapse" data-target="#about-3" aria-expanded="false" aria-controls="collapse">
                                                    <span>
                                        ...
                                        <div id="about-3" class="collapse" aria-labelledby="headingCollapse" data-parent="#accordion">
                                            <?php for ($i = 1; $i <= 6; $i++) { ?>
                                                <div class="download-block">
                                                    <div class="row align-items-center">
                                                        <div class="col-md">
