...
class url
{
    ...
    {
        global $url_show_lang, $lang_set, $lang_default, $url_show_default, $path_root_url;
        ...
        if (!empty($url_show_lang)) {
            ...
            if (isset($lang_set[$this->segment[0]])) {
                ...
                header("Location:" . $path_root_url.$urlNewDirect);
            }
        } else {
    ...
    {
        $folderpage = _DIR . '/controller/script/' . $this->segment[0] . "/";
    ...
    public function setpagedefault()
    {
        ...
        $path = _DIR . '/controller/script/' . $url_show_default;
    ...
    public function loadmodulus($array)
    {
        ...
        foreach ($array as $value) {
            $path = _DIR . '/controller/script/' . $value . "/";
