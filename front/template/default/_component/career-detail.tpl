              ...
              {foreach $Call_File as $keyCall_File => $valueCall_File}
                ...
                <div class="item">
                  <div class="attachment-block">
                    <a href="{$ul}/download/{$valueCall_File['filename']|fileinclude:'file':{$callCMS->fields.masterkey}:'download'}&n={$valueCall_File['name']}&t={'md_jof'|encodeStr}" class="link" title="{$lang['system']['attachment']}" class="link" title="เอกสารแนบ">
