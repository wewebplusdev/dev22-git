                    ...
                    <div class="container">
                        <div class="wrapper">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a href="{$ul}/policy">{$lang["policy"]["title"]}</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="form-group has-feedback">
                                        ...
                                        <span>*</span>
                                        <div class="block-control">
                                            <input type="text" class="form-control" name="inputName" id="inputName" placeholder="{$lang['system']['fill']} {$lang['contact']['name']}" data-error="" required>
                                            <span class="form-control-feedback" aria-hidden="true"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="form-group has-feedback">
                                        ...
                                        <span>*</span>
                                        <div class="block-control">
                                            <input type="email" class="form-control" name="inputEmail" id="inputEmail" placeholder="{$lang['system']['fill']}{$lang['contact']['email']}" data-error="" required>
                                            <span class="form-control-feedback" aria-hidden="true"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <div class="form-group has-feedback">
                                        ...
                                        <div class="block-control">
                                            <input type="text" class="form-control" name="inputAddress" id="inputAddress" placeholder="{$lang['system']['fill']}{$lang['contact']['address']}" data-error="" required>
                                            <span class="form-control-feedback" aria-hidden="true"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="form-group has-feedback">
                                        ...
                                        <div class="block-control">
                                            <input type="tel" class="form-control" name="inputTel" id="inputTel" placeholder="{$lang['system']['fill']}{$lang['contact']['tel']}" data-error="" required>
                                            <span class="form-control-feedback" aria-hidden="true"></span>
                                        </div>
                                    </div>
                                </div>
