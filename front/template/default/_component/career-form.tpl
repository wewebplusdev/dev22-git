  ...
  <div class="default-page about form-about">
    <div class="container">
      ...
      <form data-toggle="validator" role="form" class="form-default family-datails" method="post">
              ...
              <div class="row gutters-custom">
                ...
                <div class="col-sm">
                  <div class="form-group has-feedback">
                    ...
                    <div class="block-control">
                      <input type="text" class="form-control" id="you-are-someone-who"
              ...
              <div class="row gutters-custom">
                <div class="col-md col-sm-6">
                  <div class="form-group has-feedback">
                    ...
                    <div class="block-control">
                      <input type="text" class="form-control" id="f-surname-3" placeholder="นามสกุล / Surname"
                        data-error="">
                      <span class="form-control-feedback" aria-hidden="true"></span>
                    </div>
                  </div>
          ...
          <div class="row gutters-custom">
            <div class="col-sm">
              <div class="form-group has-feedback">
                ...
                <div class="block-control">
                  <input type="text" class="form-control" id="f-relations-3" placeholder="ความสัมพันธ์ / Relations"
                    data-error="">
                  <span class="form-control-feedback" aria-hidden="true"></span>
                </div>
              </div>
            ...
            <div class="col-sm">
              <div class="form-group has-feedback">
                <label class="control-label font-size-C" for="f-address-workplace-3">ที่อยู่/ที่ทำงาน /
                  Address/Workplace</label>
                <div class="block-control">
                  <input type="text" class="form-control" id="f-address-workplace-3"
                    placeholder="ที่อยู่/ที่ทำงาน / Address/Workplace" data-error="">
                  <span class="form-control-feedback" aria-hidden="true"></span>
                </div>
              </div>
              ...
              <div class="row gutters-custom">
                <div class="col-auto">
                  <fieldset>
                    <legend class="visuallyhidden">Live</legend>
                    <div class="form-group form-check">
                      <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="live-3"
                ...
                <div class="col-auto">
                  <fieldset>
                    <legend class="visuallyhidden">Pass Away</legend>
                    <div class="form-group form-check">
                      <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="pass-away-3"
                        value="option1" checked>
        ...
        <div class="form-setV d-none" id="add-form-1">
        ...
        <div class="row gutters-custom align-items-end">
          ...
          <div class="col-sm">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="academy-name" placeholder="ชื่อสถาบัน / Academy Name"
                  data-error="">
                <span class="form-control-feedback" aria-hidden="true"></span>
              </div>
            </div>
          ...
          <div class="col-sm">
            <div class="form-group has-feedback">
              <label class="control-label visuallyhidden" for="you-are-someone-who-2">คุณมาจากที่ไหน / You Are Someone
                Who?</label>
              <div class="block-control">
                <input type="text" class="form-control" id="you-are-someone-who-2"
          ...
          <div class="col-md-4 col-sm-6">
            <div class="form-group has-feedback">
              <label class="control-label visuallyhidden" for="educational-background">ประวัติการศึกษา / Educational
                Background</label>
              <div class="block-control">
                <input type="text" class="form-control" id="educational-background"
            ...
            <div class="row gutters-custom">
              <div class="col">
                <div class="form-group has-feedback">
                  ...
                  <div class="block-control">
                    <input type="text" class="form-control" id="average-score" placeholder="คะแนนเฉลี่ย / Average Score"
                      data-error="">
                    <span class="form-control-feedback" aria-hidden="true"></span>
                  </div>
                </div>
        ...
        <div class="row gutters-custom align-items-end">
          ...
          <div class="col-sm">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="degree-certificate"
        ...
        <div class="row gutters-custom align-items-end">
          <div class="col-md col-sm-auto">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="company-name" placeholder="ชื่อบริษัท / Company’s Name"
                  data-error="">
                <span class="form-control-feedback" aria-hidden="true"></span>
              </div>
            </div>
          ...
          <div class="col-md col-sm-auto">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="type-of-business"
          ...
          <div class="col-md col-sm-auto">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="c-telephone" placeholder="โทรศัพท์ / Telephone"
                  data-error="">
                <span class="form-control-feedback" aria-hidden="true"></span>
              </div>
            </div>
        ...
        <div class="row gutters-custom">
          <div class="col-md col-sm-auto">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="first-position"
          ...
          <div class="col-md col-sm-auto">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="last-position" placeholder="ตำแหน่งแรกเข้า / Last Position"
                  data-error="">
                <span class="form-control-feedback" aria-hidden="true"></span>
              </div>
            </div>
          ...
          <div class="col-md col-sm-auto">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="last-salary" placeholder="เงินเดือนสุดท้าย / Last Salary"
                  data-error="">
                <span class="form-control-feedback" aria-hidden="true"></span>
              </div>
            </div>
          ...
          <div class="col-md col-sm-auto">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="other-salary" placeholder="รายได้อื่น ๆ / Other"
                  data-error="">
                <span class="form-control-feedback" aria-hidden="true"></span>
              </div>
            </div>
        ...
        <div class="row gutters-custom mt-2">
          <div class="col">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="brief-responsibility"
              ...
              <div class="row gutters-custom">
                <div class="col-auto">
                  <div class="form-group form-check -nm IC">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="permanent-no"
                      value="option1" checked>
                ...
                <div class="col">
                  <div class="form-group form-check -nm IC">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="permanent-yes"
                      value="option1" checked>
          ...
          <div class="col-sm mt-sm-3 mt-3">
            <fieldset>
              ...
              <div class="row gutters-custom">
                <div class="col-auto">
                  <div class="form-group form-check -nm IC">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="temporary-no"
                      value="option1" checked>
                ...
                <div class="col">
                  <div class="form-group form-check -nm IC">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="temporary-yes"
                      value="option1" checked>
            ...
            <div class="row gutters-custom">
              <div class="col-auto">
                <fieldset>textarea
                  ...
                  <div class="form-group form-check -nm I">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="contagious-no"
                      value="option1" checked>
              ...
              <div class="col-auto">
                <fieldset>
                  <legend class="visuallyhidden"></legend>
                  <div class="form-group form-check -nm I">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="contagious-yes"
                      value="option1" checked>
            ...
            <div class="row gutters-custom">
              <div class="col-auto">
                <fieldset>
                  <legend class="visuallyhidden"></legend>
                  <div class="form-group form-check -nm I">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios"
                      id="congenital-disease-no" value="option1" checked>
              ...
              <div class="col-auto">
                <fieldset>
                  ...
                  <div class="form-group form-check -nm I">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios"
                      id="congenital-disease-yes" value="option1" checked>
            ...
            <div class="row gutters-custom">
              <div class="col-auto">
                <fieldset>
                  <legend class="visuallyhidden"></legend>
                  <div class="form-group form-check -nm I">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="imprisonment-no"
                      value="option1" checked>
              ...
              <div class="col-auto">
                <fieldset>
                  <legend class="visuallyhidden"></legend>
                  <div class="form-group form-check -nm I">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="imprisonment-yes"
                      value="option1" checked>
            ...
            <div class="row gutters-custom">
              <div class="col-auto">
                <fieldset>
                  <legend class="visuallyhidden"></legend>
                  <div class="form-group form-check -nm I">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="dismissal-no"
                      value="option1" checked>
              ...
              <div class="col-auto">
                <fieldset>
                  <legend class="visuallyhidden"></legend>
                  <div class="form-group form-check -nm I">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="dismissal-yes"
                      value="option1" checked>
            ...
            <div class="row gutters-custom">
              <div class="col-auto">
                <fieldset>
                  <legend class="visuallyhidden"></legend>
                  <div class="form-group form-check -nm I">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="friend-no"
                      value="option1" checked>
              ...
              <div class="col-auto">
                <fieldset>
                  <legend class="visuallyhidden"></legend>
                  <div class="form-group form-check -nm I">
                    <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="friend-yes"
                      value="option1" checked>
        ...
        <div class="row gutters-custom align-items-center">
          <div class="col-md-3 col-sm-6">
            <fieldset>
              <legend class="visuallyhidden"></legend>
              <div class="form-group form-check -nm I">
                <input class="form-check-input radio-check -C" type="radio" name="exampleRadios"
                  id="personal-recommendation" value="option1" checked>
        ...
        <div class="row gutters-custom align-items-center mt-sm-0 mt-2">
          <div class="col-md-3 col-sm-6">
            <fieldset>
              <legend class="visuallyhidden"></legend>
              <div class="form-group form-check -nm I">
                <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="others"
                  value="option1" checked>
        ...
        <div class="row gutters-custom">
          <div class="col">
            <div class="form-group has-feedback -nm">
              ...
              <div class="block-control">
                <textarea class="form-control form-text-area" rows="4" cols="100" id="textarea-1" value="Spicyfi"
                  data-error=""></textarea>
                <span class="form-control-feedback" aria-hidden="true"></span>
              </div>
            </div>
        ...
        <div class="row gutters-custom align-items-center">
          <div class="col-auto">
            <fieldset>
              ...
              <div class="form-group form-check -nm">
                <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="reference-no"
                  value="option1" checked>
          ...
          <div class="col">
            <fieldset>
              <legend class="visuallyhidden"></legend>
              <div class="form-group form-check -nm">
                <input class="form-check-input radio-check" type="radio" name="exampleRadios" id="reference-yes"
                  value="option1" checked>
        ...
        <div class="row gutters-custom">
          <div class="col-md col-sm">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="p-name-1" placeholder="ชื่อ-นามสกุล / Name-Surname"
                  data-error="">
                <span class="form-control-feedback" aria-hidden="true"></span>
              </div>
            </div>
          ...
          <div class="col-md col-sm">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="p-address-1"
          ...
          <div class="col-md col-sm">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="p-position-1" placeholder="ตำแหน่ง / Position"
                  data-error="">
                <span class="form-control-feedback" aria-hidden="true"></span>
              </div>
            </div>
        ...
        <div class="row gutters-custom">
          <div class="col-sm-4">
            <div class="form-group has-feedback">
              ...
              <div class="block-control">
                <input type="text" class="form-control" id="p-telephone-1" placeholder="โทรศัพท์ / Telephone"
                  data-error="">
                <span class="form-control-feedback" aria-hidden="true"></span>
              </div>
            </div>
