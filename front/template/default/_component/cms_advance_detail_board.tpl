              ...
              <div class="row justify-content-center">
                ...
                <div class="col-md-8">
                  <div class="profile-desc text-center">
                    ...
                    {$callCMS->fields.fname} {$callCMS->fields.lname}
                    </div>

                    <div class="profile-position">
                    {$callCMS->fields.depart} 
                    </div>
                    <div class="profile-timeline">
                    {$callCMS->fields.sdatetxt} 
                    </div>
                    <div class="profile-contact">
                      <div class="email">
                        {$lang['contact']['email']}: {$callCMS->fields.email} 
                      </div>
                      <div class="telephone">
                        {$lang['contact']['tel']}: {$callCMS->fields.tel} 
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {if $Call_File->_numOfRows gte 1}
              {foreach $Call_File as $keyCall_File => $valueCall_File}
                ...
                {if $fileinfo.type === '.pdf'}
                  <div class="view-pdf">
                    <object data="upload/{$callCMS->fields.masterkey}/file/{$valueCall_File['filename']}" type="application/pdf"
