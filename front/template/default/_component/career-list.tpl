<section class="site-container">
  ...
  <div class="default-page about">
          ...
          {foreach $getMenuDetail as $keygetMenuDetail => $valuegetMenuDetail}
            ...
            <div class="item">
              <a href="{$ul}/{$menuActive}/{$valuegetMenuDetail.id}"
                {if $MenuID eq $valuegetMenuDetail.masterkey}{$menuNumID = $valuegetMenuDetail.id}class="active"
                {/if}>{$arrName[0]}</a>
            </div>
          {/foreach}
        </div>
    ...
    <div class="container">
      ...
      <form action="{$ul}/{$menuActive}/{$menuNumID}" data-toggle="validator" role="form" class="form-default"
        method="get">
          ...
          <div class="col-md-4 text-right">
            ...
            <div class="form-group has-feedback">
              ...
              <div class="select-wrapper">
                <select class="select-control" name="selectCareer" id="mockSelect1" style="width: 100%;"
                  ...
                  {foreach $callListCareerSelect as $keycallListCareerSelect => $valuecallListCareerSelect}
                    <option value="{$valuecallListCareerSelect.id}"
                      {if $req_params['selectcareer'] eq $valuecallListCareerSelect.id}selected{/if}>
                      {$valuecallListCareerSelect.subject}</option>
                  {/foreach}
                </select>
              </div>
            </div>
            ...
            <div class="row">
              <a href="{$ul}/{$menuActive}/{$menuNumID}/{$menuDetail}/{$valuecallCMS.id}" style="text-decoration: none;">
                <div class="col-12">
                  ...
                  <div class="desc">({$lang['career']['quantity']} : {$valuecallCMS.quantity} {$lang['career']['position']})
                  </div>
                </div>
              ...
              <div class="row align-items-center">
                <div class="col">
                  <div class="row align-items-center no-gutters">
                    ...
                    <div class="col">
                      <a href="{$ul}/{$menuActive}/{$menuNumID}/{$menuDetail}/{$valuecallCMS.id}"
                ...
                <div class="col-auto">
                  <a href="{$ul}/{$menuActive}/{$menuNumID}/{$menuDetail}/{$valuecallCMS.id}" class="link"
                    title="{$lang['career']['detail']}">
                    <div class="row align-items-center no-gutters">
                      <div class="col">
                        <div class="desc">
                          {$lang['career']['detail']}
