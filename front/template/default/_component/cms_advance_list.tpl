         ...
         <div class="container mt-md-5 mt-4">
            ...
            <div class="default-tab-slider default-slick" data-slick='{$initialSlide2}'>
               {foreach $arrMenu as $keyarrMenu => $valuearrMenu}
                  <div class="item">
                     <div
                        class="tab-block {if $menuidLv2 eq $valuearrMenu.id}{$menuDetailID = $valuearrMenu.menuid}active{/if}">
                        <a class="text-limit"
                        ...
                        <div class="row no-gutters">
                           <div class="col">
                              ...
                              <input type="search" id="keywords" name="keywords" class="form-control"
                                 placeholder="{$lang['system']['search']}" value="{$req_params['keywords']}">
                           </div>
                           <div class="col-auto">
         ...
         <div class="row align-items-center">
            <div class="col-auto">
               <div class="h-title">{$callGroup->fields.subject}
                  {if $settingModulus['rssfeed']}<a
                        href="{$ul}/rss/{$callCMS->fields.masterkey}GIT{$settingModulus['group']}.xml" target="_blank"
                        class="rss" style="display: inline;">
                        <img src="{$template}/assets/img/icon/icon-rss.png" alt="icon rss">
                  </a>{/if}</div>
            </div>
         </div>
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-sm">
                           ...
                           <div class="row">
                              ...
                              <div class="col-12">
                                 <a href="{$ul}/{$menuActive}/{$valuecallCMS.menuid}/{$valuecallCMS.gid}/{$menuDetail}/{$valuecallCMS.id}"
                                    class="btn" title="btn">{$lang['system']['viewmore']}</a>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="row align-items-center">
                        <div class="col-sm">
                           ...
                           <div class="row">
                              ...
                              <div class="col-12">
                                 <a href="{$rssresult->link}" target="_blank" class="btn"
                                    title="btn">{$lang['system']['viewmore']}</a>
                              </div>
                           </div>
                        </div>
                     </div>
