<footer class="site-footer">
				...
				<div class="inner">
					<div class="row row-0">
						<div class="col-12">
							...
							<div class="font-body">
								<a href="mailto:{$settingWeb['contact']['infoEmailconsent']}" class="link text-primary">{$settingWeb['contact']['infoEmailconsent']}</a>
							</div>
						</div>
					</div>
					{* <div class="row row-0">
						<div class="col-12">
							...
							<div class="font-body">
								<a href="mailto:{$settingWeb['contact']['infoEmailcomplaint']}" class="link text-primary">{$settingWeb['contact']['infoEmailcomplaint']}</a>
							</div>
						</div>
					</div> *}
					<div class="row row-0">
						<div class="col-12">
							<div class="font-body">{$lang['system']['tit:channel']}</div>
							<div class="font-body">
	...
	{* <div class="footer-cac">
		<div class="container">
			<div class="logo text-center mt-3 mb-2">
				<img src="{$template}/assets/img/static/Certified-500x500.png" alt="cac logo" style="width: 85px;">
			</div>
			<p class="font-body text-center">
			บริษัท เอสจี แคปปิตอล จำกัด <br>
			ประกอบธุรกิจอย่างโปร่งใส ต่อต้านการคอร์รัปชั่นทุกรูปแบบและได้รับการรับรองให้เป็นสมาชิกแนวร่วมต่อต้านคอร์รัปชั่นของภาคเอกชนไทย (CAC)
			</p>
		</div>
	</div> *}
				...
				<div class="col-lg-auto">
					<div class="cac">
						<div class="logo text-center">
							<img src="{$template}/assets/img/static/Certified-500x500.png" alt="cac logo">
						</div>
					</div>
				</div>
				<div class="col-lg-auto">
