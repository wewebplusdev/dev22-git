                ...
                <div class="col-md-auto col-12">
                    <div class="brand">
                        <a href="link" title="Gem and Jewelry Institute of Thailand">
                            <img src="{$template}/assets/img/static/git-brand-footer-2.svg"
                    ...
                    <div class="contact">
                        ...
                        <ul class="item-list">
                            {if $settingWeb['contact']['email']}
                                <li class="email">
                                    <a href="mailto:{$settingWeb['contact']['email']}" class="link"
                                        title="{$lang['system']['email']}">
                                        {$lang['system']['email']}: {$settingWeb['contact']['email']}
                                    </a>
                                </li>
                            {/if}
                            {if $settingWeb['contact']['tel'] neq ""}
                                <li>
                                    <a href="tel:{str_replace('-', '', str_replace(' ', '', $settingWeb['contact']['tel']))}"
                                        class="link" title="{$lang['contact']['tel']}">
                                        {$lang['contact']['tel']}: {$settingWeb['contact']['tel']}
                                    </a>
                                </li>
                            {/if}
                            {if $settingWeb['contact']['fax'] neq ""}
                                <li>
                                    <a href="" class="link" title="{$lang['system']['fax']}">
                                        {$lang['system']['fax']}: {$settingWeb['contact']['fax']}
                                    </a>
                                </li>
                            {/if}
                        </ul>
                        ...
                        <div class="col">
                            <div class="links">
                                <ul class="item-list fluid">
                                    <li>
                                        <a href="{$ul}/contact/graphic-map" class="link collapsed" title="Maps">
                                            MAPS
                                            <span class="feather icon-plus"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{$ul}/contact/google-map" class="link collapsed" title="Google maps">
                                            GOOGLE MAPS
                                            <span class="feather icon-plus"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)" class="link collapsed" data-toggle="collapse"
                                            data-target="#collapseSitemap" aria-expanded="false"
                                            aria-controls="collapseSitemap">
                                            GIT SITEMAP
                                            <span class="feather icon-plus"></span>
                                        </a>
                                    </li>
                            ...
                            <div class="social">
                                <ul class="item-list">
                                    ...
                                    <li>
                                        <a href="" class="link" title="YouTube">
                                            <div class="circle-border">
