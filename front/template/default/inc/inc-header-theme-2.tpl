				...
				<div class="col-auto">
					<div class="brand">
						<a href="index-theme-2.php" class="link" title="Gem and Jewelry Institute of Thailand">
							<img src="{$template}/assets/img/static/git-brand-2.svg" alt="Gem and Jewelry Institute of Thailand">
						</a>
					</div>
				</div>
				<div class="col">
			...
			<div class="row no-gutters align-items-center">
				<div class="col-auto">
					<div class="brand d-lg-none d-block">
						<a href="index-theme-2.php" class="link" title="Gem and Jewelry Institute of Thailand">
							<img src="{$template}/assets/img/static/git-brand-theme-2.svg" alt="Gem and Jewelry Institute of Thailand">
						</a>
					</div>
				</div>
				<div class="col">
