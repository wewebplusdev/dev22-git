$(document).ready(function() {
    ...
    jQuery(function() {
        ...
        nameClassFont.push('.default-nav-tab li .item')
        nameClassFont.push('.item-list .menu-service .topic')
        nameClassFont.push('.item-list .menu-service .sub-topic li a')
        nameClassFont.push('.museum-block .museum-container .topic')
        nameClassFont.push('.default-nav-tabs a')
        nameClassFont.push('')
        nameClassFont.push('')
        nameClassFont.push('')
        nameClassFont.push('')
