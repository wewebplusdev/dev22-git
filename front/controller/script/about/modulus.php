...
class aboutPage
{
  ...
  function callSubGroup($masterkey, $gid = null, $page = 1, $limit = 20, $order = "DESC", $year = null)
  {
    global $config, $db, $url;
    $lang = $url->pagelang[3];
    $langOption = $url->pagelang[2];
  ...
  function callGroupDWN($masterkey, $id = null)
  {
    global $config, $db, $url;
    $lang = $url->pagelang[3];
    $langFull = strtolower($url->pagelang[4]);
  ...
  function callSubGroupDW($masterkey, $gid = null,$sgid = null, $page = 1, $limit = 10, $order = "ASC", $year = null)
  {
    global $config, $db, $url;
    $lang = $url->pagelang[3];
    $langFull = strtolower($url->pagelang[4]);
    ...
    $sql .= " ORDER  BY " . $config['dwsg']['db']['main'] . "." . $config['dwsg']['db']['main'] . "_order ".$order." ";
  ...
  function callCMSListDW($masterkey, $id = null, $gid = null,$sgid = null,$ssgid = null)
  {
    global $config, $db, $url;
    $lang = $url->pagelang[3];
    $langOption = $url->pagelang[2];
  ...
  function callCMSFileListDW($id = null)
  {
    global $config, $db, $url;
    $lang = $url->pagelang[4];
    $langOption = $url->pagelang[2];
