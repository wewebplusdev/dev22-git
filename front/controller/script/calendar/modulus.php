...
class calendarPage {
   ...
   function callCalendarList($masterkey, $myStartDateOfMonth, $myEndDateOfMonth) {
    ...
    " . $config['cas']['db']['main'] . "." . $config['cas']['db']['main'] . "_pic" . $lang . " as pic
    FROM
    " . $config['cas']['db']['main'] . "
    WHERE
   ...
   function callCalendarDetail($masterkey, $id = null) {
    ...
    " . $config['cas']['db']['main'] . "." . $config['cas']['db']['main'] . "_url".$lang." as url,
    " . $config['cas']['db']['main'] . "." . $config['cas']['db']['main'] . "_filevdo".$lang." as filevdo,
