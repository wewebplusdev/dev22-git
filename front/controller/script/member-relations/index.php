...
$MasterkeyTemp = "mr"; // master about like this
$showslick = true; // slick shows

if (empty($MenuID)) {
    $MenuID = $config['about']['mr']['masterkey'];
}
...
switch ($MenuID) {
    default: //สมาชิกสัมพันธ์
        require_once _DIR . '/front/controller/script/' . $menuActive . '/service/mr.php';
        break;
}
