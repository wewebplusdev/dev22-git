<section class="site-container"  style="background-color: #{$themeWebsite.color|default:'#FFFFF'};">
  <div class="main-page">
    ...
    <div class="top-graphic">
      ...
      <div class="default-slider-dots slider">
        ...
        <div class="tpg-item">
          <a href="" class="link">
            <figure class="cover">
              <img src="{$template}/assets/img/static/tpg-theme-2.jpg" alt="top graphic">
            </figure>
            <div class="info">
              <div class="container">
                <div class="wrapper">
        ...
        <div class="tpg-item">
          <a href="" class="link">
            <figure class="cover">
              <img src="{$template}/assets/img/static/tpg-theme-2-02.jpg" alt="top graphic">
            </figure>
            <div class="info">
              <div class="container">
                <div class="wrapper">
        ...
        <div class="banner-txt text-center">
          ...
          <div class="action">
            <a href="https://apps.apple.com/th/app/carat/id1498901876?itsct=apps_box_badge&amp;itscg=30200"
              ...
              <img src="{$template}/assets/img/icon/appstore.svg" alt="Download on the App Store">
            </a>
            <a href="https://play.google.com/store/apps/details?id=com.ultimate.carat&hl=th"
              title="Get it on Google Play" target="_blank">
              <img src="{$template}/assets/img/icon/playstore.svg" alt="Get it on Google Play">
            </a>
          </div>
        </div>
        <div class="graphic">
    ...
    <div class="banner-II-block bg-primary">
      <figure class="cover">
        <img src="{$template}/assets/img/background/bg-banner-theme-2-02.jpg" alt="banner II">
      </figure>
      <div class="wrapper">
        <div class="inner">
