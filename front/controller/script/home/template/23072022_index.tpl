                ...
                <div class="row row-0">
                    <div class="col-lg-6">
                        <div class="content-info">
                            ...
                            <div class="font-sub" data-aos="fade-up">SG Capital Public Company Limited (SGC)</div>
                    ...
                    <div class="row row-0 height">
                        <div class="col-md-auto">
                            <div class="whead" data-aos="fade-right">
                                <h4 class="font-head">
                                    To be no.1
                                    <img src="{$template}/assets/img/icon/toBnoI.svg" alt="To be no.1 " class="lazy">
                                </h4>
                                <div class="font-sub">
                                    in the truck registration
                                    loan by 2026
                                </div>
                                {* <div class="action">
