              ...
              <div class="booklist">
                <div class="default-slider default-slider-dots slider">
                  {foreach $valuearrGitbookList.list as $keySubNews => $valueSubNews}
                    <div class="item">
                      <a {if $valuecallWeblinkSection['url'] neq "" && $valuecallWeblinkSection['url'] neq "#"}href="{$valuecallWeblinkSection['url']}"{if $valuecallWeblinkSection['target'] eq 2}target="_blank"{/if}{else}href="javascript:void(0);"{/if} class="link" title="">
                        <figure class="cover">
