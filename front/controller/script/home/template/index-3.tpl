                ...
                <div class="slider">
                    {foreach $callservice_top as $keycallservice_top => $valuecallservice_top}
                        <div class="item-">
                            ...
                            <a {if $valuecallservice_top['url'] neq "" && $valuecallservice_top['url'] neq "#"}href="{$valuecallservice_top['url']}"{if $valuecallservice_top['target'] eq 2}target="_blank"{/if}{else}href="javascript:void(0);"{/if} class="link" title="{$valuecallservice_top['subject']}">
                                <figure class="cover">
                                    <img src="{$valuecallservice_top['pic']|fileinclude:"real":{$valuecallservice_top['masterkey']}:"link"}" alt="{$valuecallservice_top['subject']}">
                                </figure>
                            </a>
