<?php
/* Smarty version 4.0.0, created on 2022-11-07 14:40:48
  from '/var/www/html/front/template/default/inc/inc-footer.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_6368b680d992c1_64295728',
...
function content_6368b680d992c1_64295728 (Smarty_Internal_Template $_smarty_tpl) {
...
/assets/img/static/git-brand.svg"
                ...
                <div class="col">
                    ...
                    <p class="desc">
                        140, 140/1-3, 140/5 อาคารไอทีเอฟ ทาวเวอร์ ชั้น 1-4 และชั้น 6 ถนนสีลม แขวงสุริยวงศ์ เขตบางรัก
                        กรุงเทพฯ 10500
                    </p>
                </div>
            </div>
            <div class="row align-items-end">
                <div class="col-lg">
                    ...
                    <div class="maps">
                        <ul class="item-list">
                            <li>
                                <a href="" class="btn btn-xl btn-primary" title="Maps">
                                    MAPS
                                </a>
                            </li>
                            <li>
                                <a href="" class="btn btn-xl btn-primary" title="Google maps">
                                    GOOGLE MAPS
                                </a>
                            </li>
                        </ul>
...
/assets/img/icon/Icon-instagram.svg" alt="instagram icon">
                            ...
                            <li>
                                <a href="" class="btn btn-xl btn-primary" title="Facebook">
                                    <div class="inner">
                                        <!-- <div class="icon">
                                            <img src="<?php echo $_smarty_tpl->tpl_vars['template']->value;?>
/assets/img/icon/Icon-facebook-square.svg" alt="facebook icon">
                                        </div> -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="39.324" height="39.324"
                                            ...
                                            <path data-name="Icon awesome-facebook-square"
                                                d="M35.111,2.25H4.213A4.213,4.213,0,0,0,0,6.463v30.9a4.213,4.213,0,0,0,4.213,4.213H16.261V28.2h-5.53V21.912h5.53v-4.8c0-5.455,3.248-8.469,8.222-8.469a33.5,33.5,0,0,1,4.873.425v5.354H26.611c-2.7,0-3.548,1.678-3.548,3.4v4.086H29.1L28.135,28.2H23.063V41.574H35.111a4.213,4.213,0,0,0,4.213-4.213V6.463A4.213,4.213,0,0,0,35.111,2.25Z"
                            ...
                            <li>
                                <a href="" class="btn btn-xl btn-primary" title="YouTube">
                                    <div class="inner">
                                        <!-- <div class="icon">
                                            <img src="<?php echo $_smarty_tpl->tpl_vars['template']->value;?>
/assets/img/icon/Icon-youtube.svg" alt="youtube icon">
                                        </div> -->
                            ...
                            <li>
                                <a href="" class="btn btn-xl btn-primary" title="Twitter">
                                    <div class="inner">
                                        <!-- <div class="icon">
                                            <img src="<?php echo $_smarty_tpl->tpl_vars['template']->value;?>
/assets/img/icon/Icon-twitter.svg" alt="twitter icon">
                                        </div> -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="40.831" height="33.162"
                                            viewBox="0 0 40.831 33.162">
                                            <path data-name="Icon awesome-twitter"
                                                d="M36.634,11.645c.026.363.026.725.026,1.088,0,11.063-8.42,23.809-23.809,23.809A23.648,23.648,0,0,1,0,32.786a17.312,17.312,0,0,0,2.021.1A16.759,16.759,0,0,0,12.41,29.315a8.383,8.383,0,0,1-7.824-5.8,10.553,10.553,0,0,0,1.58.13,8.851,8.851,0,0,0,2.2-.285,8.369,8.369,0,0,1-6.71-8.213v-.1A8.428,8.428,0,0,0,5.441,16.1,8.381,8.381,0,0,1,2.85,4.909,23.787,23.787,0,0,0,20.1,13.666a9.447,9.447,0,0,1-.207-1.917A8.376,8.376,0,0,1,34.38,6.023,16.476,16.476,0,0,0,39.691,4a8.346,8.346,0,0,1-3.679,4.612,16.776,16.776,0,0,0,4.819-1.3,17.989,17.989,0,0,1-4.2,4.327Z"
                ...
                <div class="col-lg-auto text-center">
                    <div class="w3c">
                        <a href="https://www.w3.org/WAI/WCAG2AA-Conformance"
                            ...
                            <img height="50" width="150" src="https://www.w3.org/WAI/WCAG21/wcag2.1AA-blue-v.svg"
