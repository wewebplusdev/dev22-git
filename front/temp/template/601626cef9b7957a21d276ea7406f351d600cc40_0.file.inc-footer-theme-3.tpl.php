<?php
/* Smarty version 4.0.0, created on 2022-10-18 09:42:59
  from '/var/www/html/front/template/default/inc/inc-footer-theme-3.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_634e12b3368694_17406259',
...
function content_634e12b3368694_17406259 (Smarty_Internal_Template $_smarty_tpl) {
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-xl-auto col-12">
                    <div class="maps">
                        <ul class="item-list">
                            <li>
                                <a href="" class="btn btn-light" title="Maps">
                                    <div class="inner">
                                        <div class="icon">
                                            <img src="<?php echo $_smarty_tpl->tpl_vars['template']->value;?>
/assets/img/icon/map.svg" alt="map">
                            ...
                            <li>
                                <a href="" class="btn btn-primary" title="Google maps">
                                    <div class="inner">
                                        <div class="icon">
                                            <img src="<?php echo $_smarty_tpl->tpl_vars['template']->value;?>
