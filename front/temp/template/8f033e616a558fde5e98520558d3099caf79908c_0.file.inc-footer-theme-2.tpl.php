...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_636a2f10f05b55_66909269',
...
function content_636a2f10f05b55_66909269 (Smarty_Internal_Template $_smarty_tpl) {
...
/assets/img/static/git-brand-footer-2.svg" alt="Gem and Jewelry Institute of Thailand Logo">
                        </a>
                    </div>
                </div>
                <div class="col-md col-sm-9 col-12">
                    <div class="contact">
                        <h2 class="title">
                            สถาบันวิจัยและพัฒนาอัญมณีและเครื่องประดับแห่งชาติ <br> (องค์การมหาชน)
                        </h2>
                        <p class="desc">
                            140, 140/1-3, 140/5 อาคารไอทีเอฟ ทาวเวอร์ ชั้น 1-4 และชั้น 6 ถนนสีลม <br>
                        ...
                        <div class="col">
                            <div class="links">
                                <ul class="item-list fluid">
                                    <li>
                                        <a href="contact-graphic-map.php" class="link collapsed" title="Maps">
                                            MAPS
                                            <span class="feather icon-plus"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="contact-google-map.php" class="link collapsed" title="Google maps">
                                            GOOGLE MAPS
                                            <span class="feather icon-plus"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)" class="link collapsed" data-toggle="collapse" data-target="#collapseSitemap" aria-expanded="false" aria-controls="collapseSitemap">
                                            GIT SITEMAP
                                            <span class="feather icon-plus"></span>
                                        </a>
                                    </li>
