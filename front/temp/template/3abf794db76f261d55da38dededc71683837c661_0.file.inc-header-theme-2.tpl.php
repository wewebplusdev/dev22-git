...
/* Smarty version 4.0.0, created on 2022-10-18 09:41:43
  from '/var/www/html/front/template/default/inc/inc-header-theme-2.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_634e1267c1e830_75175430',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3abf794db76f261d55da38dededc71683837c661' => 
    array (
      0 => '/var/www/html/front/template/default/inc/inc-header-theme-2.tpl',
      1 => 1666060806,
      2 => 'file',
    ),
  ),
...
function content_634e1267c1e830_75175430 (Smarty_Internal_Template $_smarty_tpl) {
      ...
      <div class="col-auto">
        <div class="brand">
          <a href="index.php" class="link" title="Gem and Jewelry Institute of Thailand">
            <img src="<?php echo $_smarty_tpl->tpl_vars['template']->value;?>
/assets/img/static/git-logo.png"
            ...
            <div class="col-auto">
              <div class="main-menu-list">
                <ul class="nav-list level-I">
                  ...
                  <li class="dropright">
                    <a href="javascript:void(0)" class="link link-submenu" data-link="about-menu" title="เกี่ยวกับเรา"
                  ...
                  <li class="dropleft">
                    <a href="javascript:void(0)" class="link link-submenu" title="ติดต่อเรา" data-toggle="dropdown"
  ...
  <div class="main-menu">
    <ul class="nav-list level-I">
      ...
      <li class="about-menu dropright">
        <a href="javascript:void(0)" class="link submenu" title="เกี่ยวกับเรา" data-toggle="dropdown"
          aria-haspopup="true" aria-expanded="false">
          เกี่ยวกับเรา
        </a>
        <ul class="dropdown-menu level-II">
          ...
          <li class="dropdown-item">
            ...
            <ul class="item-list bullet">
              <li>
                <a href="https://www.youtube.com/watch?v=IFlB_3KRayk" class="link text-light typo-s"
      ...
      <li class="service-menu dropright">
        <a href="javascript:void(0)" class="link submenu" title="งานบริการ" data-toggle="dropdown" aria-haspopup="true"
          aria-expanded="false">
          งานบริการ
        </a>
        <ul class="dropdown-menu level-II">
