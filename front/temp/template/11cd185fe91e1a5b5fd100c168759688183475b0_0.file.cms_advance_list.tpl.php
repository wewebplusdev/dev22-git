<?php
/* Smarty version 4.0.0, created on 2022-11-09 14:05:04
  from '/var/www/html/front/template/default/_component/cms_advance_list.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.0.0',
  'unifunc' => 'content_636b51203240e0_81941161',
...
function content_636b51203240e0_81941161 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
      ...
      <div class="container">
         <div class="row align-items-center">
            ...
            <?php if (count($_smarty_tpl->tpl_vars['callYear']->value) > 0 && $_smarty_tpl->tpl_vars['callGroup']->value->fields['isstatic'] == 0) {?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
         ...
         <?php if ($_smarty_tpl->tpl_vars['callGroup']->value->fields['isstatic'] == 0) {?>
...
?>
         ...
         <?php } else { ?>
            ...
            <?php if (count($_smarty_tpl->tpl_vars['rss']->value) > 0) {?>
               <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['rss']->value, 'rssresult');
$_smarty_tpl->tpl_vars['rssresult']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['rssresult']->value) {
$_smarty_tpl->tpl_vars['rssresult']->do_else = false;
?>
                  <div class="news-block">
                     <div class="row align-items-center">
                        <div class="col-sm">
                           <div class="title"><?php echo $_smarty_tpl->tpl_vars['rssresult']->value->title;?>
</div>
                           <div class="row">
                              <div class="col-12">
                                 <div class="desc"><?php echo $_smarty_tpl->tpl_vars['rssresult']->value->description;?>
</div>
                              </div>
                              <div class="col-12">
                                 <span class="feather icon-calendar"></span>
                                 <span class="typo-xs text-black"><?php echo $_smarty_tpl->tpl_vars['rssresult']->value->pubDate;?>
</span>
                              </div>
                              <div class="col-12">
                                 <a href="<?php echo $_smarty_tpl->tpl_vars['rssresult']->value->link;?>
" target="_blank" class="btn" title="btn"><?php echo $_smarty_tpl->tpl_vars['lang']->value['system']['viewmore'];?>
</a>
                              </div>
                           </div>
                        </div>
